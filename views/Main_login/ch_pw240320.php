...
{ 
	...
	{ 
 	...
 	$("#n_p").change(function()
 	{
		...
		if((np.match(upperCase)) || (np.match(lowerCase)) || (np.match(numbers)) || (np.lenght>=8) && (np.lenght<=20))
		{
		   //alert("password ok");
		...
		{
		    alert("Your password must be between 8 and 20 characters. It must contain a mixture of upper and lower case letters, and at least one number");
		    $("#n_p").val('');
		    $("#n_p").focus();
		}
 	});
 ...
 //print_r($user_header);
    ...
    <div class="row no-gutters p-3 ">
        ...
        <div class="col-9 p-2 text-darkslategray">
  			<input type="password" name="n_p"  id="n_p"  class="form-control col-4 btn-point" minlength="8" maxlength="20" autocomplete="off" />
  			<i id="8char" class="fas fa-times text-danger"></i> 8 Characters Long  &nbsp;&nbsp;
        ...
        <div class="col-9 p-2 text-darkslategray">
  			<input type="password" name="n_c_p" id="n_c_p"  class="form-control col-4 btn-point" minlength="8" maxlength="20" autocomplete="off" />
  			<i id="8char1" class="fas fa-times text-danger"></i> 8 Characters Long &nbsp;&nbsp;
