    ...
    if(search_id==1){
      ...
      if(search_mob==''){
        ...
        $.ajax({
          ...
          url : "<?php echo site_url('Super_Ctrl/Super/search_resetpwd_list')?>",
          type: "POST",
...
function reset_password(){
  ...
  var user_id   = document.getElementById('hid_id').value; //alert(user_id);
  $("#reset_div").hide();
  $("#reseting_div").show();

  $.ajax({

          url : "<?php echo site_url('Super_Ctrl/Super/reset_password')?>",
          type: "POST",
...
<div class="alert bg-aqua-active text-center" role="alert">
  <i class="fas fa-unlock-alt"></i> &nbsp; Reset Password of Vessel Owner
</div> <!-- end of alert -->
</div> <!-- end of col10 -->
