...
<?php if($user_type_id1==2) { ?>
    <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/Survey/SurveyHome">Home</a></li>
   <?php } ?>

    <?php if($user_type_id1==4) { ?>
    <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/Survey/csHome">Home</a></li>
   <?php } ?>
   <?php if($user_type_id1==3) { ?>
    <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/Survey/pcHome">Home</a></li>
   <?php } ?>
    <?php if($user_type_id1==5) { ?>
    <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/Survey/SurveyorHome">Home</a></li>
   <?php } ?>
  </ol>
</nav> 
<!-- End of breadcrumb -->
...
$stage_count2=str_replace(array('+', '/', '='), array('-', '_', '~'), $stage_count1);
    ...
    ?>
      ...
      <td>
      <?php if($stage_count!=9) { ?> <a href="<?php echo $site_url.'/Survey/add_form1/'.$vessel_sl2.'/'.$stage_count2 ?>" class="btn btn-sm tablebtn bg-indianred btn-flat btn-point btn-block"><?php echo $button_message; ?> </a> <?php } ?>
