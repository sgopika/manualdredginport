...
<tr>
  ...
  <td> <?php if($key['dataentry_approved_status']==0) { ?><a href="<?php echo $site_url.'/Kiv_Ctrl/DataEntry/edit_dataentry_vessel/'.$vessel_sl.'/'.$data_id_enc ?>" class="btn btn-primary btn-flat btn-sm">Edit</a><?php } ?></td>
</tr>
<?php
$i++;
}
