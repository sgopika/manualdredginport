...
echo form_open("Kiv_Ctrl/DataEntry/edit_dataentry_vessel", $attributes);
?>
  <div id="showcontent">
<div class="row">
<div class="col-12"> 
...
<div class="row listrow">
  <div class="col-12 d-flex justify-content-center">
    <input type="submit" class="btn btn-success btn-point btn-flat" name="btnsubmit" id="btnsubmit" value="Edit">
  </div> <!-- end of col12 -->
<!-- end of listrow2 -- Survey row -->
