...
echo form_open("Kiv_Ctrl/DataEntry/addform", $attributes);
?>
  <div id="showcontent">
<div class="row">
<div class="col-12"> 
...
<select class="form-control btn-point js-example-basic-single" name="user_sl" id="user_sl"  required>
  ...
  <div class="col-2 home_content pt-0" >
   ...
   <div class="col-2 home_subtitle">
    <div class="form-group">
    <input type="text" class="form-control btn-point" name="user_name" id="user_name" aria-describedby="text" placeholder="Vessel owners name" maxlength="50" onkeypress="return alpbabetspace(event);" >
  </div>
  </div> <!-- end of col2 -->
  </div> <!-- end of listrow -->
...
<div class="col-2 home_content pt-0">
   ...
   <div class="col-2 home_subtitle">
    <div class="form-group">
    <input type="tel" class="form-control btn-point"name="user_mobile_number" id="user_mobile_number" aria-describedby="text" placeholder="Owner mobile number" minlength="10" maxlength="10"  onkeypress="return IsNumeric(event);">
  </div>
  </div> <!-- end of col2 -->
   <div class="col-2 home_content pt-0">
    Type of Vessel
...
<div class="row listrow">
 ...
 <input type="text" class="form-control btn-point" name="area_of_operation" id="area_of_operation" aria-describedby="text" placeholder="Area of operation" required maxlength="50">
   ...
   <div class="col-2 home_subtitle">
    <div class="form-group">
    <input type="text" class="form-control btn-point" name="user_email" id="user_email" aria-describedby="text" placeholder="Email Id" maxlength="50">
  </div>
  </div> <!-- end of col2 -->
  </div> <!-- end of listrow -->
...
<div class="col-3">
<div class="form-group">
<input type="text" class="form-control btn-point txtcapital" name="license_number_of_type_mr[]"  id="license_number_of_type_mr" aria-describedby="text" placeholder="License number" maxlength="20" onkeypress="return IsNumeric_slash(event)">
</div>
</div> 
 <div class="col-3 ">
...
<div class="col-3">
<div class="form-group">
<input type="text" class="form-control btn-point txtcapital" name="license_number_of_type_sg[]"  id="license_number_of_type_sg" aria-describedby="text" placeholder="License number" maxlength="20" onkeypress="return IsNumeric_slash(event)">
</div>
</div> 
...
<div class="col-3">
<div class="form-group">
<input type="text" class="form-control btn-point txtcapital" name="license_number_of_type_lr[]"  id="license_number_of_type_lr" aria-describedby="text" placeholder="License number" maxlength="20" onkeypress="return IsNumeric_slash(event)">
</div>
</div> 
...
<div class="col-3">
<div class="form-group">
<input type="text" class="form-control btn-point txtcapital" name="license_number_of_type_dr[]"  id="license_number_of_type_dr" aria-describedby="text" placeholder="License number" maxlength="20" onkeypress="return IsNumeric_slash(event)">
</div>
</div> 
...
<div class="row listrow">
  <div class="col-3 home_content pt-0">
   ...
   <div class="col-1 home_subtitle pt-0">
    <input tabindex="10" type="checkbox" value="1" name="hull_condition_status_id" id="icheckbox_square-green" checked>
  </div> <!-- end of col2 -->
   <div class="col-3 home_content pt-0">
    Has vessel tested for stability
  </div> <!-- end of col2 -->
   <div class="col-1 home_subtitle pt-0">
    <input tabindex="10" type="checkbox" value="1" name="stability_test_status_id" id="icheckbox_square-green" checked>
  </div> <!-- end of col2 -->
   <div class="col-3 home_content pt-0">
    Are all equipments under rule
  </div> <!-- end of col2 -->
   <div class="col-1 home_subtitle pt-0">
    <input tabindex="10" type="checkbox" value="1" name="condition_of_equipment" id="icheckbox_square-green" checked>
  <!--   <div class="form-group">
    <input type="text" class="form-control btn-point" id="text" aria-describedby="text" placeholder="">
  </div> -->
  </div> <!-- end of col2 -->
...
<div class="col-4">
  <div class="form-group">
   ...
   <div class="col-4">
     <div class="form-group">
    <input type="text" class="form-control btn-point" name="number_children<?php echo $i; ?>" id="number_children<?php echo $i; ?>" aria-describedby="text" placeholder="No. of  <?php echo $key1['equipment_name'];?> in children" maxlength="3" >
  </div>
  </div> <!-- end of col4 -->
</div> <!-- end of row -->
...
<div class="row listrow">
  <div class="col-2 home_content pt-0">
   ...
   <div class="col-2 home_content pt-0">
    Validity of Survey Certificate
  </div> <!-- end of col2 -->
   <div class="col-2 home_subtitle">
    <div class="form-group">
...
<div class="row listrow">
  ...
  <div class="col-2 home_subtitle">
  <div class="form-group">
 <input type="text" class="form-control btn-point" name="oars" id="oars" aria-describedby="text" placeholder="No. of oars" maxlength="3">
  </div>
  </div> 
  <div class="col-2 home_content pt-0">
  Fire axe
...
function IsNumeric_slash(e) 
{
  ...
  var unicode = e.charCode ? e.charCode : e.keyCode;
  if ((unicode == 8) || (unicode == 9) || (unicode > 47 && unicode < 58) ||  (unicode > 96 && unicode < 123) || (unicode == 47) || (unicode > 64 && unicode < 91) || (unicode == 40) || (unicode == 41) || (unicode == 45)) 
  {
      return true;
  }
  else 
  {
      window.alert("This field accepts only Numbers and slash and capital letters");
      return false;
  }
}
</script>
