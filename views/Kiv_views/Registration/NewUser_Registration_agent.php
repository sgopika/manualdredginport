...
echo form_open("Kiv_Ctrl/Registration/NewUser_Registration_agent", $attributes);
?>
...
<div class="container"> 
  <div class="row">
    ...
    <div class="col-4 border-left pb-2">
      <i class="fas fa-user-plus mt-5 text-primary"></i> <font class="text-primary"> <span class="eng-content"> Customer Registration | Agent Details </span><span class="mal-content mal_content_reg">     ഉപഭോക്തൃ രജിസ്ട്രേഷൻ |  ഏജന്റ് രജിസ്ട്രേഷൻ   </span> </font>  <hr>
...
<button type="button" class="close" data-dismiss="alert" aria-label="Close">
  ...
  <p class="text-primary"> <strong> <em>  <span class="mal-content mal_content_reg">ഏജന്റ് രജിസ്ട്രേഷൻ ഫോം  </span> <span class="eng-content"> <font face="Book Antiqua">  Agent Registration Form </font> </span> </em> </strong> </p>
  <font class="text-primary"> <span class="mal-content mal_content_reg">ഏജന്റിന്റെ വിവരങ്ങൾ രജിസ്റ്റർ ചെയ്യുക. എല്ലാ വിവരങ്ങളും നിർബന്ധമായും പൂരിപ്പിക്കേണ്ടതാണ്. ബോട്ടുടമയുടെ വിവരങ്ങൾ ഏജന്റിന് ലഭ്യമാക്കുന്നതല്ല. എല്ലാ അറിയിപ്പുകളും ബോട്ടുടമയുടെ ഈമെയിൽ, മൊബൈൽ നമ്പറിൽ മാത്രമെ ലഭ്യമാവുകയുള്ളൂ.  </span> <span class="eng-content"> Please enter details about your agent. All fields are mandatory. Your login credential will not be shared with the agent. All intimations will be sent to vessel owner's email id and mobile number. </span>
    <span class="mal-content mal_content_reg">
      <a href="http://portinfo.kerala.gov.in" target="_blank" class="btn btn-sm btn-outline-success">കൂടുതൽ വിവരങ്ങൾക്ക് ഇവിടെ ക്ലിക്ക് ചെയ്യാവുന്നതാണ് </a> </span> <span class="eng-content">
  ...
  <div class="row oddrows">
   <div class="col-2 border-top border-bottom ">
      <p class="mt-4 text-secondary"><em><span class="mal-content mal_content_reg">ഏജന്റിന്റെ പേര് </span> <span class="eng-content">Agent Name </span></em><font color="red">*</font></p>
    </div>
    <div class="col border-top border-bottom">
             <div class="form-group mt-3">
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="Agent Name" name="user_name" id="user_name" required onkeypress="return alpbabetspace(event);" maxlength="50">
                    <div class="invalid-tooltip"> Please enter Agent Name  </div>
                  </div>
                  <span id="textval1"></span>
   </div> <!-- end of form group -->
    </div>
    <div class="col-2 border-top border-bottom border-left">
      <p class="mt-4 text-secondary"><em><span class="mal-content mal_content_reg">മേൽവിലാസം  </span> <span class="eng-content"> Address </span>
       </em><font color="red">*</font></p>
    </div>
    <div class="col border-top border-bottom">
       <div class="form-group mt-3">
                  <div class="input-group">
                   ...
                   <div class="invalid-tooltip"> Please enter Agent's Address </div>
                  </div>
                  <span id="textval1"></span>
   </div> <!-- end of form group -->
    </div>
    ...
    <div class="col border-bottom">
      <div class="form-group mt-3">
                  <div class="input-group">
                    ...
                    <div class="invalid-tooltip"> Please enter Agent mobile number </div>
                  </div>
                  <span id="textval1"></span>
   </div> <!-- end of form group -->
    </div>
    ...
    <div class="col border-bottom">
      <div class="form-group mt-3">
                  <div class="input-group">
                    ...
                    <div class="invalid-tooltip"> Please enter Agent email </div>
                  </div>
                  <span id="textval1"></span>
   </div> <!-- end of form group -->
    </div>
...
<div class="col-2 mt-4 mb-1">
  <span class="mal-content mal_content_reg"> 
    <button class="btn btn-success text-white btn-flat btn-block btn-point" type="submit" name="btnsubmit" id="btnsubmit"> <i class="fas fa-save"></i>  &nbsp; &nbsp;രജിസ്റ്റർ ചെയ്യുക  </button> </span> <span class="eng-content">
  <button class="btn btn-success text-white btn-flat btn-block btn-point" type="submit" name="btnsubmit" id="btnsubmit"> <i class="fas fa-save"></i>  &nbsp; &nbsp;Save </button>
</span>
</div>
</div><!-- end of 8th row -->
...
$('#minor_status').on('ifUnchecked', function () { $('#hdnminor').val(''); });


$('#agent_status').on('ifChecked', function () { $('#hdnagent').val(1); });
$('#agent_status').on('ifUnchecked', function () { $('#hdnagent').val(''); });

$('#co_owner_status').on('ifChecked', function () { $('#hdn_co_owner').val(1); });
$('#co_owner_status').on('ifUnchecked', function () { $('#hdn_co_owner').val(''); });
