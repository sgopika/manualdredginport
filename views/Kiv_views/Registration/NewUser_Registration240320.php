     ...
     <div class="form-group mt-3">
                  <div class="input-group">
                    <div class="input-group-prepend">
                     ...
                     <input type="file" class="form-control-file" id="my-file-selector2"  name="signature"  >
...
<span class="mal-content mal_content_reg"> <a class="btn btn-secondary  btn-block btn-flat btn-point" href="<?php echo base_url()."index.php/Main_login/index"?>"><i class="fas fa-home" ></i> &nbsp; &nbsp; ഹോം</a> </span> <span class="eng-content"> 
<a class="btn btn-secondary  btn-block btn-flat btn-point" href="<?php echo base_url()."index.php/Main_login/index"?>"><i class="fas fa-home" ></i> &nbsp; &nbsp; Home</a> </span>
...
<div class="col mt-4 mb-1">
  <span class="mal-content mal_content_reg"> <button class="btn btn-success text-white btn-flat btn-block btn-point" type="submit" name="btnsubmit" id="btnsubmit"> <i class="far fa-save"></i>&nbsp; &nbsp; രജിസ്റ്റർ ചെയ്യുക  </button>
  </span> <span class="eng-content"> 
  <button class="btn btn-success text-white btn-flat btn-block btn-point" type="submit" name="btnsubmit" id="btnsubmit"> <i class="far fa-save"></i>&nbsp; &nbsp; Save </button> </span>
</div>
</div><!-- end of 8th row -->
...
<!-- 
  http://staging.portinfo.kerala.gov.in/index.php/Super_Ctrl/Super/reset_pwd
http://staging.portinfo.kerala.gov.in/index.php/Kiv_Ctrl/Master/dynamicform_byvessel
http://staging.portinfo.kerala.gov.in/index.php/Kiv_Ctrl/Master/copyDynamicform
http://staging.portinfo.kerala.gov.in/index.php/Kiv_Ctrl/Master/viewCopyDynamicform
http://staging.portinfo.kerala.gov.in/index.php/Kiv_Ctrl/Survey/add_newVessel
http://staging.portinfo.kerala.gov.in/index.php/Manual_dredging/Port/mailbox
http://staging.portinfo.kerala.gov.in/index.php/Manual_dredging/Master/workerqty_master
http://staging.portinfo.kerala.gov.in/index.php/Manual_dredging/Master/fee_master
http://staging.portinfo.kerala.gov.in/index.php/Manual_dredging/Report/user_notice
http://staging.portinfo.kerala.gov.in/index.php/Manual_dredging/Report/reg_lorry_pc
http://staging.portinfo.kerala.gov.in/index.php/Manual_dredging/Report/spot_reg_details
http://staging.portinfo.kerala.gov.in/index.php/Manual_dredging/Report/spot_registration


http://staging.portinfo.kerala.gov.in/index.php/Report/add_kadavu_spot
http://staging.portinfo.kerala.gov.in/index.php/Master/dredgeport_add
http://staging.portinfo.kerala.gov.in/index.php/Master/taxnamemaster_add
http://staging.portinfo.kerala.gov.in/index.php/Manual_dredging/Master/holidaysettings
 -->
