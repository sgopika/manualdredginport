...
$value133='<input type="text" name="name_of_type[]" value="" id="name_of_type1"  class="form-control"  autocomplete="off" placeholder="Enter name" data-validation="required" required />';

  /*$value134='<select class="form-control select2" name="crew_class_sl[]" id="crew_class_sl1" title="" data-validation="required" >
  <option value="">Select</option>';
  ...
  $value134.='</select>';
*/
  $value135='<input type="text" name="license_number_of_type[]" value="" id="license_number_of_type1"  class="form-control"  autocomplete="off" placeholder="Enter license number" data-validation="required" required  /> '; 
...
var passcnt=parseInt($("#rowcount").val());
 $.ajax
    ({
      type: "POST",
      url:"<?php echo site_url('/Kiv_Ctrl/Survey/add_crew_form5/')?>"+passcnt+'/'+vessel_id,
