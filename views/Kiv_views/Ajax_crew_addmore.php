...
$static_array = array_column($label_details, 'label_sl');
	...
	$value186='<select class="form-control select2" name="crew_type_sl[]" id="crew_type_sl1" title="" data-validation="required" required="required">
...
$value187='<input type="text" name="name_of_type[]" value="" id="name_of_type1"  class="form-control"  autocomplete="off" placeholder="Enter name" data-validation="required" required  onpaste="return false;" onkeypress="return IsAddress(event);"/>';
	...
	$value189='<input type="text" name="license_number_of_type[]" value="" id="license_number_of_type1"  class="form-control"  autocomplete="off" placeholder="Enter license number" data-validation="required" required  onpaste="return false;" onkeypress="return IsAddress(event);"/>'; 
