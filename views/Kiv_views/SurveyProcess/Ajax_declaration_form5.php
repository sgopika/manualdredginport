...
?>
  <input type="hidden" name="hdn_vesselId" id="hdn_vesselId" value="<?php echo $vesselId; ?>" >
    ...
    <div class="col-3 border-bottom ">
      <div class="form-group mt-2 mb-2">
        <input type="text" name="declarationDate" value="" id="declarationDate"  class="form-control dob"  maxlength="10" autocomplete="off" placeholder="Enter Declaration date" data-validation="required" required onchange="return prevDate(this.id);"  />
      </div> <!-- end of form group -->
    </div><!-- end of col -->';
