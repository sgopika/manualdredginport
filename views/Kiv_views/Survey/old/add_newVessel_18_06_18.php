   ...
   <!-- Main Content starts here -->
     ...
     <div class="row custom-inner">
      <!-- start inner custom row -->
       ...
       //echo form_open("Survey/add_newVessel", $attributes); ?>
           ...
           <table id="vacbtable" class="table table-bordered table-striped">
            ...
            <input type="text" name="vessel_expected_completion" value="" id="vessel_expected_completion"  class="form-control"  maxlength="30" autocomplete="off"  /> Eg: 2018
            </div></div></td>
          </tr>
           <tr> 
          ...
          <tr> 
            ...
            <input type="text" name="vessel_length" value="" id="vessel_length"  class="form-control"  maxlength="30" autocomplete="off"  />&nbsp;in metres <!--placeholder="...in metres"-->
            </div></div></td> 
              <td> <div class="div100"> <div class="form-group">
            <input type="text" name="vessel_breadth" value="" id="vessel_breadth"  class="form-control"  maxlength="30" autocomplete="off" />&nbsp;in metres
            </div></div></td> 
              <td> <div class="div100"> <div class="form-group">
            <input type="text" name="vessel_depth" value="" id="vessel_depth"  class="form-control"  maxlength="30" autocomplete="off" />&nbsp;in metres
            </div> </div></td> 
              <td> <div class="">
      ...
      <tr> 
            ...
            <td> <div class="div100"> <div class="form-group">
            <input type="text" name="hull_thickness" value="" id="hull_thickness"  class="form-control"  maxlength="30" autocomplete="off" />&nbsp;in millimetres
            </div> </div></td>
          </tr>
          ...
          <tr> 
            ...
            <td> <div class="div100"> <div class="form-group">
            <input type="text" name="hull_plating_material_thickness" value="" id="hull_plating_material_thickness	"  class="form-control"  maxlength="30" autocomplete="off" />&nbsp;in millimetres <!--placeholder="...in mm"-->
            </div> </div></td>
          </tr>
           <tr> 
           ...
           <tr> 
            ...
            <td> <div class="div100"> <div class="form-group">
            <input type="text" name="bulk_head_thickness" value="" id="bulk_head_thickness"  class="form-control"  maxlength="30" autocomplete="off" />&nbsp;in millimetres 
            </div> </div></td>
          </tr>
          <tr> <td colspan="5"> 
      ...
      <!------------------------------------------- Particulars of Engine --------------------------------------->
            ...
            <button type="button" class="btn btn-warning pull-right btn-space" name="tab3back" id="tab3back">Back</button>  
             ...
             <tr> <td colspan="2"> </td> <td > Port</td> 
              <td>  <div class="div100"> <div class="form-group">
            <input type="text" name="weight1" value="" id="weight1"  class="form-control "  maxlength="30" autocomplete="off" />&nbsp; in kg
            </div> </div> </td> 
            <td> 
                 <div class="form-group">
             ...
             <tr> <td colspan="2"> </td> <td > Starboard</td> 
              <td> <div class="div100"> <div class="form-group">
            <input type="text" name="weight2" value="" id="weight2"  class="form-control"  maxlength="30" autocomplete="off" />&nbsp;in kg <!--placeholder="...in kg"-->
            </div> </div></td> 
            <td> 
                 <div class="form-group">
             ...
             <tr> <td colspan="2"> </td> <td > Spare </td> 
              <td> <div class="div100"> <div class="form-group">
            <input type="text" name="weight3" value="" id="weight3"  class="form-control"  maxlength="30" autocomplete="off" /> &nbsp;in kg
            </div> </div></td> 
            <td> 
                 <div class="form-group">
            ...
            <td> <div class="div100"> <div class="form-group">
            <input type="text" name="length4" value="" id="length"  class="form-control"  maxlength="30" autocomplete="off" />&nbsp;in meter
            </div> </div> </td>
              <td>  
                 <div class="form-group">
            ...
            <td>  <div class="div100"> <div class="form-group">
            <input type="text" name="length5" value="" id="length"  class="form-control"  maxlength="30" autocomplete="off" />&nbsp;in meter
            </div> </div></td> 
            <td>  
                 <div class="form-group">
          ...
          <tr> 
            ...
            <div class="form-group">
             ...
             <tr>  
              ...
              <td> <div class="div100"> <div class="form-group">
            <input type="text" name="water_consumption" value="" id="water_consumption"  class="form-control"  maxlength="30" autocomplete="off"  />&nbsp;in litre
            </div> </div></td>
           ...
           <input id="my-file-selector1" type="file" style="display:none" name="asdf"  onchange="$('#upload-file-info1').html(this.files[0].name)"> Browse File  </label>
            ...
            <div class="form-group">
                 <div class="input-group date">
                  <div class="input-group-addon">
                    ...
                    <input type="text" class="form-control" id="datepicker"  name="vessel_pref_inspection_date"  >
                </div>
                <!-- /.input group -->
              </div>
              <!-- /.form group -->
                 ...
                 <div class="input-group date">
                  <div class="input-group-addon">
                    <i class="fa fa-calendar"></i>
                     ...
                     <input type="text" class="form-control" id="datepicker" name="dd_date">
                </div>
                <!-- /.input group -->
              </div>
              <!-- /.form group -->
