   ...
   /* function validate()
      {
         ...
         document.form1.vessel_name.focus();
   {
  ...
  $("#tab1next").click(function() {
   ...
   //var str = $("#form1").serialize();
     ...
     $.ajax({
            ...
            type: "POST",
          data:{vessel_name:vessel_name, vessel_expected_completion:vessel_expected_completion},
   // data:{str},
            //dataType: "JSON",
      ...
      <!-- start inner custom row -->
        ...
        <div class="col-md-12">
          ...
          <div class="box-header with-border">
              ...
              <?php
   /*
              foreach($form_stage as $result_stage)
              {
                 $stage_count=$result_stage['stage_count'];
              }
*/
              ?>
          ...
          <div class="nav-tabs-custom">
           ...
           <div class="tab-pane active" id="tab_1">
               <form name="form1" id="form1" method="post" enctype="multipart/form-data"> 
                  ...
                  <?php 
       /* $attributes = array("class" => "form-horizontal", "id" => "add_newVessel", "name" => "add_newVessel" , "novalidate");
		
		if(isset($editres)){
       		echo form_open("Survey/add_vessel_details", $attributes);
		} else {
			echo form_open("Survey/add_vessel_details", $attributes);
		}*/ ?>
          ...
          <tr> 
            ...
            <tr > <td colspan="5">  
                   ...
                   <button type="button" class="btn btn-info pull-right" name="tab1next" id="tab1next" onclick="return validate()">Next</button> 
