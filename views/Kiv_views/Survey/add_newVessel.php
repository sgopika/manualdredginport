    ...
    <div class="col border-top border-bottom ves_div1">
      <div class="form-group mt-2 mb-2">
        <div class="input-group">
            <input type="text" name="vessel_length_overall" value="" id="vessel_length_overall"  class="form-control"  maxlength="4" autocomplete="off" title="Length Over All" onkeypress="return IsDecimal(event);" onchange="return IsZero(this.id);"/>
