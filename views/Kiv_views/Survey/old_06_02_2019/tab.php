...
<ul class="nav nav-tabs" id="myTab" role="tablist">
  <li class="nav-item">
    <a class="nav-link active" id="Vessel-tab" data-toggle="tab" href="#tab_1" role="tab" aria-controls="Vessel Details" aria-selected="true">Vessel Details</a>
  </li>

  <li class="nav-item">
    <a class="nav-link" id="Hull-tab" data-toggle="tab" href="#tab_2" role="tab" aria-controls="Particulars of Hull" aria-selected="false">Particulars of Hull</a>
  </li>

  <li class="nav-item">
    <a class="nav-link" id="engine-tab" data-toggle="tab" href="#tab_3" role="tab" aria-controls="Particulars of Engine" aria-selected="false">Particulars of Engine</a>
  </li>
   <li class="nav-item">
    <a class="nav-link" id="equipment-tab" data-toggle="tab" href="#tab_4" role="tab" aria-controls="Particulars of Equipment" aria-selected="false">Particulars of Equipment</a>
  </li>
   <li class="nav-item">
    <a class="nav-link" id="fireappliance-tab" data-toggle="tab" href="#tab_5" role="tab" aria-controls="Particulars of Fire Appliance" aria-selected="false">Particulars of Fire Appliance</a>
  </li>
   <li class="nav-item">
    <a class="nav-link" id="otherequipment-tab" data-toggle="tab" href="#tab_6" role="tab" aria-controls="Other Equipment" aria-selected="false">Other Equipments</a>
  </li>
   <li class="nav-item">
    <a class="nav-link" id="documents-tab" data-toggle="tab" href="#tab_7" role="tab" aria-controls="Documents" aria-selected="false">Documents</a>
  </li>
<li class="nav-item">
    <a class="nav-link" id="payment-tab" data-toggle="tab" href="#tab_8" role="tab" aria-controls="Payment" aria-selected="false">Payment</a>
  </li>
