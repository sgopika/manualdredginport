...
<button type="button" class="btn bg-primary btn-flat margin"> Initial Survey Timeline </button>
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#"></i>  <span class="badge bg-blue"> New Applications </span> </a></li>
      ...
      <!-- start inner custom row -->
        <div class="col-md-12">
          ...
          <ul class="timeline">
            ...
            <li class="time-label">
                  <span class="bg-red">
                    Initial Survey / New Applications
                  </span>
            </li>
            <!-- /.timeline-label -->
            <!-- timeline item -->
            ...
            <li>
              ...
              <div class="timeline-item">
                <h3 class="timeline-header"><a href="#">പുതിയ അപേക്ഷകൾ / New Applications (Form 1)</a> </h3>
              ...
              <table id="example" class="table table-bordered table-striped">
                ...
                <td><a href="<?php echo $site_url.'/Survey/View_Vessel/'.$vessel_sl ?>" target="_blank" class="btn btn-primary btn-xs"> View</a></td>
                <td>
                <?php if($status==1) { ?>
                <a href="<?php echo $site_url.'/Survey/Verify_Vessel/'.$vessel_sl.'/'.$processflow_sl ?>" class="btn btn-danger btn-xs">Verify</a>
                <?php
              }
                ?>
                </td>
