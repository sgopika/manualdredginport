...
?>
  <div class="box-body">
  <form name="form1" id="form1" method="post" action="<?php echo $site_url.'/Survey/csTask/'.$vessel_id.'/'.$processflow_sl.'/'.$survey_id //echo $site_url.'/Survey/csTask/'.$vessel_id  ?>">
...
?>
	...
	<tr>
	<td>Preferred Inspection Date by Vessel Owner</td>
	<td><?php echo $vessel_pref_inspection_date; ?></td>
	<td>
		vid<input type="text" name="vessel_id" id="vessel_id" value="<?php echo $vessel_id; ?>"><br>
		pid<input type="text" name="process_id" id="process_id" value="<?php echo $vessel_details[0]['process_id']; ?>"><br>
		sid<input type="text" name="survey_id" id="survey_id" value="<?php echo $vessel_details[0]['survey_id']; ?>"><br>
		prid<input type="text" name="processflow_sl" id="processflow_sl" value="<?php echo $processflow_sl; ?>"><br>
		uid<input type="text" name="user_id" id="user_id" value="<?php echo $user_id; ?>"><br>
		utype<input type="text" name="user_type_id" id="user_type_id" value="<?php echo $user_type_id; ?>"><br>
		stid<input type="text" name="status_details_sl" id="status_details_sl" value="<?php echo $status_details_sl; ?>">
		</td>
	<td></td>
	</tr>
	<td><b>Slno</b></td>
...
foreach($processactivity_date as $res_date) { ?>
	<tr>
	<td><?php echo $i;  ?></td>
	<td><?php if($res_date['process_id']==2) {echo 'Keel Laying'; }   if($res_date['process_id']==3) {echo 'Hull Inspection'; } if($res_date['process_id']==4) {echo 'Final Inspection '; } ?></td>
	<td><?php echo date('d-m-Y', strtotime($res_date['activity_date']));  ?></td>
	<td><?php echo $res_date['remarks'];  ?></td>
	</tr>
	<?php 
	$i++;
	 }
	...
	<td><div class="div250">
		...
		<i class="fa fa-calendar"></i>
		 ...
		 <input type="text" class="form-control" id="datepicker3" name="inspection_date" title="Enter Inspection Date" data-validation="required">
		</div>
		</div>
		</div>
	</td>
