		...
		$.ajax({
			...
			success: function(data)
			{
				...
				$('.nav-tabs a[href="#tab_8"]').tab('show');
					$("#payment").html(data).find(".div200").select2();
...
<div class="tab-pane active" id="tab_1">
	<form name="form1" id="form1" method="post" class="form1" > 
		<!-- Vessel Details Div -->
		<div class="col-md-12 col-lg-12" id="vessel_details_div" style="padding-top: 1px;"> 
			<div class="col-md-6 ves_div1">
				<div class="col-md-6"> 
					 <font color="#282626"> <small> യാനത്തിന്റെ തരം / </small>  <h5> Type of vessel</h5> </font>
				</div><!-- end of inside 1div -->
				<div class="col-md-6 ves_div1">
		...
		?>
				...
				</div><!-- end of inside 2div -->
			</div><!-- end of one div-6 column -->
  			<div class="col-md-6 ves_div1">
				<div class="col-md-6"> 
					 <font color="#282626"> <small> യാനത്തിന്റെ സബ്ടൈപ്പ് / </small>  <h5>  Sub-type of vessel</h5> </font>
				</div><!-- end of inside 1div -->
				<div class="col-md-6 ves_div1">
					<div class="form-group">
					<select class="form-control select2" name="vessel_subtype_id" id="vessel_subtype_id" title="Select Vessel Sub Type" >	</select>
					</div><!-- /.form-group -->
				</div><!-- end of inside 2div -->
				</div><!-- end of one div-6 column -->	
								<div class="col-md-6 ves_div2">
				<div class="col-md-6"> 
					 <h5> Material of hull</h5>
				</div><!-- end of inside 1div -->
				<div class="col-md-6 ves_div2">
					<div class="form-group">
		<select class="form-control select2" name="hullmaterial_id" id="hullmaterial_id" title="Enter Material of hull" data-validation="required">
		<option value="">Select</option>
		...
		?>
								...
								<div class="col-md-6 ves_div2">
				<div class="col-md-6"> 
					 <h5> Whether Engine inboard/outboard</h5>
				</div><!-- end of inside 1div -->
				<div class="col-md-6 ves_div2">
					<div class="form-group">
						<select class="form-control select2" name="engine_placement_id" id="engine_placement_id" title="Select Engine inboard/outboard" data-validation="required">
                         <option value="">Select</option>
                    <?php
				...
				<div class="col-md-6 ves_div1">
				<div class="col-md-6"> 
					 <font color="#282626"> <small> യാനത്തിന്റെ പേര്  / </small>  <h5>Vessel name  </h5> </font>
				</div><!-- end of inside 1div -->
				<div class="col-md-6 ves_div1">
					<div class="form-group">
				<input type="text" name="vessel_name" value="" id="vessel_name"  class="form-control"  maxlength="30" autocomplete="off" title="Enter Vessel Name" data-validation="required"/>
								...
								<div class="col-md-6 ves_div1">
				<div class="col-md-7"> 
				<font color="#282626"> <small> നിർമ്മാണം പൂർത്തീകരിക്കാവുന്ന വർഷം </small>  <h5>Proposed month and year of completion  </h5> </font>
				</div><!-- end of inside 1div -->
				<div class="col-md-3 ves_div1">
					<div class="form-group">
		...
		?>
				...
				</div><!-- end of inside 3div -->
				</div><!-- end of one div-6 column -->	
				<div class="col-md-6 ves_div2">
				<div class="col-md-6"> 
					 <font color="#282626"> <small> യാനത്തിന്റെ വിഭാഗം / </small>  <h5> Category of vessel </h5> </font> 
				</div><!-- end of inside 1div -->
				<div class="col-md-6 ves_div2">
					<div class="form-group">
		...
		?>
				...
				<div class="col-md-6 ves_div2">
				<div class="col-md-6"> 
					 <font color="#282626"> <small> യാനത്തിന്റെ ഉപവിഭാഗം / </small>  <h5> Sub category of vessel</h5> </font>
				</div><!-- end of inside 1div -->
				<div class="col-md-6 ves_div2">
					<div class="form-group">
				...
				<div class="col-md-6 ves_div1">
				<div class="col-md-6"> 
					 <font color="#282626"> <h5>Length Overall  </h5> </font> 
				</div><!-- end of inside 1div -->
				<div class="col-md-6 ves_div1">
				...
				<div class="col-md-6 ves_div1">
				<div class="col-md-6"> 
					 <font color="#282626"> <small>  </small>  <h5>Number of Deck</h5> </font>
				</div><!-- end of inside 1div -->
				<div class="col-md-6 ves_div1">
					<div class="form-group">
				...
				<div class="col-md-12 ves_div2" id="over_deck_id">
				<div class="col-md-3"> 
					 <font color="#282626">  <h5> <small> നീളം / </small> Length Over the Deck</h5> </font>
				</div>
				<div class="col-md-3"> 
					 <font color="#282626">  <h5> <small> വീതി /</small> Breadth </h5> </font>
				</div>
				<div class="col-md-3"> 
					 <font color="#282626"> <h5>  <small> ആഴം / </small> Depth </h5> </font>
				</div>
				<div class="col-md-3"> 
					 <font color="#282626">  <h5> <small> ഭാരം / </small> Tonnage </h5> </font>
				</div>
			    </div><!-- end of inside coldiv12-instead of col6 -->	
			    <div class="col-md-12 ves_div1" id="over_deck_id_value">
				<div class="col-md-3"> 
					 <div class="input-group">
		...
		<button type="button" class="btn bg-olive btn-flat" id="check_tonnage"> Check </button>
			    ...
			    </div><!-- inside div_col_12_instead_of_div_6 -->
			    <div class="col-md-12 ves_div2" id="upper_deck_id">
				<div class="col-md-3"> 
					 <font color="#282626"> <h5> <small> നീളം / </small>  Length Upper the Deck</h5> </font>
				</div>
				<div class="col-md-3"> 
					 <font color="#282626">  <h5><small> വീതി / </small> Breadth </h5> </font>
				</div>
			    ...
			    <div class="col-md-12 ves_div1" id="upper_deck_id_value">
				<div class="col-md-3"> 
					 <div class="input-group">
		...
		<span class="input-group-addon">m</span>
				...
				<div class="col-md-3"> <div class="col-md-6">
					 <div class="form-group">
		<button type="button" class="btn bg-olive btn-flat" id="check_tonnage_upperdeck"> Check </button></div> </div>  <div class="col-md-6" id="Ton_upperdeck">
		<font color="#00f" id="show_upperdeck_tonnage">  </font>  </div>
				</div>
			    </div><!-- inside div_col_12_instead_of_div_6 -->
				<div class="col-md-12 ves_div2"> <div class="col-md-1 pull-right">
					<button type="button" class="btn btn-primary btn-flat btn-block btn-lg" name="tab1next" id="tab1next" >Save</button> </div>
				</div><!-- end of button div -->
       </div> <!-- End of vessel_details_div -->
	</form>  
<?php
?>
</div>
...
<tr> <td colspan="5"> 
		...
		<button type="button" class="btn btn-warning pull-right btn-space" name="tab8back" id="tab8back">Back</button>  
              ...
              <!-- __________________ Owner Details ________________ ->
              <?php 
