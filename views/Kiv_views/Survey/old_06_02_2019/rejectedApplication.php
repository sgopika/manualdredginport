...
<button type="button" class="btn bg-primary btn-flat margin"> Initial Survey Timeline </button>
      ...
      <ol class="breadcrumb">
       ...
       <li><a href="#"></i>  <span class="badge bg-blue"> Rejected Applicaton </span> </a></li>
      ...
      <!-- start inner custom row -->
        <div class="col-md-12">
          ...
          <ul class="timeline">
            ...
            <li class="time-label">
                  <span class="bg-red">
                    Initial Survey / Rejected Applications
                  </span>
            </li>
            <!-- /.timeline-label -->
            <!-- timeline item -->
            ...
            <li>
              ...
              <div class="timeline-item">
                <h3 class="timeline-header"><a href="#">Rejected Applications</a> </h3>
