...
$status_details_sl2=str_replace(array('+', '/', '='), array('-', '_', '~'), $status_details_sl1);
             ...
             elseif($process_id==31) {
                ?>
                <a href="<?php echo $site_url.'/Kiv_Ctrl/Survey/Verify_payment_pc_additionalpayment/'.$vessel_sl.'/'.$processflow_sl.'/'.$survey_id ?>" class="btn btn-primary btn-flat btn-sm">Verify payment form <?php echo $form_no; ?></a>
                <?php
              }
