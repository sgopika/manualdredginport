...
<!-- <table id="example" class="display mytableheader" style="width:100%" border="0"> -->
  ...
  <thead>
    <tr><th colspan="9"><font size="4">Duplicate Certificate for Registered Vessels</font></th></tr>  
    <tr>
    <th>#</th>
    <th>Vessel Name</th>
    <th>Vessel Type</th>
 ...
 //print_r($namechange_det);
  foreach($dupcertificate_det as $res1)
  {
    $vessel_sl              = $res1['vesselmain_vessel_id'];
    $ref_number             = $res1['ref_number'];
    $approved_id            = $res1['duplicate_cert_decisionmake_id'];
    $pay_status             = $res1['duplicate_payment_status'];
    $user_type_name         = $res1['user_type_type_name'];
    $change_status          = $res1['duplicate_cert_status'];
    $processid              = 41;
