...
{
  $process_id               = 40;//$vessel_details[0]['process_id'];
...
$data['transfer_type']      = $transfer_type; //print_r($transfer_type);
...
<div class="main-content ">  <!-- Container Class overridden for edge free design -->
  <div class="row ui-innerpage">
    <div class="col-12"> 
      <div class="row">
        ...
        <div class="col mt-2 text-primary">
          Request for Transfer of Registered Vessel 
        </div>
      </div> <!-- inner row -->
    ...
    <div class="col-12 mt-2 ml-2 newfont">
      ...
      <div id="form12show">
        ...
        <form name="form11" id="form11" method="post"  enctype="multipart/form-data" action="<?php echo $site_url.'/Kiv_Ctrl/VesselChange/pay_now_form18_trans/'.$vessel_sl1.'/'.$processflow_sl1.'/'.$status_details_sl1 ?>">
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <input type="hidden" value="<?php echo $trans_typ; ?>" id="transfer_type" name="transfer_type"> 
...
var transfer_type=$("#transfer_type").val();//alert(transfer_type);
 //if($("#form8").isValid())
 // { 
    $.ajax({
      url : "<?php echo site_url('Kiv_Ctrl/VesselChange/showpayment19/')?>"+vessel_id,
      type: "POST",
...
$("#btnsubmit").click(function()
{
  ...
  // { 
    $.ajax({
      url : "<?php echo site_url('Kiv_Ctrl/VesselChange/not_payment_details_form19')?>",
      type: "POST",
      data:$('#form11').serialize(),
      //dataType: "JSON",
      success: function(data)
