...
<table width="50%" border="1" cellpadding="0" cellspacing="0" align="center" >
	<tr>
		<td>Merchant key</td>
		<td></td>
		<td><input type="text" name="merchant_key" id="merchant_key" value="<?php echo $online_payment_data[0]['merchant_key'];?>"></td>
	</tr>
	<tr>
		<td>Order id</td>
		<td></td>
		<td><input type="text" name="order_id" id="order_id" value="<?php ?>"></td>
	</tr>
	<tr>
		<td>Amount</td>
		<td></td>
		<td><input type="text" name="amount" id="amount" value="<?php echo $amount_tobe_pay; ?>"></td>
	</tr>
	<tr>
		<td>Currency</td>
		<td></td>
		<td><input type="text" name="currency" id="currency" value="<?php echo 'INR';?>"></td>
	</tr>
	<tr>
		<td>Redirect URL</td>
		<td></td>
		<td><input type="hidden" name="redirect_url" id="redirect_url" value="<?php echo base_url('index.php/Hdfc/Hdfc_response');?>"/></td>
	</tr>
	<tr>
		<td>Cancel URL</td>
		<td></td>
		<td><input type="hidden" name="cancel_url" id="cancel_url" value="<?php echo base_url('index.php/Hdfc/Hdfc_response');?>"/></td>
	</tr>
</table>
 -->
...
<body>
 ...
 ?>
			...
			<table width="40%" height="100" border='1' align="center">
				...
				<tr>
					<td>Order Id	:</td><td><input type="hidden" name="order_id" value="<?php //echo $tokenno;?>"/></td>
				</tr>
				<tr>
