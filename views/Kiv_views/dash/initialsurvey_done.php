...
echo form_open("Kiv_Ctrl/Survey/initialsurvey_done", $attributes);
?>
...
<div class="main-content ui-innerpage">
  ...
  <div class="col-10 text-center">
      <div class="alert bg-darkslateblue" role="alert">
        Completed Initial Survey Details
      </div> <!-- end of alert -->
  </div> <!-- end of col10 -->
...
<?php if(!empty($initial_survey_done)) { ?>
...
<div class="table-responsive">
 <table id="example" class="table table-bordered table-striped table-hover dataTable no-footer" role="grid" aria-describedby="example1_info">
        <thead>
          <tr><th colspan="9"><font size="4">Initial survey completed</font></th></tr>
            <tr>
                  <th>#</th>
        ...
        <tbody>
            <?php
                ...
                foreach($initial_survey_done as $res1)
                {
...
$survey_id2=str_replace(array('+', '/', '='), array('-', '_', '~'), $survey_id1);
                ...
                <td>
                <?php if($category==1) { ?>
                <a  href="<?php echo site_url(); ?>/Survey/form9_view/<?php echo $vessel_sl; ?>/<?php echo $survey_id2;?>" target="_blank" width="30" height="30"><?php echo 'Form '. $form_number; ?> </a>
                <?php } ?>


                <?php if($category==2) { ?>
                <a  href="<?php echo site_url(); ?>/Kiv_Ctrl/Survey/form10_view/<?php echo $vessel_sl; ?>/<?php echo $survey_id2;?>" target="_blank" width="30" height="30"><?php echo 'Form '. $form_number; ?> </a>
                <?php } ?>
