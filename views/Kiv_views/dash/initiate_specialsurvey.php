...
$survey_id2=$res1['subprocess_id'];

$survey_type          = $this->Survey_model->get_survey_type($survey_id2);
...
$processflow_sl=str_replace(array('+', '/', '='), array('-', '_', '~'), $processflow_sl1);
                ...
                <td>
                   <a href="<?php echo $site_url.'/Kiv_Ctrl/Survey/initiate_/'.$vessel_sl.'/'.$processflow_sl.'/'.$survey_id  ?>" class="btn btn-danger btn-xs">Verify defect</a>
                </td>
                </tr>
                <?php
                $i++;
