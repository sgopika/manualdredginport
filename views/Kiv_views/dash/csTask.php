...
?>
<!-- <form name="form1" id="form1" method="post" action="<?php echo $site_url.'/Kiv_Ctrl/Survey/csTask/'.$vessel_id1.'/'.$processflow_sl1.'/'.$survey_id1 ?>">
 -->
...
$attributes = array("class" => "form-horizontal", "id" => "form1", "name" => "form1", "enctype"=> "multipart/form-data");
  echo form_open("Kiv_Ctrl/Survey/csTask/".$vessel_id1.'/'.$processflow_sl1.'/'.$survey_id1, $attributes);
  ?>
...
<div class="col-3 d-flex justify-content-left mt-1 mb-1 text-primary formfont pl-1">
   ...
   <!--  <div class="form-group">
     <input type="text" class="form-control dob" id="inspection_date" name="inspection_date" title="Enter Inspection Date" data-validation="required">
    </div> -->
