...
; ?>">
<input type="hidden" name="sess_usr_id " id="sess_usr_id " value="<?php echo $sess_usr_id  ; ?>">
...
<div class="row no-gutters evenrow border-bottom" id="survey1">
<div class="col-3 d-flex justify-content-left mt-1 mb-1 text-dark formfont pl-1">
Amount
</div> <!-- end of col-3 1st-->
<div class="col-3 d-flex justify-content-left mt-1 mb-1 text-primary formfont">

<!--  <input type="text" class="form-control" name="dd_amount" value="<?php echo $amount_tobe_pay; ?>" id="dd_amount" autocomplete="off"  required readonly> -->

<input type="text" name="dd_amount" id="dd_amount" value="1" readonly> 
