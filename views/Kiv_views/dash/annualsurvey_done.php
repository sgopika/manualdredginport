...
echo form_open("Kiv_Ctrl/Survey/annualsurvey_done", $attributes);
?>
...
<div class="main-content ui-innerpage">
  ...
  <div class="col-10 text-center">
      <div class="alert bg-darkslateblue" role="alert">
        Completed Annual Survey Details
      </div> <!-- end of alert -->
  </div> <!-- end of col10 -->
...
<?php if(!empty($annual_survey_done)) { ?>
<?php if($day=='30') { ?>
...
<table id="example" class="table table-bordered table-striped table-hover dataTable no-footer" role="grid" aria-describedby="example1_info">
        <thead>
           <tr><th colspan="9"><font size="4">Annual survey completed</font></th></tr>
            <tr>
                  <th>#</th>
