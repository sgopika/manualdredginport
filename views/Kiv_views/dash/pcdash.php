      ...
      <div class="card-body ">
        <div class="row no-gutters p-1">
         ...
         foreach($mod_qry as $details){ 
            ...
            //print_r($user_module_id);
             if(!empty($user_module_id))
            {
              $user_master_id_user_type  = $user_module_id[0]['user_master_id_user_type'];
            $main_module_id  = $user_module_id[0]['main_module_id'];
            }
                  ...
                  <div class="col-8 leftbordercard">
                    <div class="card-body">
                      <h5 class="card-title">
                       ...
                       {
                        ?>
                         <a class="no-link" href="<?php echo base_url(); ?>index.php/Manual_dredging/Port/user_change_pw"> CHANGE PASSWORD </a>
                      <?php
                         }
                       else
                       {
