...
$survey_intimation          = $this->Survey_model->get_survey_intimation_details_owner($vessel_id,$survey_id1);
...
<div class="col-8 py-2 text-secondary px-3"><?php echo $date_of_survey; ?>
</div>
</div> <!-- end of postodd -->
