...
<!-- ########################################################################################### -->
 <!-- inside content -->
<div><font size="4"><strong>Form --</strong></font></div>

<form name="form20_payment" id="form20_payment" method="post" action="<?php echo $site_url.'/Kiv_Ctrl/VesselChange/Verify_payment_pc_form20/'.$vessel_id.'/'.$processflow_sl.'/'.$survey_id ?>">
