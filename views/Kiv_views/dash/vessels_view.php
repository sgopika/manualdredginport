...
foreach($vessel_details_viewpage as $res_vessel)
{
  ...
  $sewage_treatment       = $res_vessel['sewage_treatment'];
    ...
    $vessel_sl            = $res_vessel['vessel_sl'];
  ...
  if($vessel_category_id!=0)
  {
    $vessel_subcategory_id6      =   $this->Survey_model->get_vessel_subcategory_id($vessel_subcategory_id);
  ...
  {
    $vessel_subtype_id6      =   $this->Survey_model->get_vessel_subtype_id($vessel_subtype_id);
...
<script type="text/javascript">
  function IsAddress(e) 
        ...
        if ( (unicode == 47) || (unicode == 40) || (unicode == 41) || (unicode == 45) || (unicode >64 && unicode<91) || (unicode > 47 && unicode < 58)  || (unicode==8)  ) 
        {
                return true;
        }
        else 
        ...
        //(unicode == 32) ||  (unicode == 44) || || (unicode > 96 && unicode < 123)
</script>
<!-- Start of breadcrumb -->
...
<div class="col-6 formfont "> <button class="btn-sm btn-flat btn btn-outline-primary "><i class="fab fa-wpforms"></i>&nbsp; Initiate special survey </button></div>
...
echo form_open("Kiv_Ctrl/Survey/initiate_specialsurvey", $attributes);
?>
...
<input type="hidden" name="vessel_id" id="vessel_id" value="<?php echo $vessel_sl; ?>">
...
<div class="col-9 d-flex justify-content-left mt-1 mb-1 text-primary formfont">
 <select name="survey_id_assign" id="survey_id_assign" required="required">
 <option value="">Select</option>
   <option value="2">Annual survey</option><!-- 17 -->
   <option value="3">Drydock survey</option><!-- 26 -->
 </select>
</div> <!-- end of col-3 2nd-->
