  ...
  <table class="table table-striped table-hover table-sm">
            ...
            <tbody class="bcontentfont">
              ...
              <tr class="">
                ...
                <td> <?php if(strtotime($date) < strtotime($next_annual_date) && $processing_status==0) {?>  <?php } else {?> <a href="<?php echo $site_url.'/Kiv_Ctrl/Survey/annual_survey/'.$vessel_sl.'/'.$processflow_sl.'/'.$survey_id2 ?>"><button class="btn btn-flat btn-point btn-sm bg-chocolate"><i class="fas fa-rupee-sign"></i> &nbsp; Renew </button> </a>
               ...
               <tr class="">
                ...
                <td class="<?php if(strtotime($date) < strtotime($next_drydock_date)) {?>text-fuchsia<?php } else {?>text-crimson<?php } ?>"><strong><?php echo $next_drydock_date; ?></strong> </td>
