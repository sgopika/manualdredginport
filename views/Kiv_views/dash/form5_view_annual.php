...
if(!empty($vessel_details_viewpage))
{
  foreach($vessel_details_viewpage as $res_vessel)
  {
    ...
    $operation_area             =     $res_vessel['operation_area'];
...
$bilgepump             =    $this->Survey_model->get_bilgepump($vessel_id);
...
$firepumps             =    $this->Survey_model->get_firepumps($vessel_id);
...
//-----------Get Sandbox :  tbl_kiv_equipment_details --------------//
 ...
 $equipment_details_sandbox         =   $this->Survey_model->get_type_equipment_details_view($vessel_id, $equipment_id12, $equipment_type_id4,,$survey_id);
 ...
 $equipment_details_lifejkt         =   $this->Survey_model->get_type_equipment_details_view($vessel_id, $equipment_id17, $equipment_type_id11,$survey_id);
...
<div class="col-6 formfont "> <button class="btn-sm btn-flat btn btn-outline-primary" id="form3"><i class="fab fa-wpforms"></i>&nbsp; Form 5 </button>&nbsp;
</div>
...
<!-- <form name="form1" id="form1" method="post" action="<?php echo $site_url.'/Kiv_Ctrl/Survey/form5_entry_annaul/'.$vessel_id1.'/'.$processflow_sl1.'/'.$survey_id1 ?>"> -->
  <?php
$attributes = array("class" => "form-horizontal", "id" => "form1", "name" => "form1", "enctype"=> "multipart/form-data");
  echo form_open("Kiv_Ctrl/Survey/form5_entry_annaul/".$vessel_id1.'/'.$processflow_sl1.'/'.$survey_id1, $attributes);
  ?>

<!-- ____________________________ Vessel Details ____________________________ -->
<div class="col-12 py-2 d-flex justify-content-center text-primary"> <strong>FORM NO. 5</strong> </div>
...
<div class="col-4 d-flex justify-content-left mt-1 mb-1 text-primary  formfont" >
<?php  echo $fuel_tank_material_condition_id; ?>  
</div> <!-- end of col-3 4th-->
</div> <!-- end of row -->
...
Certified that I have inspected the <?php echo $vessel_name; ?> on <?php echo $date_of_survey; ?> <?php echo $time_of_survey; ?> at <?php echo $placeofsurvey_name;  ?> and found in good condition for issuing fitness certificate
</div> <!-- end of col-3 1st-->
...
<div class="col-8 d-flex justify-content-end mt-1 mb-1 text-primary  formfont" >
Designation of officer: <?php echo $user_type_name; ?>
</div> <!-- end of col-3 4th-->
</div> <!-- end of row -->
