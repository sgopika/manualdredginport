...
$vessel_details               =   $this->Vessel_change_model->get_process_flow($processflow_sl); //print_r($cetificate_type); 
$data['vessel_details']       = $vessel_details;
if(!empty($vessel_details))
{
  $process_id                 = 41;//$vessel_details[0]['process_id'];
...
<div class="main-content ">  <!-- Container Class overridden for edge free design -->
  <div class="row ui-innerpage">
    <div class="col-12"> 
      <div class="row">
        ...
        <div class="col mt-2 text-primary">
          Request for Duplicate Certificate of Registered Vessel 
        </div>
      </div> <!-- inner row -->
    ...
    <!--__________________________________________________________________________-->
      <div id="form12show">
        ...
        <form name="form11" id="form11" method="post"  enctype="multipart/form-data" action="<?php echo $site_url.'/Kiv_Ctrl/VesselChange/pay_now_form20/'.$vessel_sl1.'/'.$processflow_sl1.'/'.$status_details_sl1 ?>">
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <!-- <input type="hidden" value="<?php echo $cetificate_type; ?>" id="cetificate_type" name="cetificate_type"> -->
...
$("#pay_now").click(function()
{
 ...
 // { 
    $.ajax({
      url : "<?php echo site_url('Kiv_Ctrl/VesselChange/showpayment20/')?>"+vessel_id,
      type: "POST",
...
$("#btnsubmit").click(function()
{
  ...
  // { 
    $.ajax({
      url : "<?php echo site_url('Kiv_Ctrl/VesselChange/not_payment_details_form20')?>",
      type: "POST",
      data:$('#form11').serialize(),
      //dataType: "JSON",
      success: function(data)
