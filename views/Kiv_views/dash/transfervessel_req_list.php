...
<div class="main-content ui-innerpage">
  ...
  <!-- <table id="example" class="display mytableheader" style="width:100%" border="0"> -->
    ...
    <thead>
      <tr><th colspan="11"><font size="4">Transfer of Registered Vessels</font></th></tr>  
      <tr>
        <th>#</th>
        <th>Vessel Name</th>
        <th>Vessel Type</th>
    ...
    foreach($transfervesl_det as $res1)
    {
      ...
      if($seller_id!=0){
        $seller_det                 = $this->Vessel_change_model->get_vessel_owner_name($seller_id);
      ...
      $processflowsl                = $this->Vessel_change_model->get_processflow_details_before_flow($vessel_sl);
