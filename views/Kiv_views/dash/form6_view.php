...
$portablefire_extinguisher             =   $this->Survey_model->get_portablefire_extinguisher($vessel_id,$survey_id,$survey_id);
...
$firepumptype_id=1;
$powerdriven             =   $this->Survey_model->get_firepumps_typenumber($vessel_id,$firepumptype_id,$survey_id);
...
$firepumptype_id=2;
$handpump             =   $this->Survey_model->get_firepumps_typenumber($vessel_id,$firepumptype_id,$survey_id);
...
echo form_open("Kiv_Ctrl/Survey/form6_view", $attributes);
?>
