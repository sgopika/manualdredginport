...
@$status_details_sl     =   $current_status[0]['status_details_sl'];
            ...
            ?> 
<!-- <form id="form1" name='form1' method="post" action="<?php echo $site_url.'/Kiv_Ctrl/Survey/Forward_Vessel_form2'?>"> -->
  <?php
$attributes = array("class" => "form-horizontal", "id" => "form1", "name" => "form1");
echo form_open("Kiv_Ctrl/Survey/Forward_Vessel_form2", $attributes);
?>
...
Completed the process of&nbsp;<?php echo $msg; ?>&nbsp;of vessel&nbsp;
<em> <strong> <?php echo $vessel_details[0]['vessel_name']; ?> </strong> </em>
</div> <!-- end of col 8 -->
</div> <!-- end of row -->
<div class="row no-gutters ">
<div class="col-4 d-flex justify-content-center">Forward To  <input type="hidden" name="current_status_id" id="current_status_id" value="2"></div> 
