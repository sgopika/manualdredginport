...
{
  $process_id               = 38;//$vessel_details[0]['process_id'];
...
<nav aria-label="breadcrumb " class="mb-0">
  <ol class="breadcrumb justify-content-end mb-0">
    ...
    <!-- <li class="breadcrumb-item"><a class="no-link" href="<?php echo base_url(); ?>index.php/VesselChange/namechange_req_list">List Page</a></li> -->
  </ol>
</nav> 
<!-- End of breadcrumb -->
  ...
  <div class="row ui-innerpage">
    <div class="col-12"> 
      <div class="row">
        ...
        <div class="col mt-2 text-primary">
          Request for Name Change of Registered Vessel 
        </div>
      </div> <!-- inner row -->
    ...
    <!--__________________________________________________________________________-->
      <div id="form12show">
        ...
        <form name="form11" id="form11" method="post"  enctype="multipart/form-data" action="<?php echo $site_url.'/Kiv_Ctrl/VesselChange/pay_now_form11/'.$vessel_sl1.'/'.$processflow_sl1.'/'.$status_details_sl1 ?>">
...
var vessel_id=$("#vessel_sl").val(); //alert(vessel_id);
 ...
 // { 
    $.ajax({
      url : "<?php echo site_url('Kiv_Ctrl/VesselChange/showpayment/')?>"+vessel_id,
      type: "POST",
...
$("#btnsubmit").click(function()
{
  ...
  // { 
    $.ajax({
      url : "<?php echo site_url('Kiv_Ctrl/VesselChange/not_payment_details_form11')?>",
      type: "POST",
      data:$('#form11').serialize(),
      //dataType: "JSON",
      success: function(data)
