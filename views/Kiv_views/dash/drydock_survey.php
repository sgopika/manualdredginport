...
//$current_status1          =   $this->Survey_model->get_status_details($vessel_id,$survey_id0);
...
*/
    $.ajax({
    url : "<?php echo site_url('Kiv_Ctrl/Survey/drydock_survey_entry')?>",
    type: "POST",
    //dataType: "JSON",
...
$("#tab2next").click(function()
{
  ...
  { 
    $.ajax({
      url : "<?php echo site_url('Kiv_Ctrl/Survey/drydock_survey_payment')?>",
      type: "POST",
...
echo form_open("Kiv_Ctrl/Survey/drydock_survey_entry", $attributes);
?>
...
<!-- <form name="form2" id="form2" method="post" action="<?php echo $site_url.'/Kiv_Ctrl/Survey/drydock_survey_payment'?>">   -->
  <?php
$attributes = array("class" => "form-horizontal", "id" => "form2", "name" => "form2");
echo form_open("Kiv_Ctrl/Survey/drydock_survey_payment", $attributes);
?>
