...
<form name="form1" id="form1" method="POST" action="<?php echo site_url().'/Kiv_Ctrl/Bookofregistration/renewalofinsurance'?>" enctype="multipart/form-data">
<?php 
...
$insurance_typename     =  $this->Bookofregistration_model->get_insurance_typename($vessel_insurance_type);
$data['insurance_typename']=$insurance_typename;
if(!empty($insurance_typename))
{
  $insurance_type_name=$insurance_typename[0]['insurance_type_name'];
}
else
{
  $insurance_type_name='';
...
<div class="col-12 d-flex justify-content-center text-success py-2"> <strong> 
 <u>Previous insurance details </u> </strong> </div>
</div>
<div class="row evenrow py-2">
<div class="col-3 pl-6 text-primary"> Insurance Company</div>
<div class="col-3 px-6 text-secondary"> <?php echo $insurance_company_name; ?></div>
<div class="col-3 pl-6 text-primary"> Insurance Number </div>
<div class="col-3 px-6 text-secondary"><?php echo $vessel_insurance_number; ?> </div>
</div> <!-- end of row -->
<div class="row oddrow py-2">
<div class="col-3 pl-6 text-primary"> Insurance Type</div>
<div class="col-3 px-6 text-secondary"> <?php echo $insurance_type_name; ?></div>
<div class="col-3 pl-6 text-primary"> Insurance Amount </div>
<div class="col-3 px-6 text-secondary"><?php echo $vessel_insurance_premium; ?> </div>
</div> <!-- end of row -->

<div class="row evenrow py-2">
<div class="col-3 pl-6 text-primary"> Insurance Date</div>
<div class="col-3 px-6 text-secondary"> <?php echo $vessel_insurance_date; ?></div>
<div class="col-3 pl-6 text-primary"> Insurance validity </div>
<div class="col-3 px-6 text-secondary"><?php echo $vessel_insurance_validity; ?> </div>
</div> <!-- end of row -->

<div class="row  oddrow"> 
<div class="col-12 d-flex justify-content-center text-success py-2"> <strong> 
 <u>New insurance details </u> </strong> </div>
</div>
...
<div class="col-3 px-6 text-secondary"> 
  <select class="form-control select2" name="vessel_insurance_type" id="vessel_insurance_type" title="Select Insurance Type" data-validation="required">
        ...
        { 
          ...
          foreach ($insurance_type as $res_insurance_type) { ?>
