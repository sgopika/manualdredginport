...
$user_type_id_details          =   $this->Survey_model->get_usertype_master($user_type_id);
				...
				<div class="card">
				  <div class="card-header">
				    <div class="row no-gutters">
				    	...
				    	<div class="col-6 d-flex justify-content-left"> pc123@gmail.com</div>
				  ...
				  <div class="card-header">
				    <div class="row no-gutters">
				    	...
				    	<div class="col-6 d-flex justify-content-left"> 9847500214 </div>
				    	<div class="col-3 d-flex justify-content-left"> <button type="button" class="btn btn-info btn-flat btn-sm"> <i class="fas fa-pencil-alt"></i> Edit</button></div>
				    </div> <!-- end of row -->
				  </div>
				</div>
