...
<div><font size="4"><strong>Form 4</strong></font></div>
...
echo form_open("Kiv_Ctrl/Survey/Verify_payment_pc_form4", $attributes);
?>
...
<div class="col-9 d-flex justify-content-left mt-1 mb-1 text-primary formfont">
 <textarea name="remarks" id="remarks" cols="50" rows="3" required onkeypress="return IsAddress(event);">Verified</textarea>
</div> <!-- end of col-3 2nd-->
...
<input type="hidden" name="current_position" id="current_position" value="<?php echo $user_type_id_cs; ?>">
<input type="hidden" name="user_sl_cs" id="user_sl_cs" value="<?php echo $user_sl_cs; ?>">
