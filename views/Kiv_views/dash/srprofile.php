		...
		<div class="row no-gutters border ">
			...
			<div class="col-12">
				<div class="alert alert-success text-primary" role="alert">
				  ...
				  <p>Please check your Request Menu, for viewing notifications from the Vessel Owners and Chief Surveyors. All the requests about survey activities is grouped under the Request menu.</p>
				  <hr>
				...
				<div class="card">
				  <div class="card-header">
				    <div class="row no-gutters">
				    	...
				    	<div class="col-6 d-flex justify-content-left"> sr123@gmail.com</div>
				  ...
				  <div class="card-header">
				    <div class="row no-gutters">
				    	...
				    	<div class="col-6 d-flex justify-content-left"> 9847506983 </div>
				    	<div class="col-3 d-flex justify-content-left"> <button type="button" class="btn btn-info btn-flat btn-sm"> <i class="fas fa-pencil-alt"></i> Edit</button></div>
				    </div> <!-- end of row -->
				  </div>
				</div>
