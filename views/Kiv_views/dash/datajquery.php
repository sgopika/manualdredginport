...
$data['vessellist_owner']  = $vessellist_owner;
...
if($process_id_status==17 && $status_id==7)
    {
      ?>
      <a href="<?php echo $site_url.'/Kiv_Ctrl/Survey/surveyIntimation/'.$vessel_sl.'/'.$survey_id1 ?>">
       <button type="button" class="btn btn-success btn-flat btn-sm">  
 ...
 //  if($process_id_status==7 && $status_id==2)
   if(($process_id_status==7 && $status_id==2) || ($process_id_status==7 && $status_id==7))
    {
      ?>
 ...
 // if($process_id_status==18 && $status_id==7)
   if(($process_id_status==18 && $status_id==7) || ($process_id_status==18 && $status_id==2))
    ...
    if($numberofdays1<30 && $numberofdays1!=0 && $process_id_status==24 && $processing_status==1)
  ...
  if($numberofdays1<30 && $numberofdays1!=0 && $process_id_status==27 && $processing_status==1)
...
if($process_id_status==26 && $status_id==2)
      {
      ?>
