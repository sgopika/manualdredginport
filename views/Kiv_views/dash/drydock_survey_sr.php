...
*/
    $.ajax({
    url : "<?php echo site_url('Kiv_Ctrl/Survey/drydock_forward_owner')?>",
    type: "POST",
    //dataType: "JSON",
      ...
      success: function(data)
    {
      ...
      window.location.href = "<?php echo site_url('Kiv_Ctrl/Survey/SurveyorHome'); ?>";
      }
    });
  }
}); 
...
echo form_open("Kiv_Ctrl/Survey/drydock_forward_owner", $attributes);
?>
...
<div class="row no-gutter  mx-0 postodd">
<div class="col-6 py-2 text-primary px-5">
Copy of last drydock certificate <a  href="<?php echo site_url(); ?>/Kiv_Ctrl/Survey/drydocksurvey_certificate/<?php echo $vessel_id1; ?>" target="_blank" width="30" height="30"><i class="fas fa-file-pdf h4"></i> </a>
</div>
<div class="col-6 py-2 text-primary px-5">
</div>
</div> <!-- end of postodd -->
