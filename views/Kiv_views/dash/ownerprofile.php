...
//----Keel laying-----//
$process_keel_id=2;
$processactivity_date_keel = $this->Survey_model->get_processactivity_form1($vessel_id,$survey_id,$process_keel_id);
...
//print_r($process_keel_approved_date);
...
//----Hull inspection-----//   
$process_hull_id=3;
$processactivity_date_hull= $this->Survey_model->get_processactivity_form1($vessel_id,$survey_id,$process_hull_id);
...
//----Final inspection-----//   
$process_final_id=4;
$processactivity_date_final= $this->Survey_model->get_processactivity_form1($vessel_id,$survey_id,$process_final_id);
$data['processactivity_date_final']= $processactivity_date_final;
//print_r($processactivity_date_final);
...
<div class="jumbotron">
  ...
  <div class="row no-gutters layoutcolor">
      ...
      <li class="list-group-item text-primary"> <i class="fas fa-eraser"></i> <!-- Next keel date -->
      <?php  //echo $next_keel_date;
     /* if($next_keel_date==false && $next_hull_date==false && $next_final_date==false) {  echo "Next keel date :"; }
      ...
      if($next_keel_date==false && $next_final_date==false) {  echo "Next keel date :"; }
      else {
        if($next_keel_date==true &&  $next_final_date==false) { echo "Next keel date :"; }
        else if($keel_approved_date==true) { echo "Keel approved date :".$keel_approved_date; }
        else { echo ""; }
      }
...
<!-- Next hull date: 
 -->      <?php //echo $next_hull_date;
     /* if($next_hull_date==false && $next_final_date==false) {  echo "Next hull date :"; }
      ...
      <div class="col-4">
      <ul class="list-group">
      <li class="list-group-item text-primary"> <i class="fas fa-toolbox"></i> <!-- Previous keel date:  -->
       <?php //echo $previous_keel_date;
     /*  if($next_hull_date) { echo ""; }  
       else if($next_hull_date) { echo ""; } 
       else { echo "Previous keel date  : ".$previous_keel_date; }*/
       if($keel_approved_date==true)
       {
        echo "Previous keel date  : ".$next_keel_date;
       }
 else
 {
  echo "Previous keel date  : ".$previous_keel_date;
 }
      ...
      <div class="col-4">
      <ul class="list-group">
      <li class="list-group-item text-primary"> <i class="fas fa-toolbox"></i><!--  Previous hull date : --> 
       <?php //echo $previous_hull_date;
...
<?php
if($final_approved_date==true)
       {
        echo "Previous final date  : ".$next_final_date;
       }
 else
 {
  echo "Previous final date  : ".$previous_final_date;
 }
 ?>
...
//echo $vessel_id.'--'.$process_id.'--'.$survey_id.'--'.$current_status_id1.'--'.$user_type_id.'--'.$sess_usr_id;
...
$survey_intimation1          = $this->Survey_model->get_survey_intimation_details_owner($vessel_id,$survey_id);
