...
<!-- <form name="form1" id="form1" method="post" action="<?php echo $site_url.'/Kiv_Ctrl/Survey/form4defect_detection/'.$vessel_id1.'/'.$processflow_sl1.'/'.$survey_id1 ?>" enctype="multipart/form-data"> -->



<?php
$attributes = array("class" => "form-horizontal", "id" => "form1", "name" => "form1", "enctype"=> "multipart/form-data");
  echo form_open("Kiv_Ctrl/Survey/form4defect_detection/".$vessel_id1.'/'.$processflow_sl1.'/'.$survey_id1, $attributes);
  ?>
...
<button type="submit" class="btn btn-flat btn-sm btn-success btn-point" id="btnsubmit">Send &nbsp; <i class="fas fa-arrow-right"></i> </button>
  ...
  <!-- </form> --> <?php echo form_close(); ?><!-- end of inside container -->
...
<div class="modal" id="myModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal body -->
      <div class="modal-body" id="disp_details">Data here
        Modal body..
      </div>
