...
<!-- <form name="form1" id="form1" method="post" action="<?php //echo $site_url.'/Survey/form4Task/'.$vessel_id.'/'.$processflow_sl.'/'.$survey_id ?>"> -->

  <?php
$attributes = array("class" => "form-horizontal", "id" => "form1", "name" => "form1");
echo form_open("Kiv_Ctrl/Survey/csform4annual", $attributes);
?>
