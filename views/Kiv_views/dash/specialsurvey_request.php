...
<thead>
    <tr><th colspan="10"><font size="4">Special survey requests</font></th></tr>
<tr>
  <th>#</th>
      <th>Vessel Name</th>
      <th>Ref. No</th>
  ...
  $i=1;
  if(!empty($specialsurvey)) {
  foreach($specialsurvey as $res)
  {
...
$processflow_sl=str_replace(array('+', '/', '='), array('-', '_', '~'), $processflow_sl1);
  ...
  ?>
    <a href="<?php echo $site_url.'/Kiv_Ctrl/urvey/form8_view/'.$vessel_sl.'/'.$processflow_sl.'/'.$survey_id ?>" class="btn btn-secondary btn-flat btn-sm">Form 8 View</a>
  <?php
  }
  ...
  <?php
   ...
   elseif($process_id==28) 
  {
  ?>
  <a href="<?php echo $site_url.'/Kiv_Ctrl/Survey/vessels_view/'.$vessel_sl.'/'.$processflow_sl.'/'.$survey_id ?>" class="btn btn-secondary btn-flat btn-sm">Initiate special survey</a> 
  <?php
  }
  else
  {
