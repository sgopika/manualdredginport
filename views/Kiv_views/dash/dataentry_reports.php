...
<tr>
  ...
  <td><?php if($user_type_id==14) { ?><a href="<?php echo $site_url.'/Kiv_Ctrl/DataEntry/view_dataentry_vessel/'.$vessel_sl.'/'.$data_id_enc ?>" class="btn btn-primary btn-flat btn-sm">View</a><?php } ?></td>
</tr>
<?php
$i++;
}
