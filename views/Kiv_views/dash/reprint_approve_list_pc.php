...
<!-- End of breadcrumb -->
<div ><?php if(isset($resp_msg)){echo $resp_msg; }?></div>
 <div id="resp_msg">
        ...
        <table id="example1" class="table table-bordered table-striped table-hover dataTable no-footer" role="grid" aria-describedby="example1_info">
          ...
          <tr>
            ...
            <th></th>
             ...
             <tbody>
         <?php $i=1; foreach ($reprint_req_pc as $req_value) {
               ...
               $reprint_request_reason=$req_value['reprint_request_reason'];
         ...
         ?>
          <tr>
            ...
            <td><a href="<?php echo base_url();?>index.php/Kiv_Ctrl/Survey/reprint_req_det_Vw/<?php echo $idencd;?>" name="vw_btn" id="vw_btn" class="btn btn-sm btn-flat btn-point bg-firebrick"><i class="fas fa-file-archive"></i>&nbsp; View </a></td>
