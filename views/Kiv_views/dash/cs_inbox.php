...
foreach($initial_data as $res)
{
  ...
  else
  {
    ...
    {
      $message1='<span class="badge badge-success">Drydock application</span>';
    }
     if($process_id_status==28)
    {
      $message1='<span class="badge badge-success">Special application</span>';
...
$processflow_sl=str_replace(array('+', '/', '='), array('-', '_', '~'), $processflow_sl1);
  ...
  <tr>
  <td><?php echo $i; ?></td>
  <td><?php echo $res['vessel_name']; //.'---'.$vessel_sl2; ?></td>
  ...
  <td></td>
  <td>
    <!-- href="http://127.0.0.1/kiv_port/index.php/Kiv_Ctrl/Survey/Verify_Vessel/klrcOyzSuDKzgiiR5mPdGJsqAgbJs0EQAwGR8f3VbNNy_bN_4Osyqjm_C1Tdk0Z4kumowbdQ-_dIyYxZQt0Yrw~~/
      5aW1QH2VYdo4RVY1Lb0VRGtgjbzeWkSZlNq94xz6dEwrkxz4vzWY-LdErFXwMjSww9sLhc-YXTR6IKMLt8SU8Q~~/
      hRiuStkZCHm7Z7MRY42laeuvY5eL86fA0Dd_qiavdygUt00BuiaEJeiVn1T6jeMiqpVJfUNvkxXvfLP1eZvYCg~~" -->
...
<!--   <a href="<?php //echo $site_url.'/Survey/form9_view/'.$vessel_sl.'/'.$survey_id ?>" class="btn btn-success btn-flat btn-sm">Form 9 view</a>  -->
  ...
  ?>
  <!-- <a href="<?php //echo $site_url.'/Survey/form10_view/'.$vessel_sl.'/'.$processflow_sl.'/'.$survey_id ?>" class="btn btn-secondary btn-flat btn-sm">Form 10 view</a>  -->
  ...
  <a href="<?php echo $site_url.'/Kiv_Ctrl/Survey/form10_view/'.$vessel_sl.'/'.$survey_id ?>" class="btn btn-secondary btn-flat btn-sm">Form 10 preview</a> 
  <?php
  }
  ...
  {
  ?>
  <a href="<?php echo $site_url.'/Kiv_Ctrl/Survey/drydock_application/'.$vessel_sl.'/'.$processflow_sl.'/'.$survey_id ?>" class="btn btn-secondary btn-flat btn-sm">View</a> 
  <?php
  }
  elseif($process_id==31) 
  {
  ?>
  <a href="<?php echo $site_url.'/Kiv_Ctrl/Survey/form10_approve/'.$vessel_sl.'/'.$processflow_sl.'/'.$survey_id ?>" class="btn btn-secondary btn-flat btn-sm">Verify and approve</a> 
  <?php
  }
  ...
  {
  ?>
  <a href="<?php echo $site_url.'/Kiv_Ctrl/Survey/form9_view_annual/'.$vessel_sl.'/'.$processflow_sl.'/'.$survey_id ?>" class="btn btn-secondary btn-flat btn-sm">Form 9 view</a> 
