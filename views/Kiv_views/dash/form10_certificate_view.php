...
//-----------Get heaving line  : equipment_id=55 tbl_kiv_equipment_details--------------//
$equipment_id55=55;
$heaving_line     =   $this->Survey_model->get_equipment_details_edit($vessel_id,$equipment_id55,$survey_id);
$data['heaving_line']   =   $heaving_line;
if(!empty($heaving_line)) 
{
    @$number_of_heaving_line    =   $heaving_line[0]['number'];
}
else
{
   $number_of_heaving_line  =   0;
}

//-----------Get fire axe  : equipment_id=57 tbl_kiv_equipment_details--------------//
$equipment_id57=57;
$fire_axe     =   $this->Survey_model->get_equipment_details_edit($vessel_id,$equipment_id57,$survey_id);
$data['fire_axe']   =   $fire_axe;
if(!empty($fire_axe)) 
{
    @$number_of_fire_axe    =   $fire_axe[0]['number'];
}
else
{
   $number_of_fire_axe  =   0;
}

//-----------Get fixed foam  : equipment_id=20 tbl_kiv_equipment_details--------------//
$equipment_id20=20;
$fixed_foam     =   $this->Survey_model->get_equipment_details_edit($vessel_id,$equipment_id20,$survey_id);
$data['fixed_foam']   =   $fixed_foam;
if(!empty($fixed_foam)) 
{
    @$number_of_fixed_foam    =   $fixed_foam[0]['number'];
}
else
{
   $number_of_fixed_foam  =   0;
}


//-----------Get fixed CO2  : equipment_id=21 tbl_kiv_equipment_details--------------//
$equipment_id21=21;
$fixed_co2     =   $this->Survey_model->get_equipment_details_edit($vessel_id,$equipment_id21,$survey_id);
$data['fixed_co2']   =   $fixed_co2;
if(!empty($fixed_co2)) 
{
    @$number_of_fixed_co2    =   $fixed_co2[0]['number'];
}
else
{
   $number_of_fixed_co2  =   0;
}
...
//-----------Get bilge pump-power driven : equipment_id=53 tbl_kiv_bilgepump_details--------------//
$equipment_id53=53;
$bilgepumptype_id1=1;
$bilge_pump_pd  =   $this->Survey_model->get_bilgepump_details($vessel_id,$equipment_id53,$bilgepumptype_id1);
$data['bilge_pump_pd']     =   $bilge_pump_pd;
//print_r($bilge_pump_pd);

if(!empty($bilge_pump_pd)) 
{
  @$number_of_bilge_pump_pd  =   $bilge_pump_pd[0]['number'];
}
else
{
  @$number_of_bilge_pump_pd  =0;
}
//-----------Get bilge pump-hand pump : equipment_id=53 tbl_kiv_bilgepump_details--------------//

$bilgepumptype_id2=2;
$bilge_pump_hp  =   $this->Survey_model->get_bilgepump_details($vessel_id,$equipment_id53,$bilgepumptype_id2);
$data['bilge_pump_hp']     =   $bilge_pump_hp;
if(!empty($bilge_pump_hp)) 
{
  @$number_of_bilge_pump_hp  =   $bilge_pump_hp[0]['number'];
}
else
{
  @$number_of_bilge_pump_hp =0;
}
...
<tr>
	...
	<td>:</td>
	<td>&nbsp;&nbsp;<?php if(!empty($vessel_registration_number)) { echo $vessel_registration_number; } else { echo "To be registered"; }  ?></td>
</tr>
...
<tr>
	<td>4.</td>
	<td>Master/ Serang's Name and License number</td>
	<td>:</td>
	<td>&nbsp;&nbsp;<?php if(!empty($crew_details_master)){ echo $crew_details_master[0]['name_of_type']; }?>, <?php if(!empty($crew_details_master)){ echo $crew_details_master[0]['license_number_of_type']; }?></td>
</tr> 
...
<tr>
	...
	<td>:</td>
	<td>&nbsp;&nbsp;<?php if(!empty($cargo_nature)) { echo $cargo_nature; } else { echo $nil; } ?> 
 </td>
</tr>
...
if(!empty($engine_details))
{
  ...
  foreach ($engine_details as $key_engine2) 
  {
    ...
    $bhp   =   $key_engine2['bhp'];
?>
	&nbsp;&nbsp;<?php echo $engine_number; ?>,&nbsp;<?php echo $bhp;?><br> <?php } }   ?></td>
</tr>
...
<tr>
	<td valign="top">13.</td>
	<td valign="top">Details of crew required for the vessel</td>
	<td valign="top">:</td>
	<td>&nbsp;&nbsp;
	<table>
	<tr>
		<td><b>Type</b></td><td>&nbsp;<b>Count</b></td><!-- td>Address</td> -->
	</tr>
    ...
    { 
      $crew_type_id=$res['crew_type_id'];
      $crew_count             =    $this->Survey_model->get_crew_count($vessel_id,$crew_type_id);
      $data['crew_count']     =    $crew_count;
      if(!empty($crew_count))
      {
        $count=count($crew_count); 
      }
      else
      {
        $count=0;
      ...
      ?>
	<tr>
		<td><?php echo $res['crew_type_name'];?></td><td>&nbsp;&nbsp;<?php echo $count; ?></td><!-- <td></td> -->
	</tr>
...
<tr>
	<td valign="top">14.</td>
	<td>Is the hull of the vessel in good condition and fit for service</td>
	<td>:</td>
...
<tr>
	<td valign="top">16.</td>
	<td>Has the vessel been tested for stability and found safe<br> for passenger service</td>
	<td valign="top">:</td>
	<td valign="top">&nbsp;&nbsp;<?php if($stability_test_status_id!=0) { echo $yes; } else { echo $no; } ?></td>
</tr>


<tr>
	<td>17.</td>
	<td><b>Details of life saving equipments</b></td>
	<td>&nbsp;</td>
	<td>&nbsp;</td>
</tr>
...
<tr>
  <td>&nbsp;</td>
    ...
    <table border="0" width="100%" cellpadding="0" cellspacing="0">
      <tr><!--  bgcolor="#e4eef0" -->
        <td width="20%" valign="top">Whether there is life jacket</td>
        <td width="20%" valign="top">&nbsp;:&nbsp;<?php if(!empty($lifejacket)) { echo $yes; } else { echo $no; } ?></td>
        <td width="20%" valign="top">&nbsp;&nbsp;Adult</td>
        <td width="10%" valign="top">&nbsp;:&nbsp;<?php if(!empty($number_adult)) { echo $number_adult; } else { echo $nil; } ?></td>
        <td width="20%" valign="top">&nbsp;&nbsp;Children</td>
        <td width="10%" valign="top">&nbsp;:&nbsp;<?php if(!empty($number_children)) { echo $number_children; } else { echo $nil; } ?></td>
      </tr>

  <tr><!--  bgcolor="#b7bcbd" -->
        <td width="20%" valign="top">No. of Buoyant apparatus</td>
        <td width="20%" valign="top">&nbsp;:&nbsp;<?php  if($number_of_buoyant_apparatus!=0) { echo $number_of_buoyant_apparatus; } else  { echo '0'; }  ?></td>
        <td width="20%" valign="top">&nbsp;&nbsp;No. of life bouys</td>
        <td width="10%" valign="top">&nbsp;:&nbsp;<?php  if($number_of_lifebouy!=0) { echo $number_of_lifebouy; } else  { echo '0'; } ?></td>
        <td width="20%" valign="top">&nbsp;&nbsp;No. of life boat</td>
        <td width="10%" valign="top">&nbsp;:&nbsp;<?php if(@$life_boat_number!=0) { echo @$life_boat_number; } else  { echo '0'; } ?></td>
      </tr>

    <tr><!--  bgcolor="#e4eef0" -->
        <td width="20%" valign="top">No. of oars</td>
        <td width="20%">&nbsp;:&nbsp;<?php  if($number_of_oars!=0) { echo $number_of_oars; } else  { echo '0'; }  ?></td>
        <td width="20%" valign="top">&nbsp;&nbsp;No. of anchor</td>
        <td width="10%" valign="top">&nbsp;:&nbsp;<?php  if($number_of_anchors!=0) { echo $number_of_anchors; } else  { echo '0'; }  ?></td>
        <td width="20%" valign="top">&nbsp;&nbsp;No. of heaving line</td>
        <td width="10%" valign="top">&nbsp;:&nbsp;<?php if(@$number_of_heaving_line!=0) { echo @$number_of_heaving_line; } else  { echo '0'; } ?></td>
      </tr>

<tr><!--  bgcolor="#b7bcbd" -->
        <td width="20%" valign="top">Bilge pump-power driven</td>
        <td width="20%" valign="top">&nbsp;:&nbsp;<?php  if($number_of_bilge_pump_pd!=0) { echo $number_of_bilge_pump_pd; } else  { echo '0'; }  ?></td>
        <td width="20%" valign="top">&nbsp;&nbsp;Bilge pump-hand pump</td>
        <td width="10%" valign="top">&nbsp;:&nbsp;<?php  if($number_of_bilge_pump_hp!=0) { echo $number_of_bilge_pump_hp; } else  { echo '0'; } ?></td>
        <td width="20%" valign="top">&nbsp;&nbsp;First aid box</td>
        <td width="10%" valign="top">&nbsp;:&nbsp;<?php if($first_aid_box!=0) { echo $yes;} else {echo $no;} ?></td>
      </tr>
...
<tr>
	<td>18.</td>
	<td><b>Details of fire fighting equipments</b></td>
	<td>&nbsp;</td>
	<td>&nbsp;</td>
</tr>
...
<tr>
  <td>&nbsp;</td>
    ...
    <table border="0" width="100%" cellpadding="0" cellspacing="0">
      ...
      <tr><!--  bgcolor="#e4eef0" -->
        <td width="20%" valign="top">No. of fire pumps</td>
        <td width="20%" valign="top">&nbsp;:&nbsp;<?php  if($count_firepumps!=0 ) { echo $count_firepumps; } else{ echo '0'; } ?></td>
        <td width="20%" valign="top">&nbsp;&nbsp;No. of fire buckets</td>
        <td width="10%" valign="top">&nbsp;:&nbsp;<?php if(@$fire_bucket_number!=0 ) { echo $fire_bucket_number; } else{ echo '0'; } ?></td>
        <td width="20%" valign="top">&nbsp;&nbsp;No. of fire axe</td>
        <td width="10%" valign="top">&nbsp;:&nbsp;<?php if(@$number_of_fire_axe!=0 ) { echo $number_of_fire_axe; } else{ echo '0'; } ?></td>
      </tr>

<tr><!--  bgcolor="#e4eef0" -->
        <td width="20%" valign="top">Fire pump type</td>
        <td width="20%" valign="top">&nbsp;:&nbsp;<?php echo $firepumptype_name; ?></td>
        <td width="20%" valign="top">&nbsp;&nbsp;Fixed fire ext. foam</td>
        <td width="10%" valign="top">&nbsp;:&nbsp;<?php if(@$number_of_fixed_foam!=0 ) { echo $number_of_fixed_foam; } else{ echo '0'; } ?></td>
        <td width="20%" valign="top">&nbsp;&nbsp;Fixed fire ext.CO2</td>
        <td width="10%" valign="top">&nbsp;:&nbsp;<?php if(@$number_of_fixed_co2!=0 ) { echo $number_of_fixed_co2; } else{ echo '0'; };  ?></td>
      </tr>
<!--
<tr bgcolor="#e4eef0">
<?php 
if(!empty($portablefire_extinguisher))
{
  ...
  {
    $type_id=$key['fire_extinguisher_type_id'];
    $fire_extinguisher_number=$key['fire_extinguisher_number'];
    if(!empty($fire_extinguisher_number))
    {
      $extinguisher_number=$fire_extinguisher_number;
    }
    else
    {
      $extinguisher_number=0;
    }
    $fire_ext_type          =   $this->Survey_model->get_portablefire_extinguisher_type($type_id);
    $data['fire_ext_type']  =   $fire_ext_type;

    if(!empty($fire_ext_type))
    {
      $portable_fire_extinguisher_name=$fire_ext_type[0]['portable_fire_extinguisher_name'];
    }
    else
    {
      $portable_fire_extinguisher_name="";
    }
    ?>
    <td width="20%" valign="top"><?php echo $portable_fire_extinguisher_name; ?></td>
    <td width="20%" valign="top">&nbsp;:&nbsp;<?php echo $extinguisher_number; ?></td> 

    <?php
   if ($i % 3 == 0 && $i !== 0) 
    {
      echo '<tr bgcolor="#e4eef0"><td width="20%" valign="top">'.$portable_fire_extinguisher_name.'</td><td width="20%" valign="top">&nbsp;:&nbsp;'.$extinguisher_number.'</td></tr>';
    }
    $i++;  
  }
} 
...
<tr>
	...
	<td>:</td>
	<td>&nbsp;&nbsp;<?php if ($sewage_treatment!=0) { echo $sewage_treatment; } else {echo $no; } ?></td>
</tr>
<tr>
	<td></td>
...
<tr>
	<td valign="top">20.</td>
	<td>Are all the equipment and facility prescribed under the rules provided on board </td>
	<td valign="top">:</td>
	<td valign="top">&nbsp;&nbsp;<?php if($condition_of_equipment!=0) { echo $yes;} else {echo $no;}?></td>
</tr>

<tr>
	<td valign="top">21.</td>
	<td>Nature of repairs, renewals neded at the time of inspection</td>
	<td>:</td>
	<td>&nbsp;&nbsp;<?php if(!empty($repair_details_nature)) { echo $repair_details_nature;} else {echo $nil;}?></td>
</tr>
 

<tr>
	<td valign="top">22.</td>
	<td>Number of passengers which the vessel is licensed to carry</td>
	<td></td>
	<td></td>
</tr>
<tr>
  <td>&nbsp;</td>
    ...
    <table border="0" width="100%" cellpadding="0" cellspacing="0">
      ...
      <tr><!--  bgcolor="#e4eef0" -->
        <td width="20%" valign="top">Lower Deck</td>
        <td width="20%" valign="top">&nbsp;:&nbsp;<?php  if ($lower_deck_passenger!=0) { echo $lower_deck_passenger; } else {echo '0'; } ?></td>
        <td width="20%" valign="top">&nbsp;&nbsp;Upper Deck</td>
        <td width="10%" valign="top">&nbsp;:&nbsp;<?php if ($upper_deck_passenger!=0) { echo $upper_deck_passenger; } else {echo '0'; } ?></td>
        <td width="20%" valign="top">&nbsp;&nbsp;Four Day Cruise</td>
        <td width="10%" valign="top">&nbsp;:&nbsp;<?php if ($four_cruise_passenger!=0) { echo $four_cruise_passenger; } else {echo '0'; }  ?></td>
      </tr>
      </table>
    </td>
  </tr>
...
<tr>
  ...
  <td>FFA validity</td>
  <td>:</td>
  <td>&nbsp;&nbsp;<?php echo $validity_fire_extinguisher; ?></td>
</tr>
<tr>
  <td valign="top">25.</td>
  <td>Insurance validity</td>
  <td>:</td>
  <td>&nbsp;&nbsp;<?php echo $validity_of_insurance; ?></td>
</tr>
