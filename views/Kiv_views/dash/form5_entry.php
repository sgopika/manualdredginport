...
/*var form = $("#form1");
  ...
  {*/
    ...
    {
      $.ajax({
      url : "<?php echo site_url('Kiv_Ctrl/Survey/form5_saveTab1')?>",
      type: "POST",
      //dataType: "JSON",
...
{ 
 /* var form = $("#form2");
  ...
  if($("#form2").isValid())
  {
    ...
    url : "<?php echo site_url('Kiv_Ctrl/Survey/form5_saveTab2')?>",
    type: "POST",
    //dataType: "JSON",
...
{ 
 /* var form = $("#form3");
  ...
  {
    $.ajax({
    url : "<?php echo site_url('Kiv_Ctrl/Survey/form5_saveTab3')?>",
    type: "POST",
  ...
  {*/
   if($("#form4").isValid())
   {
      $.ajax({
        ...
        url : "<?php echo site_url('Kiv_Ctrl/Survey/form5_saveTab4')?>",
        type: "POST",
 ...
 if($("#form5").isValid())
  { 
    $.ajax({
      ...
      url : "<?php echo site_url('Kiv_Ctrl/Survey/form5_saveTab5')?>",
      type: "POST",
...
$("#tab6next").click(function() 
{
  ...
  { 
    $.ajax({      
      url : "<?php echo site_url('Kiv_Ctrl/Survey/form5_saveTab6')?>",
      type: "POST",
...
/*  var form = $("#form7");
  ...
  {   
    $.ajax({
      url : "<?php echo site_url('Kiv_Ctrl/Survey/form5_saveTab7')?>",
      type: "POST",
...
/*var form = $("#form8");
  ...
  { 
    $.ajax({
      ...
      url : "<?php echo site_url('Kiv_Ctrl/Survey/form5_saveTab8')?>",
      type: "POST",
      ...
      { //alert(data);
        if(data!="val_errors")
        {
          alert("Declaration Inserted.");
           window.location.href = "<?php echo site_url('Kiv_Ctrl/Survey/form5_view'); ?>/"+vessel_id+"/"+survey_id;
  ...
  <div class="col-12"> 
    <div class="row">
      ...
      <div class="col mt-2 text-primary">
        ...
        See Rule 9 (1) - Declaration of survey of inland vessels
      </div>
    </div> <!-- inner row -->
...
echo form_open("Kiv_Ctrl/Survey/form5_saveTab1", $attributes);
?>
...
$var_color=0;// 0-odd, 1-even
 ...
 ?>
 <?php
 $value89='  <input type="text" name="grt" value="" id="grt"  class="form-control"  maxlength="10" autocomplete="off" placeholder="Enter Gross Registered Tonnage" data-validation="required" required onkeypress="return IsDecimal(event);" onpaste="return false;" onchange="return IsZero(this.id);" /> ';

     $value90=' <input type="text" name="nrt" value="" id="nrt"  class="form-control"  maxlength="10" autocomplete="off" placeholder="Enter Net Registered Tonnage" data-validation="required" required onkeypress="return IsDecimal(event);" onpaste="return false;" onchange="return IsZero(this.id);" /> ';

     $value95='<input type="text" name="placeofBuild" value="" id="placeofBuild"  class="form-control"  maxlength="50" autocomplete="off" placeholder="Enter Place of Build" data-validation="required" required onpaste="return false;" onkeypress="return alpbabetspace(event);" onchange="return IsZero(this.id);" />';

      

     $value96 ='  <input type="text" name="dateofBuild" value="" id="dateofBuild"  class="form-control dob" onpaste="return false;"  maxlength="10" autocomplete="off" placeholder="dd/mm/yyyy" data-validation="required" required /> '; 


        $value229='
 <input type="text" name="area_of_operation" value="" id="area_of_operation"  class="form-control"  maxlength="100" autocomplete="off" placeholder="Enter Area of operation" data-validation="required"  required onkeypress="return alpbabetspace(event);" onpaste="return false;" />';          
...
echo form_open("Kiv_Ctrl/Survey/form5_saveTab2", $attributes);
?>
...
echo form_open("Kiv_Ctrl/Survey/form5_saveTab3", $attributes);
?>
...
echo form_open("Kiv_Ctrl/Survey/form5_saveTab4", $attributes);
?>
...
echo form_open("Kiv_Ctrl/Survey/form5_saveTab5", $attributes);
?>
...
<!-- <form name="form6" id="form6" method="post">  --> 
  <?php
$attributes = array("class" => "form-horizontal", "id" => "form6", "name" => "form6");
echo form_open("Kiv_Ctrl/Survey/form5_saveTab6", $attributes);
?>
...
<!-- <form name="form7" id="form7" method="post" > -->  
  <?php
$attributes = array("class" => "form-horizontal", "id" => "form7", "name" => "form7");
echo form_open("Kiv_Ctrl/Survey/form5_saveTab7", $attributes);
?>
...
<!-- <form name="form8" id="form8" method="post">   -->
  <?php
$attributes = array("class" => "form-horizontal", "id" => "form8", "name" => "form8");
echo form_open("Kiv_Ctrl/Survey/form5_saveTab8", $attributes);
?>
<input type="hidden" id="hdn_vessel_type" name="hdn_vessel_type" value="<?php echo $vesselType; ?>" >
<input type="hidden" id="hdn_vessel_subtype" name="hdn_vessel_subtype" value="<?php echo $vesselSubtype; ?>" >
<input type="hidden" id="hdn_vessel_length" name="hdn_vessel_length" value="<?php echo $lengthOverDeck; ?>" >
