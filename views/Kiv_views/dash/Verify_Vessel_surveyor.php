...
$(document).ready(function()
{
  ...
  $("#surveyactivity_id").change(function()
  {
    //alert($("#surveyactivity_id").val());
  });
...
foreach($hull_details as $res_hull)
{
  ...
  {
    $bulk_head_placement_name     =   $this->Survey_model->get_bulk_head_placement_name($bulk_head_placement,$survey_id);
...
?>
<!-- <form name="form1" id="form1" method="post" action="<?php echo $site_url.'/Kiv_Ctrl/Survey/Verify_Vessel_surveyor/'.$vessel_id1 ?>">
 -->
...
$attributes = array("class" => "form-horizontal", "id" => "form1", "name" => "form1", "enctype"=> "multipart/form-data");
      ...
      echo form_open("Kiv_Ctrl/Survey/Verify_Vessel_surveyor/".$vessel_id1, $attributes);
      ?>
...
<div class="col-3 d-flex justify-content-left mt-1 mb-1 text-primary  border-primary ">
<?php echo date('d-m-Y', strtotime($res_date['activity_date']));  ?>
</div> <!-- end of col-3 3rd-->
<div class="col-3 d-flex justify-content-left mt-1 mb-1 text-primary formfont pl-1">
...
<div class="col-3 d-flex justify-content-left mt-1 mb-1 text-primary formfont">
<textarea name="remarks" data-validation="required" id="remarks" rows="5" cols="50" onkeypress="return IsAddress(event);"></textarea>
