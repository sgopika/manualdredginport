...
<nav aria-label="breadcrumb " class="mb-0">
  ...
  <?php if($user_type_id==14)/// After integration Registering Authority New user_type_id=14  ?>
    ...
    <li class="breadcrumb-item"><a class="no-link" href="<?php echo base_url(); ?>index.php/Kiv_Ctrl/VesselChange/namechange_req_list">List Page</a></li>
  </ol>
</nav> 
<!-- End of breadcrumb -->
...
<!-- <form name="form1" action="<?php //echo site_url('VesselChange/namechange_intimation_send/')?>" method="POST" enctype="multipart/form-data" id="form1"> -->
          ...
          <div class="row no-gutters">
            ...
            <div class="col-12 d-flex justify-content-center text-primary"> <u> INTIMATION FOR CHANGE OF NAME OF THE VESSEL </u></div>
          </div>
          ...
          <div class="row evenrow py-2">
            ...
            <div class="col-3 px-2 text-secondary"><a class="btn btn-flat btn-sm btn-info" href="<?php echo base_url(); ?>uploads/NameChange_Intimation/<?php echo $registration_inspection_report_upload; ?>"  target="_blank" width="30" height="30">Intimation Report<i class="fas fa-file-pdf h4"></i> </a></div>
          </div>
