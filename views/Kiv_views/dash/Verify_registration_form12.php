...
<div class="col-6 formfont "> <button class="btn-sm btn-flat btn btn-outline-primary "><i class="fab fa-wpforms"></i>Form 13  </button></div>
<div class="col-6 d-flex justify-content-end">
<button class="btn-sm btn-flat btn btn-outline-success " id="printform">&nbsp; Registration </button>
...
$attributes = array("class" => "form-horizontal", "id" => "form1", "name" => "form1", "enctype"=> "multipart/form-data");
  echo form_open("Kiv_Ctrl/Bookofregistration/Verify_registration_form12", $attributes);
  ?>
...
<div class="col-9 d-flex justify-content-left mt-1 mb-1 text-primary formfont">
 <textarea name="remarks" id="remarks" cols="50" rows="3">Verified</textarea>
</div> 
</div>  -->
<div class="row no-gutters headrow text-white border-bottom">
<div class="col-12 mt-1 mb-1 pl-2 formfont">
...
<div class="col-3 d-flex justify-content-left mt-1 mb-1 text-primary formfont">
<textarea name="registration_intimation_remark" id="registration_intimation_remark" cols="50" rows="3" data-validation="required" required onkeypress="return IsAddress(event);">Verified</textarea>
</div> <!-- end of col-3 2nd-->
<div class="col-3 d-flex justify-content-left mt-1 mb-1 text-dark border-primary formfont pl-1">
Upload documents
</div> <!-- end of col-3 3rd-->
<div class="col-3 d-flex justify-content-left mt-1 mb-1 text-primary formfont pl-1">
<input type="file" name="registration_inspection_report_upload" id="registration_inspection_report_upload" />
</div> <!-- end of col-3 4th-->
</div> <!-- end of row -->
...
<input type="hidden" name="current_position" id="current_position" value="<?php echo $user_type_id_ra; ?>">
