...
if(!empty($user_sl))
{
  ...
  $user_type_id_cs_sr=   $user_sl[0]['user_type_id'];
}*/
...
{
  foreach($buyer_details as $res_owner)
  {
...
<!-- ########################################################################################### -->
 <!-- inside content -->
<div><font size="4"><strong>Form 18</strong></font></div>

<form name="form18_payment" id="form18_payment" method="post" action="<?php echo $site_url.'/Kiv_Ctrl/VesselChange/Verify_payment_pc_form18/'.$vessel_id.'/'.$processflow_sl.'/'.$survey_id ?>">
