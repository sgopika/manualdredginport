...
echo form_open("Kiv_Ctrl/Survey/drydock_forward_sr", $attributes);
?>
...
Copy of last drydock certificate &nbsp;<input type="file" name="drydock_certificate" id="drydock_certificate" onChange="validate_file(this.value,this.id)"> -->
 <a  href="<?php echo site_url(); ?>/Kiv_Ctrl/Bookofregistration/form14_certificate/<?php echo $vessel_id; ?>" target="_blank" width="30" height="30"><i class="fas fa-file-pdf h4"></i>  </a>
...
<div class="col-6 py-2 text-primary px-5"><a  href="<?php echo site_url(); ?>/Kiv_Ctrl/Survey/drydocksurvey_certificate/<?php echo $vessel_id1; ?>" target="_blank" width="30" height="30"><i class="fas fa-file-pdf h4"></i> </a>
...
<select name="forward_to" id="forward_to" class="form-control select2" data-validation="required">
  ...
  {
  ?>
  <option value="<?php echo $res_surveyor_details['user_master_id']; ?>"> <?php echo $res_surveyor_details['user_master_fullname']; ?> </option>
  <?php 
  }
  ?>
  </select>
