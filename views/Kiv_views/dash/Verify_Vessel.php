 ...
 /*  if(($hullmaterial_id!='9999') || ($hullmaterial_id!='0'))
    {
       ...
       {
         $hullmaterial_name1[] = $key['hullmaterial_name'];
       }
       }
       else
       {
        ...
        $hullmaterial_name    = implode(", ",$hullmaterial_name1);
    }
    else
    {
...
<!-- <form name="form1" id="form1" method="post" action="<?php echo $site_url.'/Kiv_Ctrl/Survey/Verify_Vessel/'.$vessel_id1?>"> -->
  <?php
$attributes = array("class" => "form-horizontal", "id" => "form1", "name" => "form1", "enctype"=> "multipart/form-data");


      echo form_open("Kiv_Ctrl/Survey/Verify_Vessel/".$vessel_id1, $attributes);
      ?>
...
<div class="col-4 d-flex justify-content-left mt-1 mb-1 text-primary formfont"><?php echo $hullmaterial_name; //echo @$hullplating_material_name; ?>
</div> <!-- end of col-3 2nd-->
<div class="col-2 d-flex justify-content-left mt-1 mb-1 text-dark border-left border-primary pl-1 formfont">
Thickness
</div> <!-- end of col-3 3rd-->
...
else
{
  ...
  if(!empty($nozzle_equip_name)) { echo $nozzle_equip_name; } else { echo $nil; }
  ?>
</div> <!-- end of col-3 4th-->
</div> <!-- end of row -->
...
<div class="col-3 d-flex justify-content-left mt-1 mb-1 text-primary formfont">
<select name="surveyactivity_id" id="surveyactivity_id" class="form-control select2" data-validation="required" required="required">
  <option value="">Select</option>  
...
<div class="row no-gutters evenrow border-bottom" id="survey0">
...
<div class="col-3 d-flex justify-content-left mt-1 mb-1 text-primary formfont pl-1">
 ...
 <!--    <div class="form-group">
     <input type="text" class="form-control inspection_date" id="inspection_date" name="inspection_date" title="Enter Inspection Date" data-validation="required">
    </div>
 -->
...
<input type="hidden" name="today_date" id="today_date" value="<?php echo date('d-m-Y');?>">
...
<div class="col-3 d-flex justify-content-left mt-1 mb-1 text-primary formfont">
<textarea name="remarks" data-validation="required" id="remarks" rows="5" cols="50" onkeypress="return IsAddress(event);" >Approved</textarea>
...
{
var inspection_date1=$("#inspection_date").val(); 
var CurrentDate = new Date();
var GivenDate1 = inspection_date1.split("/").reverse().join("-");
...
/* function startDate() 
  { 
        var dateString = document.getElementById('inspection_date').value; 

        dateString = dateString.split("/").reverse().join("-");
        
        var dateString1 = document.getElementById('today_date').value;
