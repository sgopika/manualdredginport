...
<!-- <form name="form1" method="POST" action="<?php echo $site_url.'/Kiv_Ctrl/Survey/defect_payment_annual/'.$vessel_id1.'/'.$processflow_sl1.'/'.$survey_id1 ?>"> 
 -->

<?php
$attributes = array("class" => "form-horizontal", "id" => "form1", "name" => "form1", "enctype"=> "multipart/form-data");
  echo form_open("Kiv_Ctrl/Survey/defect_payment_annual/".$vessel_id1.'/'.$processflow_sl1.'/'.$survey_id1, $attributes);
  ?>
