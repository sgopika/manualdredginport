...
<div class="main-content ui-innerpage">
 ...
 <table id="example" class="table table-bordered table-striped table-hover dataTable no-footer" role="grid" aria-describedby="example1_info">
        <thead>
          <tr><th colspan="9"><font size="4">Form 4 intimation</font></th></tr>
            <tr>
                  <th>#</th>
                  <th>Vessel Name</th>
                  <th>Ref. No</th>
...
$survey_id = $this->encrypt->encode($survey_id2); 
...
$processflow_sl=str_replace(array('+', '/', '='), array('-', '_', '~'), $processflow_sl1);
               ...
               <td>
                <?php if($status==1) { ?>
                <a href="<?php echo $site_url.'/Kiv_Ctrl/Survey/csform4Task/'.$vessel_sl.'/'.$processflow_sl.'/'.$survey_id  ?>" class="btn btn-danger btn-xs">Intimation</a>
                <?php
                }
                ?>
                </td>
