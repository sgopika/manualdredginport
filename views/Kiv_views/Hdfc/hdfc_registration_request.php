...
echo form_open("Kiv_Ctrl/Hdfc/hdfc_request_registration", $attributes);
?>
...
<table width="40%" height="100" border='1' align="center">
	...
	<tr>
		<td>Redirect URL	:</td><td><input type="hidden" name="redirect_url" value="<?php echo base_url('index.php/Kiv_Ctrl/Hdfc/hdfc_response_registration');?>"/></td>
	</tr>
 	<tr>
 		<td>Cancel URL	:</td><td><input type="hidden" name="cancel_url" value="<?php echo base_url('index.php/Kiv_Ctrl/Hdfc/hdfc_response_registration');?>" /></td>
 	</tr>
 	<tr>
