...
echo form_open("Kiv_Ctrl/Hdfc/Hdfc_ownrequest", $attributes);
?>
...
<table width="40%" height="100" border='1' align="center">
	...
	<tr>
		<td>Redirect URL	:</td><td><input type="hidden" name="redirect_url" value="<?php echo base_url('index.php/Kiv_Ctrl/Hdfc/Hdfc_ownresponse');?>"/></td>
	</tr>
 	<tr>
 		<td>Cancel URL	:</td><td><input type="hidden" name="cancel_url" value="<?php echo base_url('index.php/Kiv_Ctrl/Hdfc/Hdfc_ownresponse');?>" /></td>
 	</tr>
 	<tr>
