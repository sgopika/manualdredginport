...
<button type="button" class="btn bg-primary btn-flat margin">Dynamic Form</button>
 ...
 <?php 
    $attributes = array("class" => "form-horizontal", "id" => "dynamic_form_list", "name" => "dynamic_form_list" , "novalidate");
         ...
         ?>
          ...
          <tr>
            ...
            <td>
                ...
                <button name="edit_dynamic_page_btn_<?php echo $i;?>" id="edit_bank_btn_<?php echo $i;?>" class="btn btn-sm bg-purple btn-flat" type="button" >   <i class="fa fa-fw  fa-pencil"></i>  </button><!--&nbsp; Edit-->
                </a>   
