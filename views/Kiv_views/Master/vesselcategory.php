	...
	if(vesselcategory_name=="")
        ...
        if(vesselcategory_code=="")
        {
            ...
            return false;
				...
				$.ajax({
					url : "<?php echo site_url('Kiv_Ctrl/Master/add_vesselcategory/')?>",
					type: "POST",
...
function toggle_status(id,status)
{
	...
	$.ajax({
				url : "<?php echo site_url('Kiv_Ctrl/Master/status_vesselcategory/')?>",
				type: "POST",
...
{
	$.ajax({
				url : "<?php echo site_url('Kiv_Ctrl/Master/delete_vesselcategory/')?>",
				type: "POST",
				data:{ id:id,stat:status},
				dataType: "JSON",
				success: function(data)
...
function save_vesselcategory(id,i)
{
	...
	if(edit_vesselcategory=="" ||  edit_vesselcategory_code==""){
		...
		$.ajax({
					url : "<?php echo site_url('Kiv_Ctrl/Master/edit_vesselcategory/')?>",
					type: "POST",
...
<div class="row py-1">
	<div class="col-4 breaddiv">
		<span class="badge bg-darkmagenta innertitle mt-2">Vessel Category</span>
	</div>  <!-- end of col4 -->
	<div class="col-8">
...
<!---------------------------------------- start of main content area  ---------------------------------------- -->
	<div id="msgDiv" class="alert alert-info alert-dismissible" style="display:none"></div> 
				...
				if(isset($editres)){
		       		echo form_open("Kiv_Ctrl/Master/add_vesselcategory", $attributes);
				} else {
					echo form_open("Kiv_Ctrl/Master/add_vesselcategory", $attributes);
				}?>
