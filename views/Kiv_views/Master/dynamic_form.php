...
function dynamic_date_commentedon_04_11_2020()
{	/*added on 04/11/2020*/
  var heading_id              = $("#heading_name").val();//alert(heading_id);	
  if(heading_id==''){
  	document.getElementById("heading_name").focus();
  	$("#heading_name").val('');	
  	$('#onclick_check').show();
  	}
  	else{/*added on 04/11/2020*/
    var vesseltype_name         = $("#vesseltype_name_hidden").val();//alert(vesseltype_name);
   ...
   $.ajax
      ({
        ...
        { 
          ...
          {  //alert("else");
          var dateArray=data;  
          var dateVal=dateArray.split("+"); 
          var dateVal1=dateVal[0];//alert(dateVal[0]);
          var dateVal2=dateVal[1];//alert(dateVal[1]);
          $('#date1').val(dateVal1);
          $('#date2').val(dateVal2);
          //var date11=dateVal[0];//alert(date11);
          //var date21=dateVal[1];//alert(date21);
          //$('#date1').val(date11);
          //$('#date2').val(date21);
          }
        }
   ...
   <div class="col-12 d-flex justify-content-end">
    <table class="table table-bordered table-striped">
        <?php if(isset($addResult)){ ?>
          <input type="hidden" name="vesseltype_name_hidden" id="vesseltype_name_hidden" value="<?php echo $vesseltype_id;?>"/>
          <input type="hidden" name="vessel_subtype_name_hidden" id="vessel_subtype_name_hidden" value="<?php echo $vessel_subtype_id;?>"/>
          <input type="hidden" name="length_over_deck_hidden" id="length_over_deck_hidden" value="<?php echo $length_over_deck;?>"/>
          <input type="hidden" name="hullmaterial_name_hidden" id="hullmaterial_name_hidden" value="<?php echo $hullmaterial_id;?>"/>
          <input type="hidden" name="engine_inboard_outboard_hidden" id="engine_inboard_outboard_hidden" value="<?php echo $engine_inboard_outboard;?>"/>
          <input type="hidden" name="start_date_hidden" id="start_date_hidden" value="<?php echo $start_date_db;?>"/>
          <input type="hidden" name="end_date_hidden" id="end_date_hidden" value="<?php echo $end_date_db;?>"/>
        <?php } ?>
        <tr>   
      ...
      <tr> 
       ...
       <td>       
          ...
          <input type="hidden" name="date2" id="date2" value="">
               ...
               <select name="heading_name" id="heading_name" class="form-control" <?php if(isset($editres)){?> disabled <?php } ?> ><?php //onclick="dynamic_date()";  ?>
                    <?php if(isset($editres)){?>
               ...
               <div id="onclick_check" style="display:none"><font color='red'>Please Select a heading</font> </div>
       </td>
 </tr> 
 <?php if(isset($editres)){?>
   <tr>
