...
<button type="button" class="btn bg-primary btn-flat margin">View Copied Dynamic Form</button>
      ...
      <ol class="breadcrumb">
        ...
        <li><a class="no-link" href="<?php echo $site_url."/Kiv_Ctrl/Master/copyDynamicform"?>"></i>  <span class="badge bg-blue"> Copy Dynamic Form </span> </a></li>
        <li><a class="no-link" href="<?php echo $site_url."/Kiv_Ctrl/Master/add_dynamic_form"?>"><span class="badge bg-blue"> Add Dynamic Form  </span></a></li>
      </ol></ol>
    </section>
 ...
 <?php 
    ...
    if(isset($editres)){
      ...
      echo form_open("Master/viewCopyDynamicform", $attributes);
 }?>
...
<div class="box">
  <div class="box-header">
        ...
        <!--<div class="box-header" id="view_enginetype">
             <a href="<?php echo $site_url."/Master/add_dynamic_form"?>"><button type="button" class="btn btn-sm btn-primary"> <i class="fa fa-plus-circle"></i>&nbsp; Add New Dynamic Form</button></a>
        </div>-->
      ...
      <tbody>
         ...
         ?>
          ...
          <tr>
            ...
            <td>
                <?php //echo $site_url."/Master/edit_dynamic_form/$id"?>
