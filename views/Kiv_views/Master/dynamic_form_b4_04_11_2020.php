...
$(document).ready(function()
{
  ...
  {//alert("change fun");
    ...
    var start_date              = $("#start_date_hidden").val();//alert(start_date);
    var end_date                = $("#end_date_hidden").val();//alert(end_date);  
    var date1                   = $('#date1').val();//var date111="date111"+date1;alert(date111);
    var date2                   = $('#date2').val();//var date222="date111"+date2;alert(date222);alert(date2);
    var csrf_token              ='<?php echo $this->security->get_csrf_hash(); ?>';
    ...
    {      //alert("ajax");
      ...
      // var date2                   =$('#date2').val();alert(date2);
      $('#msgVal3').hide(); 
      $.ajax
      ({
        type: "POST",
        ...
        {     
          ...
          if(data==1)
          {
            alert("Values corresponding to selected criteria is exist");
            location.reload();
          }
          else
          {
