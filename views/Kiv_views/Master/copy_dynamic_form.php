...
{ 
  ...
  $.ajax({
            /*type: "text",
            url: "<?php echo $site_url; ?>/Kiv_Ctrl/Master/copyFormData_ajax/"+vesselId+"/"+subvesselId+"/"+hullId+"/"+lengthOverDeck+"/"+engineInboardOutboard+"/"+formId+"/"+startDate+"/"+endDate+"/"+vesselName+"/"+subvesselName+"/"+hullName+"/"+boardName+"/"+hidformName,//+"/"+csrf_test_name, 
            dataType: "text",  
            cache:false,*/

            type: "POST",
            url:"<?php echo site_url('/Kiv_Ctrl/Master/copyFormData_ajax/')?>",
            data:{vesselId:vesselId,subvesselId:subvesselId,hullId:hullId,lengthOverDeck:lengthOverDeck,engineInboardOutboard:engineInboardOutboard,formId:formId,startDate:startDate,endDate:endDate,vesselName:vesselName,subvesselName:subvesselName,hullName:hullName,boardName:boardName,hidformName:hidformName,'csrf_test_name': csrf_token},
...
{ 
  ...
  $.ajax({
            ...
            cache:false,*/
            type: "POST",
            url:"<?php echo site_url('/Kiv_Ctrl/Master/copyFormHeadingData_ajax/')?>",
            data:{vesselId:vesselId,subvesselId:subvesselId,hullId:hullId,lengthOverDeck:lengthOverDeck,engineInboardOutboard:engineInboardOutboard,formId:formId,headingId:headingId,startDate:startDate,endDate:endDate,vesselName:vesselName,subvesselName:subvesselName,hullName:hullName,boardName:boardName,hidformName:hidformName,headingName:headingName,'csrf_test_name': csrf_token},
            success: 
            function(result)
            {  
              $("#paste_div").show();
...
<div class="container-fluid ui-innerpage">
  ...
  <div class="row" id="paste_div"  style="display: none;">
      <div class="col-12" >
