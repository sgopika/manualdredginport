  ...
  <?php 
       ...
       <?php 
          ...
          if(isset($editres)){
            ...
            echo form_open("Kiv_Ctrl/Master/copyFormHeadingData_ajax", $attributes);//Master/addCopiedForm_Ajax
  }?>
...
<div class="row no-gutters">
  ...
  <div class="col-7 ">
    ...
    <div class="row no-gutters destbody">
      ...
      <div class="col-6">
        <p class="lead">. </p>
         <input type="hidden" name="hidformId" value="<?php echo urldecode($hidformId); ?>" id="hidformId"  class="form-control col-3"  autocomplete="off" />
                  <input type="hidden" name="hidheadingId" value="<?php echo urldecode($hidheadingId); ?>" id="hidheadingId"  class="form-control col-3"  autocomplete="off" />
      </div>
      <div class="col-12 d-flex justify-content-end">
                  <input type="hidden" name="copiedPrimaryValue_hidden" id="copiedPrimaryValue_hidden" value="<?php echo $primaryValue; ?>">
                  <input type="submit" class="btn btn-point btn-danger pull-right"  name="dynamicCopy_ins" value="Copy Details" id="dynamicCopy_ins" ><?php /*onClick="ins_dynamicCopyform()"*/ ?>
