...
<?php 
    ...
    if(isset($editres)){
          echo form_open("Kiv_views/edit_dynamic_form", $attributes);
    } else {
      echo form_open("Kiv_views/copyFormData_ajax", $attributes);
 }?>
    ...
    <div class="row no-gutters destbody">
      ...
      <div class="col-12 d-flex justify-content-end">
         <input type="hidden" name="copiedPrimaryValue_hidden" id="copiedPrimaryValue_hidden" value="<?php echo $primaryValue; ?>">
                  <input type="submit" class="btn btn-point btn-danger pull-right" name="dynamicCopy_ins" value="Copy Details" id="dynamicCopy_ins" onClick="ins_dynamicCopyform()"><?php //onClick="ins_dynamicCopyform()" commented on 28-10-2020?>
      </div> <!-- end of col6 -->
    </div> <!-- end of row -->
  </div> <!-- end of col7 -->
</div> <!-- end of row -->
