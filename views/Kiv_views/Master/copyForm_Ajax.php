      ...
      <tbody>
         ...
         ?>
          ...
          <tr>
            ...
            <td><?php echo "From ".$start_date_view." To ".$msg; ?></td>  
            <td>
              <button class="btn btn-sm btn-info btn-flat"  type="button" onclick="copyFormData(<?php echo $i;?>);"> <i class="fa fa-fw fa-copy (alias)"></i>  </button>
              ...
              <!--<input type="hidden" name="hid_headingId" id="hid_headingId" value="<?php //echo $head_id; ?>">-->
