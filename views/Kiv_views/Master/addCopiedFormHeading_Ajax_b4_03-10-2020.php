...
$("#vesseltype_name").change(function(){
    ...
    $.ajax
      ({
        type: "POST",
        url:"<?php echo site_url('/Master/dynamic_vesselsubtype_ajax/')?>",
...
<!-- ----------------------------------------------------------- --- Add Copied Form with Heading ------------------------------------------ -->
  <?php 
        ...
        ?>
       <?php 
          $attributes = array("class" => "form-horizontal", "id" => "addCopiedFormHeading_Ajax", "name" => "addCopiedFormHeading_Ajax" , "novalidate");
          
          if(isset($editres)){
                echo form_open("Master/edit_dynamic_form", $attributes);
          } else {
            echo form_open("Master/copyFormHeadingData_ajax", $attributes);//Master/addCopiedForm_Ajax
  }?>
  ...
  <div class="col-4">
    <div class="row  no-gutters sourcehead">
      ...
      <div class="col-12">
        ...
        <li class="list-group-item">&nbsp; Heading   <div class="pull-right"> <span class="pull-rightlabel label-warning"><?php echo urldecode($headingName); ?></span></div></li>
    ...
    <div class="row no-gutters destbody">
      ...
      <div class="col-6">
        <div class="form-group">
                  ...
                  <input type="text" name="start_date" maxlength="50" id="start_date" class="form-control" value=""   placeholder="Enter Start Date"  onchange="startDate()"  autocomplete="off" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask/>
      ...
      <div class="col-6">
         <div class="form-group">
                <p class="lead">End Date </p>
                  <input type="text" name="end_date" maxlength="50" id="end_date" class="form-control" value=""  placeholder="Enter End Date"  onchange="endDate()"  autocomplete="off" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask/>
      ...
      <div class="col-6">
        <p class="lead">. </p>
         <input type="text" name="hidformId" value="<?php echo urldecode($hidformId); ?>" id="hidformId"  class="form-control col-3"  autocomplete="off" />
                  <input type="text" name="hidheadingId" value="<?php echo urldecode($hidheadingId); ?>" id="hidheadingId"  class="form-control col-3"  autocomplete="off" />
      </div>
      <div class="col-12 d-flex justify-content-end">
                  <input type="hidden" name="copiedPrimaryValue_hidden" id="copiedPrimaryValue_hidden" value="<?php echo $primaryValue; ?>">
                  <input type="submit" class="btn btn-point btn-danger pull-right"  name="dynamicCopy_ins" value="Copy Details" id="dynamicCopy_ins" onClick="ins_dynamicCopyform()">
