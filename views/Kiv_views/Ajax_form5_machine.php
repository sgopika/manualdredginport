...
?>
  ...
  <div class="row oddtab">
    ...
    <?php echo '<div id="boatDet"></div><div class="col border-top border-bottom ves_div1" id="showbtn"><div class="form-group mt-2 mb-2"><button type="button" class="btn btn-success btn-flat  btn-point btn-sm" name="addMoreBoat" id="addMoreBoat" onclick="add()" ><i class="far fa-save"></i>&nbsp;Add Boat</button>&nbsp;&nbsp;<button type="button" class="btn btn-success btn-flat  btn-point btn-sm" name="remove" id="remove" onclick="rem()"  ><i class="far fa-save"></i>&nbsp;Remove</button></div></div>';?>
   ...
   <?php 
     ...
     $value157=' <div class="col-3 border-top border-bottom ves_div1">
   ...
   <div class="col-3 border-top border-bottom border-left ves_div1">
    ...
    <div class="row eventab">
    <?php 
     $value168='<div class="col-3 border-top border-bottom ves_div1">
   ...
   <div class="col-3 border-top border-bottom border-left ves_div1">
       ...
       <select class="form-control select2" name="conditionofEquipment" id="conditionofEquipment" placeholder="Select Condition of equipment" data-validation="required">
           ...
           foreach ($conditionofItem as $res_conditionofItem)
  {
  
   $value168.='<option value="'. $res_conditionofItem['conditionstatus_sl'].'"> '. $res_conditionofItem['conditionstatus_name'].'</option>';
