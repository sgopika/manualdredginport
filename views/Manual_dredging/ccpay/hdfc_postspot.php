...
//{
	$customerspotreg_id=$postdata['hid_bookingid'];
	//$merkey=$postdata['key'];
	...
	$banktype	=	$postdata['banktype'];
		...
		$tokenno=$getbookingdata[0]['spot_token'];
		$transamount=$getbookingdata[0]['spot_amount'];	
		$custname=$getbookingdata[0]['spot_cusname'];
		$custphone=$getbookingdata[0]['spot_phone'];
		$requestton=$getbookingdata[0]['spot_ton'];	
		$portid=$getbookingdata[0]['port_id'];	
...
//} ?>
			...
			<table width="40%" height="100" border='1' align="center">
		        ...
		        <tr>
		        	<td>Merchant Param1	:</td><td><input type="hidden" name="merchant_param1"  id="merchant_param1" value="<?php echo $customerspotreg_id; ?>"/></td>
		        </tr>
		        <tr>
				...
				<tr>
					<td>Merchant Param4	:</td><td><input type="hidden" name="merchant_param4" id="merchant_param4" value="2"/></td>
				</tr>
				<tr>
