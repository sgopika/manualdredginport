...
echo '<div id="showhome" ><a href="http://portinfo.kerala.gov.in/index.php/Master/customer_booking_history" ><button class="btn btn-sm bg-blue btn-flat" type="button" > Go Back</button></a></div>';  
	echo "</center>";
?>
