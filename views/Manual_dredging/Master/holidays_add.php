...
function popupClose(id){
	...
	<!--Pop-up-->
    <script src="<?php echo base_url() ?>/assets/css/jquery-1.11.3.min.js"></script>
<!--    <link rel="stylesheet" href="https://code.jquery.com/mobile/1.4.5/jquery.mobile-1.4.5.min.css">
-->	<script src="<?php echo base_url() ?>/assets/css/jquery.mobile-1.4.5.min.js"></script>

   <?php
   
    if($_ci_view=='Manual_dredging/Master/holidays_add'){ ?>
	...
	<div class="col-8 d-flex justify-content-end">
        ...
        <li class="breadcrumb-item"><a href="#"><strong>Holiday Add</strong></a></li>
      </ol>
</div> <!-- end of col-8 -->
	...
	{ 
	  ...
	  else
	   {
	    $url=site_url('Manual_dredging/Port/port_clerk_main');
					...
					$this->session->set_flashdata('msg', '<div class="alert alert-info alert-success">Holidays of '.$period_name.' Added Successfully.</div>'); ?>
