...
function ins_allegation()
{
 ...
 <!-- Page specific script Ends Here -->
    ...
    <section class="content-header">
      <h1>
         <button class="btn btn-primary btn-flat disabled" type="button" >Fee Master</button>
      </h1>
      <ol class="breadcrumb">
        ...
        <li><a href="#"><strong>Fee Master</strong></a></li>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">
      <div class="row custom-inner">
		...
		if(isset($editres)){
            ...
            <!-- /.box-header -->
            <div class="box-body">
            <input type="hidden" name="hid" value="<?php echo $get_fee[0]['fee_master_id'] ?>"/>
              <table  class="table table-bordered table-striped">
                <thead>
                <tr>
                <td>Fee Name</td>
                <td><?php echo $get_fee[0]['fee_master_fee_name']; ?></td>
                </tr>
                <tr>
                <td>Amount</td>
                <td><input type="text" name="famt" value="<?php echo $get_fee[0]['fee_master_fee'] ?>" /></td>
                </tr>
                <?php echo form_close(); ?>
