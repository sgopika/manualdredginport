...
function showSection(val){
    ...
    <section class="content-header">
     <h1>
         ...
         <strong>Customer Registration Request Processing </strong> </button>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url("Master/dashboard"); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
		 ...
		 <li><a href="<?php echo site_url("Master/customer_requestprocessing"); ?>"><strong>Customer Request Processing</strong></a></li>
        <li><a href="#"><strong><?php if(isset($int_userpost_sl)){?>Edit<?php } else {?>Add <?php }?></strong></a><a href="<?php echo site_url("Master/canoeRegistration"); ?>"><strong>&nbsp;Registration Request Processing </strong></a></li>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">
      ...
      <!--      </div> -->
        ...
        <div class="box box-primary box-blue-bottom">
            <div class="box-header ">
              ...
              <a href="<?php echo site_url("Master/customer_requestprocessing_add"); ?>"><strong>Registration Request Processing</strong></a></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <?php 
        ...
        $attributes = array("class" => "form-horizontal", "id" => "customer_requestprocessing_add", "name" => "customer_requestprocessing_add");
			} else {
       $attributes = array("class" => "form-horizontal", "id" => "customer_requestprocessing_add", "name" => "customer_requestprocessing_add", "onSubmit" => "return validate_chk();");
			}
      ...
      <tr><td>Customer name</td><td><?php  foreach($customerreg_data as $rowmodule){  ?><input type="text" name="txtcustrname"  id="txtcustrname"  class="form-control" value="<?php echo strtoupper($rowmodule['customer_name']);?>" readonly="true"  maxlength="100" autocomplete="off" required/><input type="hidden" name="hid_custid" id="hid_custid" value="<?php echo $rowmodule['customer_registration_id']  ?>" /> <?php } ?></td></tr>
        <tr >
  
      		<td>Request Status<font color="#FF0000">*</font></td>
      		<td>Approve  <input type="radio" name="radioRequestStatus"  value="2" onclick="$(this).closest('tr').next().hide();"  />
                Reject <input type="radio" name="radioRequestStatus"  value="3"  checked="checked" onclick="$(this).closest('tr').next().show();"/>
           </td>
      	</tr>
