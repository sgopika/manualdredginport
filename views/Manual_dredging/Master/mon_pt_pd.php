...
$(document).ready(function()
{
	...
	$('#btn_add').click(function()
	{
		...
		//var t_date=$('#to_date').val();
					//var period =$('#periodb').val();
		$.post("<?php echo $site_url?>/Port/get_mon_pd/",{port_id:port_id,zone_id:zone_id,m_p:m_p},function(data)
	 	{
							//alert("hello");
	...
	<div class="col-8 d-flex justify-content-end">
	 ...
	 <div class="row">
        ...
        <tr>
        	<th>Sl No</th>
            <th>Port Name</th>
            <th>Total Permit Requests</th>
            <th>Permit Request Approved</th>
            <th>Permit Request Rejected</th>
            <th>View More</th>
        </tr>
        <?php 
		$j=1;
		foreach($arr as $ar)
		{
            ...
            <tr>
                ...
                <td><a href="<?php echo $site_url.'/Manual_dredging/Port/get_mon_pd/'.encode_url($ar['col4']);?>">View More</a></td>
            </tr>
            <?php
			$j++;
		}
