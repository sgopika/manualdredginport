...
<div class="row py-1">
	<div class="col-4 breaddiv">
		<span class="badge bg-darkmagenta innertitle mt-2">Customer Registration</span>
	</div>  <!-- end of col4 -->
	
	<div class="col-8 d-flex justify-content-end">
		<ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?php echo site_url("Manual_dredging/Port/port_dir_main"); ?>"> Home</a></li>
        <li class="breadcrumb-item"><a href="#"><strong>Customer Registration</strong></a></li>
      </ol>
</div> <!-- end of col-8 -->
...
<tr>
    ...
    <th>Customer Name</th>
    <th>Aadhar No.</th>
    <th>Work Site Localbody</th>
    <th>Status</th>
    <th>View Details</th>
</tr>
<?php
foreach($cu_det as $b_d)
{
	$c_id=encode_url($b_d['customer_registration_id']);
	$port_id=encode_url($b_d['port_id']);
	?>
<tr>
	<td><?php echo $i; ?></td>
    <td><?php echo $b_d['customer_name'];?></td>
    <td><?php echo $b_d['customer_aadhar_number'];?></td>
    <td><?php echo $b_d['panchayath_local'];?></td>
    <td>
	<?php if($b_d['customer_public_user_id']==0)
	{ ?>
	<button class="btn btn-sm btn-success btn-flat" type="button"> <i class="fa fa-fw  fa-minus"></i> &nbsp;&nbsp; Waiting For Approval &nbsp;&nbsp; </button> 
	<?php } else
	{ ?> <button class="btn btn-sm btn-info btn-flat" type="button"> <i class="fa fa-fw  fa-check-circle-o"></i> &nbsp; Approved </button> <?php } ?></td>
    <td><a href="<?php echo site_url("Manual_dredging/Port/customerregistration_view/".$c_id."/".$port_id);?>">View Details</a></td>
