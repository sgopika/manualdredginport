      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="<?php echo site_url("Port/mailbox");?>"><i class="fa fa-inbox"></i> Inbox
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li><a id="pd" href="#"><i class="fa fa-circle-o text-red"></i> Port Director</a></li>
                <li><a id="pc" href="#"><i class="fa fa-circle-o text-green"></i> Port Conservator</a></li>
                <li><a id="ot" href="#"><i class="fa fa-circle-o text-light-blue"></i> Others</a></li>
              </ul>
            </div>
            <!-- /.box-body -->
          </div>
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body no-padding"><!-- Check all button -->
           <div class="mailbox-controls">
              ...
              <div class="table-responsive mailbox-messages">
                ...
                <th></th>
                  ...
                  <tbody>
                 <?php foreach($recieved as $s) 
				  {?>
                  <tr style="color:<?php if($s['tbl_usertypeid']==2){ echo "red"; } elseif($s['tbl_usertypeid']==3){echo "green";} else {echo "light-blue";} ?>">
                    <td><input name="chk[]" value="<?php echo $s['tbl_inboxid']; ?>" type="checkbox"></td>
                    <td class="mailbox-star"><a href="#"><i class="<?php if($s['tbl_mailflag']==0){ echo "glyphicon glyphicon-eye-close text-red"; }else { echo "glyphicon glyphicon-eye-open text-green";} ?>"></i></a></td>
