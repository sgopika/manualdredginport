...
function del_userposing(id,status)
{
 ...
 <!-- Page specific script Ends Here -->
    ...
    <section class="content-header">
      <h1>
         <button class="btn btn-primary btn-flat disabled" type="button" >Communication</button>
      </h1>
      <ol class="breadcrumb">
        ...
        <li><a href="#"><strong>Comunication</strong></a></li>
      </ol>
    </section>
    <!-- Main content -->
      ...
      <div class="row custom-inner">
		...
		if(isset($editres)){
            ...
            <div class="box-header" id="view_designation">
              <a href="<?php echo $site_url.'/Master/police_view_pc';?>"> <button class="btn btn-primary btn-flat" type="button" > <i class="fa fa-fw fa-plus-circle"></i> &nbsp;&nbsp;Communication</button>
              </a>
            </div>
            <div class="box-body">
				...
				//print_r($data);
				 $i=1; foreach($get_policecase_list as $rowmodule){
					...
					<tr id="<?php echo $i;?>">
                        ...
                        <td><a href="<?php echo $site_url.'/Master/police_view_pc/'.encode_url($id);?>">
                        <button class="btn btn-sm btn-success btn-flat" type="button" onclick="toggle_status(<?php echo $id;?>,<?php echo $rowmodule['police_case_replied_user'];?>);"  > <i class="fa fa-fw  fa-check-circle-o"></i> &nbsp;&nbsp;View&nbsp;&nbsp; </button></a>
                        </td>
						<?php 
