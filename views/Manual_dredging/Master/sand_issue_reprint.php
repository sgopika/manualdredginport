...
<div class="row py-1">
	<div class="col-4 breaddiv">
		<span class="badge bg-darkmagenta innertitle mt-2">Sand Pass Reprint Request</span>
	</div>  <!-- end of col4 -->
	
	<div class="col-8 d-flex justify-content-end">
		<ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?php echo site_url("Manual_dredging/Port/port_zone_main"); ?>"> Home</a></li>
        <li class="breadcrumb-item"><a href="#"><strong>Sand Pass Reprint Request</strong></a></li>
      </ol>
</div> <!-- end of col-8 -->
     ...
     <div id="msgDiv" class="alert alert-info alert-dismissible" style="display:none"></div>
       ...
       $attributes = array("class" => "form-horizontal", "id" => "sand_issue_add", "name" => "sand_issue_add", "onSubmit" => "return validate_chk();");
		...
		if(isset($int_userpost_sl)){
       		echo form_open("Manual_dredging/Master/sand_issue_reprint", $attributes);
		} else {
			echo form_open("Manual_dredging/Master/sand_issue_reprint", $attributes);
		}?>
	  ...
	  Reason<font color="#FF0000">*</font>
           ...
           <div class="col-md-4 d-flex justify-content-start px-2">
			<textarea name="txtreason" id="txtreason"></textarea>
    	</div>
		   </div> <!-- end of row -->
