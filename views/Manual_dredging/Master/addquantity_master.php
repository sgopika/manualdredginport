  ...
  <link rel="stylesheet" href=<?php echo base_url("assets/plugins/datepicker/datepicker3.css"); ?>>
   <script src=<?php echo base_url("assets/plugins/input-mask/jquery.inputmask.js");?>></script>
	  ...
	  <script type="text/javascript">
		...
		messages: {
				vch_quantity_name: {
					required: "<font color='#FF0000'> Quantity Required!!</font>",
...
<div class="row py-1">
	...
	<div class="col-8 d-flex justify-content-end">
        ...
        <li class="breadcrumb-item"><a href="<?php echo site_url("Manual_dredging/Master/quantity_master"); ?>"><strong>Quantity</strong></a></li>
     ...
     <div id="msgDiv" class="alert alert-info alert-dismissible" style="display:none"></div> 
        ...
        $attributes = array("class" => "form-horizontal", "id" => "addqty", "name" => "addqty");
			} else {
       $attributes = array("class" => "form-horizontal", "id" => "addqty", "name" => "addqty", "onSubmit" => "return validate_chk();");
			}
        
		//print_r($editres); echo $editres[0]['intUserTypeID'];
		if(isset($int_userpost_sl)){
       		echo form_open("Manual_dredging/Master/quantity_master_edit", $attributes);
		} else {
		echo form_open("Manual_dredging/Master/quantitymaster_add", $attributes);
		...
		<input type="hidden" name="hid" value="<?php if(isset($int_userpost_sl)){ echo encode_url($int_userpost_sl);} ?>" />
			...
			Quantity Name<font color="#FF0000">*</font>
			</div>
           <div class="col-md-4 d-flex justify-content-start px-2">
            <input type="text" name="vch_quantity_name" value="<?php if(isset($int_userpost_sl)){ echo $quantity[0]['quantity_master_name'];} ?>" id="vch_quantity_name"  class="form-control"  maxlength="2" autocomplete="off" /> 
           </div></div>
