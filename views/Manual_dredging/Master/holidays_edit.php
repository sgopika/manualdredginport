...
$(document).ready(function()
{
	...
	$.post("<?php echo $site_url?>/Manual_dredging/Master/createDateRangeArrEdit",{start_date:start_date,end_date:end_date,port_id:port_id,period_name:period_name},function(data)
		{	
     ...
     <h1>
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url("Master/dashboard"); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
		 ...
		 <li><a href="<?php echo site_url("Master/holidaysettings"); ?>"><strong>Holiday Settings </strong></a></li>
        <li><a href="#"><strong><?php if(isset($period_name)){?>Edit<?php }?></strong></a><a href="<?php echo site_url("Master/holidays_edit"); ?>"><strong>Holidays </strong></a></li>
      </ol>
    </section>
    <!-- Main content -->
      ...
      <!--      </div> -->
        ...
        <div class="box box-primary box-blue-bottom">
            <div class="box-header ">
              ...
              <a href="<?php echo site_url("Manual_dredging/Master/holidays_edit"); ?>"><strong>Holiday</strong></a></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <?php 
       ...
       $attributes = array("class" => "form-horizontal", "id" => "holidays_add", "name" => "holidays_add");
		...
		if(isset($period_name)){
       		echo form_open("Master/holidays_add", $attributes);
		} else {
			echo form_open("Master/holidays_add", $attributes);
		}?>
