...
/*$teastvar=' events: [
			...
			//$teastvar=array('title'=>'Sunday','start'=>' 02-07-2017');
?>
<html>
<head>
  <meta charset="utf-8">
      ...
      <div class="row">
        ...
        <!-- /.col -->
         <div class="col-md-12" style="text-align:center">
            <div class="box-body no-padding">
        		<input width="10px" style="text-align:center" id="btn_add" name="btn_add" type="submit" class="btn btn-primary" value="Save"/>
			</div>
		</div>
      </div>
      <!-- /.row -->
    ...
    viewRender:function(view,element){
        if(view.name == "agendaDay"){
            if(jQuery("#calendar").hasClass("hasRendered") == false){
				...
				for(i=(d+diff);i<=lastday;i=i+7){
					
					newdate = new Date(y, m, i);
                ...
                $("#calendar").fullCalendar( "renderEvent", myEvents,"stick");
            }
...
$(document).ready(function () {/*
	function monthevent(date){
		//var date = new Date();
		//var b = $("#calendar").fullCalendar("getDate");
		//alert($('#calendar').fullCalendar.formatDate( b,'MM-dd-yyyy'));
		//b=b.format('YYYY-MM-DD');
		date = new Date(d_year, d_month,d_date);
		console.log(date);
		var datearr 	= date.split('-');
		date = new Date(datearr[0], (datearr[1]-1),01); 
		var d = date.getDate(),
		m = date.getMonth(),
		y = date.getFullYear();
		...
		$('#calendar').fullCalendar({events: myEvents});
			//alert(moment);
		//console.log(moment);
		//alert("The view's title is " + viewf.title);
	}
*/});
/*$("#calendar").fullCalendar({
    viewRender: function(view, element) {
        //alert(element);//Do something
		var b = $("#calendar").fullCalendar("getDate");
		//alert(b.getMonth());
		b=b.format('YYYY-MM-DD');
		//alert(b);
		...
		for(i=(d+diff);i<=lastday;i=i+7){
			...
			newdate = new Date(y, m, i);
			//newdate = new Date(y, m, i).toISOString().slice(0,10);
			//.replace(/-/g,"-");
			//var startdate = y + '-' + month + '-10';
			//var enddate = y + '-0' + month + '-15';
			myEvents.push({
		...
		//myEventsJSON=JSON.stringify(myEvents);
...
*/
  $(function () {
	  ...
	  //var myEvents = [];
	  function monthevent(d_year,d_month,d_date){
		var date = new Date(d_year,d_month,d_date);
		//var b = $("#calendar").fullCalendar("getDate");
		//alert($('#calendar').fullCalendar.formatDate( b,'MM-dd-yyyy'));
		//b=b.format('YYYY-MM-DD');
		//console.log(date);
		...
		for(i=(d+diff);i<=lastday;i=i+7){
			...
			//dateHasEvent(newdate) ;
		}
		//myEventsJSON=JSON.stringify(myEvents);
		$('#calendar').fullCalendar( 'removeEvents');
		$('#calendar').fullCalendar('addEventSource',myEvents);
		//$('#calendar').fullCalendar("renderEvent", myEventsJSON, 'stick');
			//alert(moment);
		console.log(myEvents);
		//alert("The view's title is " + viewf.title);
		//return myEvents;
	...
	viewRender: function (view, element) {
		...
		var datearr 	= b.split('-');
		//date = new Date(datearr[0], (datearr[1]-1),01); 
		monthevent(datearr[0], (datearr[1]-1),01);
		//alert(date);
		//console.log(datearr);
		//var d = date.getDate(),
		/*var d = 1,
		...
		myEventsJSON=JSON.stringify(myEvents);
		console.log(myEvents);*/
		//$('#calendar').fullCalendar( 'addEventSource', myEventsJSON );
		//$('#calendar').fullCalendar({events: myEvents});
		//$('#calendar').fullCalendar("renderEvent", myEvents, 'stick');
	...
	$(".fc-prev-button span").click(function(){
   		//alert('prev is clicked, do something');
		//var b = $("#calendar").fullCalendar("getMonth");
	    //alert(b.format());
