...
function showSection(val){
    ...
    <section class="content-header">
     <h1>
         ...
         <strong>Police Case </strong> </button>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url("Master/dashboard"); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
		 ...
		 <li><a href="<?php echo site_url("Master/police_case_pc"); ?>"><strong>Communication</strong></a></li>
      ...
      <!--      </div> -->
       ...
       $attributes = array("class" => "form-horizontal", "id" => "police_case_add", "name" => "police_case_add", "onSubmit" => "return validate_chk();");
		...
		<input type="hidden" name="hid" value="<?php if(isset($int_userpost_sl)){ echo $int_userpost_sl;} ?>" />
      		...
      		<td>
            <select name="bukid"  id="bukid"  class="form-control"  maxlength="100"> 
            <option value="" selected="selected">--select--</option>
            <?php
			foreach($get_cus_buk as $bid)
			{
				?>
                <option value="<?php echo $bid['customer_booking_id']; ?>"><?php echo $bid['customer_booking_token_number']; ?></option>
                <?php
			}
			?>
            </select>
		...
		<tr >
      		...
      		<td ><input type="text" name="txttokenno"  id="txttokenno"  class="form-control"  maxlength="100" autocomplete="off" required/> </td>
      	</tr>
		<tr >
       		<td>Police Station Name<font color="#FF0000">*</font></td>
      		<td><textarea name="txtpolicestnname" id="txtpolicestnname" class="form-control"  maxlength="100"></textarea></td>
      	</tr>
		 <tr >
      		...
      		<td><div class="input-group">
                  ...
                  </div><input type="text" class="form-control"  value="<?php echo @$start_date?>" name="txtletterdate" id="txtletterdate" data-inputmask="'alias': 'dd/mm/yyyy'" onChange="check_dates();" data-mask>
           </td>
      	</tr>
		<tr >
      		<td>Letter Number<font color="#FF0000">*</font></td>
      		<td ><input type="text" name="txtletterno"  id="txtletterno"  class="form-control"  maxlength="100" autocomplete="off" required/> </td>
      	</tr>
		<tr >
		<tr >
      		<td>Reference Number<font color="#FF0000">*</font></td>
      		<td ><input type="text" name="txtrefno"  id="txtrefno"  class="form-control"  maxlength="100" autocomplete="off" required/> </td>
      	</tr>
		<tr >
        ...
        <tr >
      		...
      		<td><textarea name="txtofficedetails" id="txtofficedetails" class="form-control"  maxlength="100"></textarea>
           </td>
      	</tr>
