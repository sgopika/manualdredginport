...
$(document).ready(function()
{
	$('#search').click(function()
				...
				//alert("asdasd");
					...
					$.post("<?php echo $site_url?>/Manual_dredging/Master/getbookingdetails_ajax_new/",{tokenno:tokenno},function(data)
						{
						//alert(data);exit();
						//alert(data);
							$('#showres').html(data);
...
<div class="row py-1">
	<div class="col-4 breaddiv">
		<span class="badge bg-darkmagenta innertitle mt-2">Search Booking</span>
	</div>  <!-- end of col4 -->
	 <?php 
	...
	<div class="col-8 d-flex justify-content-end">
        ...
        <li class="breadcrumb-item"><a href="#"><strong>Search Booking</strong></a></li>
      </ol>
</div> <!-- end of col-8 -->
		...
		if(isset($editres)){
          ...
          <div class="col-md-6 d-flex justify-content-center px-2">
           ...
           <div class="col-md-12 d-flex justify-content-center px-2">
            <center>
                <input class="btn btn-success" type="button" id="search" value="Search" /></center>
            </div>
	</div> <!-- end of row -->
           <div class="row p-3">
