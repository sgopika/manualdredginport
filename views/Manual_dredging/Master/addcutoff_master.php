...
<div class="row py-1">
	<div class="col-4 breaddiv">
		<span class="badge bg-darkmagenta innertitle mt-2">Cutoff Date</span>
	</div>  <!-- end of col4 -->
	
	<div class="col-8 d-flex justify-content-end">
		<ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?php echo site_url("Manual_dredging/Port/port_dir_main"); ?>"> Home</a></li>
        <li class="breadcrumb-item"><a href="<?php echo site_url("Manual_dredging/Master/cutoff_master"); ?>"><strong>Cutoff Status</strong></a></li>
		<li><a href="#"><strong><?php if(isset($int_userpost_sl)){?>Edit<?php } else {?>Set <?php }?> Cutoff </strong></a></li>
      </ol>
</div> <!-- end of col-8 -->
     ...
     <div id="msgDiv" class="alert alert-info alert-dismissible" style="display:none"></div> 
       ...
       $attributes = array("class" => "form-horizontal", "id" => "addplinth", "name" => "userposting", "onSubmit" => "return validate_chk();");
		...
		if(isset($int_userpost_sl)){
       		echo form_open("Manual_dredging/Master/cutoff_master_edit", $attributes);
		} else {
		echo form_open("Manual_dredging/Master/cutoff_add", $attributes);
       ...
       Permit Cutoff Date<font color="#FF0000">*</font>
	   </div>
           <div class="col-md-4 d-flex justify-content-start px-2">
            <input type="text" name="vch_plinth_pc" value="<?php if(isset($int_userpost_sl)){ echo $plinth[0]['cutoff_date'];} ?>" id="vch_plinth_pc"  class="form-control"  maxlength="2" autocomplete="off" /> 
            </div>
		   </div> <!-- end of row -->
           <div class="row p-3">
           <div class="col-md-6 d-flex justify-content-center px-2">
