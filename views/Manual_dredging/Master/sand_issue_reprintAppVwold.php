      ...
      <div class="row custom-inner">
		...
		if(isset($editres)){
            ...
            <!--<div class="box-header" id="view_designation">
              <a href="<?php echo $site_url.'file:///Master/sand_issue_reprint';?>"> <button class="btn btn-primary btn-flat" type="button" > <i class="fa fa-fw fa-plus-circle"></i> &nbsp;&nbsp;Sand Issue Reprint Request</button>
              </a>
            </div>-->
            <div class="box-body">
				 ...
				 $i=1; foreach($datareprintview as $rowmodule){
					...
					<tr id="<?php echo $i;?>">
                        ...
                        <div ><?php echo strtoupper($rowmodule['customer_max_allotted_ton']);?></div>
							...
							<td>  <a href="<?php echo $site_url.'/Master/sand_issue_reprintApproval/'.encode_url($id);?>"><button class="btn btn-sm bg-blue btn-flat" type="button">  &nbsp; Approve </button></a> </td>
