	...
	?>
     <div class="col-12 d-flex justify-content-end">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?php echo site_url('Manual_dredging/Master/customer_requestprocessing'); ?>"> Customer Registration View</a></li>
...
<!-- ------------------------------------------------------------------------------------->
 ...
 <?php 
      ...
      <div class="row p-3">
       ...
       <div class="row p-3"  <?php if($rowsmodule['customer_purpose']!=1){?> style="display:none;" <?php }?>>
           ...
           <div class="col-md-4 d-flex justify-content-start px-2">
			<input type="text" name="customer_plinth_area" value="<?php echo $rowsmodule['customer_plinth_area']; ?>" id="customer_plinth_area"  class="form-control"  maxlength="100" onchange="maxton_calculate();" autocomplete="off"  /> 
			</div>
		</div> <!-- end of row -->
       <div class="row p-3">
           <div class="col-md-6 d-flex justify-content-center px-2">
       ...
       <div class="row p-3">
           ...
           <div class="col-md-4 d-flex justify-content-start px-2">
		   <input type="text" name="customer_max_allotted_ton" value="<?php echo $rowsmodule['customer_max_allotted_ton']; ?>" id="customer_max_allotted_ton"  class="form-control"  maxlength="100" onBlur="customer_max_allotted_ton()" autocomplete="off" readonly="true" /> 
		   </div>
		</div> <!-- end of row -->
       <div class="row p-3">
           <div class="col-md-6 d-flex justify-content-center px-2">
       ...
       <div class="row p-3">
           ...
           <div class="col-md-4 d-flex justify-content-start px-2">
			<a href="<?php echo site_url("Manual_dredging/Master/down_my_file");?>/<?php echo $rowsmodule['aadhar_uploadname'];?>"  target="_blank"><font color="#CC0000">Aadhaar</font></a>
			</div>
		</div> <!-- end of row -->
       <div class="row p-3">
           <div class="col-md-6 d-flex justify-content-center px-2">
           ...
           <div class="col-md-4 d-flex justify-content-start px-2">
			<a href="<?php echo site_url("Manual_dredging/Master/down_my_file");?>/<?php echo $rowsmodule['permit_uploadname'];?>"  target="_blank"><font color="#CC0000">Building Permit</font> </a>
			</div>
		</div> <!-- end of row -->
       <div class="row p-3">
           <div class="col-md-6 d-flex justify-content-center px-2">
           ...
           <select name="customer_port_id" id="customer_port_id"   class="form-control"  disabled="disabled" >
 ...
 <div class="row p-3">
           ...
           <div class="col-md-4 d-flex justify-content-start px-2">
				  &nbsp;&nbsp;<input type="radio" name="radioRequestStatus"  value="2" />&nbsp;&nbsp;Approve
			

                &nbsp;&nbsp;<input type="radio" name="radioRequestStatus"  value="3"   /> &nbsp;&nbsp;Reject
			</div>
 ...
 <div class="row p-3">
           <div class="col-md-6 d-flex justify-content-center px-2">Remarks<font color="#FF0000">*</font>
		  </div>
           <div class="col-md-4 d-flex justify-content-start px-2">
			<textarea name="txtremarks" id="txtremarks"></textarea> 
			</div>
