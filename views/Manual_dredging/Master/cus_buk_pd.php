...
$(document).ready(function()
{
	...
	$('#btn_add').click(function()
	{
		...
		var t_date=$('#to_date').val();
					//var period =$('#periodb').val();
		$.post("<?php echo $site_url?>/Manual_dredging/Port/get_pd_buk/",{port_id:port_id,zone_id:zone_id,f_date:f_date,t_date:t_date},function(data)
	 	{
							//alert("hello");
      ...
      <!--      </div> -->
       ...
       $attributes = array("class" => "form-horizontal", "id" => "addlsgd", "name" => "userposting", "onSubmit" => "return validate_chk();");
        ...
        <tr>
        	<th>Sl No</th>
            <th>Port Name</th>
            <th>Total Sand Booking</th>
            <th>Approved Sand Booking</th>
            <th>Sand Issued</th>
            <th>View More</th>
        </tr>
        <?php 
		...
		foreach($arr as $ar)
		{
            ...
            <tr>
                ...
                <td><a href="<?php echo $site_url.'/Manual_dredging/Port/get_pd_buk/'.encode_url($ar['col4']);?>">View More</a></td>
            </tr>
            <?php
			$j++;
		}
