...
function showSection(val){
      ...
      <!--      </div> -->
       ...
       $attributes = array("class" => "form-horizontal", "id" => "userposting", "name" => "userposting", "onSubmit" => "return validate_chk();");
		...
		if(isset($int_userpost_sl)){
       		...
       		echo form_open("Master/editmaterialrate_pc", $attributes);

		} else {

		echo form_open("Master/addmaterialrate_pc", $attributes);
        ...
        <tr >
            ...
            <option value="<?php echo $mat['material_master_id']; ?>" <?php if($mat['material_master_id']==$material_det[0]['materialrate_port_material_master_id']){ ?> selected="selected" <?php } ?>><?php echo $mat['material_master_name']; ?></option>
        ...
        <tr >
           ...
           <input type="text" name="vch_material_amt"  <?php if(isset($int_userpost_sl)){ ?> value="<?php echo $material_det[0]['materialrate_port_amount'];?>" readonly <?php } ?>id="vch_designation_name"  class="form-control"  maxlength="100" autocomplete="off" /> 
		...
		if(isset($int_userpost_sl))
         ...
         <tr >
           ...
           <input type="text" name="vch_material_sd" value="<?php if(isset($int_userpost_sl)){ echo date("d/m/Y", strtotime(str_replace('-', '/',$material_det[0]['materialrate_port_start_date'])));}else { echo date('d/m/Y');} ?>" id="vch_material_sd"  class="form-control"  data-inputmask="'alias': 'dd/mm/yyyy'" onChange="check_dates();" data-mask  maxlength="100" autocomplete="off" /> 
  ...
  <?php
				  ...
				  if($material_det[0]['materialrate_port_end_date']!='0000-00-00')

				  {

				  $end_date=date("d/m/Y", strtotime(str_replace('-', '/',$material_det[0]['materialrate_port_end_date'] ))); 
       	...
       	<tr >
            ...
            <option value="<?php echo $s['status_id'];?>" <?php if($s['status_id']==$material_det[0]['materialrate_port_status']) { ?> selected="selected" <?php } ?> ><?php echo $s['status_name'];?></option>
