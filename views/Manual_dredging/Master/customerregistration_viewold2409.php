...
function checkconstruction()
{
    ...
    <section class="content-header">
     <h1>
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#"><strong><?php if(isset($int_userpost_sl)){?>Edit<?php } else {?>Add <?php }?></strong></a><a href="<?php echo site_url("Master/customerregistration_add"); ?>"><strong>Customer</strong></a></li>
      </ol>
    </section>
    <!-- Main content -->
      ...
      <!--      </div> -->
        ...
        <div class="box box-primary box-blue-bottom">
            <div class="box-header ">
              <h3 class="box-title">View <a href="<?php echo site_url("Master/customerregistration_vire"); ?>"><strong>Customer Registration</strong></a>  </h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <?php 
       ...
       $attributes = array("class" => "form-horizontal", "id" => "customerregistration_add", "name" => "customerregistration_add", "onSubmit" => "return validate_chk();");
		...
		if(isset($int_userpost_sl)){
       		echo form_open("Master/customerregistration_view", $attributes);
		} else {
			echo form_open("Master/customerregistration_view", $attributes);
		}?>
    ...
    <?php  foreach ($customerreg_details as $rowsmodule){ ?>
        ...
        <tr >
         ...
         <tr >
      		<td colspan="2" align="center"style="background-color:#9BDADD"><font color="#330099" style="text-align:center; font-weight:bold;">Permanent Address Details</font></td>
		</tr>
        ...
        <tr <?php if($rowsmodule['customer_purpose']!=1){?> style="display:none;" <?php }?> >
         ...
         <tr >
            ...
            <td ><input type="text" name="customer_max_allotted_ton" value="<?php echo $rowsmodule['customer_max_allotted_ton']; ?>" id="customer_max_allotted_ton"  class="form-control"  maxlength="100" onBlur="customer_max_allotted_ton()" autocomplete="off" required/> </td>
        </tr>
        ...
        <tr >
            ...
            <td ><a href="../../../upload/<?php echo $rowsmodule['aadhar_uploadname'];?>"  target="_blank"><font color="#CC0000">Aadhaar</font></a></td>
        </tr>
        	
        <tr >
            <td>Upload Building Permit/Tax Receipt<font color="#FF0000">*</font></td>
            <td ><a href="../../../upload/<?php echo $rowsmodule['permit_uploadname'];?>"  target="_blank"><font color="#CC0000">Building Permit</font> </a> </td>
        </tr>
 ...
 <tr >
      		...
      		<td>Approve  <input type="radio" name="radioRequestStatus"  value="2"  />
                Reject <input type="radio" name="radioRequestStatus"  value="3"  checked="checked" />
           </td>
      	</tr>
