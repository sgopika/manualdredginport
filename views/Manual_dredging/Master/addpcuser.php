...
$(document).ready(function()
{
	...
	$('#vch_un').change(function()
				{
					var un=$('#vch_un').val();
					$.post("<?php echo $site_url?>/Manual_dredging/Master/ch_usrAjax/",{un:un},function(data)
						{
							if(data==1)
							{
				...
				{
					var zid=$('#int_zone').val();
					$.post("<?php echo $site_url?>/Manual_dredging/Master/get_zusrAjax/",{zid:zid},function(data)
						{
							$('#vch_un').val(data);
...
<div class="row py-1">
	<div class="col-4 breaddiv">
		<span class="badge bg-darkmagenta innertitle mt-2">Create PC User</span>
	</div>  <!-- end of col4 -->
	
	<div class="col-8 d-flex justify-content-end">
		<ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?php echo site_url("Manual_dredging/Master/pcdredginghome"); ?>"> Home</a></li>
          <li class="breadcrumb-item"><a href="#"><strong>Create PC User</strong></a></li>
      </ol>
</nav>
</div> <!-- end of col-8 -->
 ...
 <?php
       ...
       $attributes = array("class" => "form-horizontal", "id" => "addzone", "name" => "addzone", "onSubmit" => "return validate_chk();");
		...
		if(isset($int_userpost_sl)){
       		echo form_open("Manual_dredging/Master/pc_user_addN", $attributes);
		} else {
		echo form_open("Manual_dredging/Master/pc_user_addN", $attributes);
    ...
    <div class="row p-3">
		...
		<input type="hidden" name="hid" value="<?php if(isset($int_userpost_sl)){ echo $int_userpost_sl;} ?>" />
		 ...
		 ?>
           ...
           <div class="row p-3" id="zone" style="display:none">
           <div class="col-md-6 d-flex justify-content-center px-2" >
        Zone<font color="#FF0000">*</font>
           ...
           <div class="row p-3">
           <div class="col-md-6 d-flex justify-content-center px-2">Username<font color="#FF0000">*</font>
		   </div>
           <div class="col-md-4 d-flex justify-content-start px-2">
            <input type="text" name="vch_un" id="vch_un" autocomplete="off" class="form-control"  maxlength="100" /><div id="chk_usr"></div>
             </div>
		</div> <!-- end of row -->
           <div class="row p-3">
           <div class="col-md-6 d-flex justify-content-center px-2">Phone Number<font color="#FF0000">*</font>
		    </div>
           <div class="col-md-4 d-flex justify-content-start px-2">
            <input type="text" name="vch_ph" id="vch_ph" autocomplete="off" class="form-control"  maxlength="10" />
            </div>
		</div> <!-- end of row -->
           <div class="row p-3">
           <div class="col-md-6 d-flex justify-content-center px-2">Email </div>
           <div class="col-md-4 d-flex justify-content-start px-2">
