...
<div class="row py-1">
	<div class="col-4 breaddiv">
		<span class="badge bg-darkmagenta innertitle mt-2">Cutoff Status</span>
	</div>  <!-- end of col4 -->
	
	<div class="col-8 d-flex justify-content-end">
		<ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?php echo site_url("Manual_dredging/Port/port_dir_main"); ?>"> Home</a></li>
        <li class="breadcrumb-item"><a href="#"><strong>Cutoff Status</strong></a></li>
      </ol>
</div> <!-- end of col-8 -->
     ...
     <div id="msgDiv" class="alert alert-info alert-dismissible" style="display:none"></div> 
		...
		<div class="col-12">
               <a href="<?php echo $site_url.'/Manual_dredging/Master/cutoff_add';?>"> <button class="btn btn-primary btn-flat" type="button"<?php if(count($plinth)>0) {?> disabled="disabled" <?php } ?>> <i class="fa fa-fw fa-plus-circle"></i> &nbsp;&nbsp;Add Cutoff Settings </button>
              </a>
            </div></div>
            <!-- /.box-header -->
             <div class="row">
		...
		<!-- --------------------------------------------- start of table column ------------------------------------- -->
		 <table id="example" class="table table-bordered table-striped">
                ...
                <tr>
                  <th id="sl">Sl.No</th>
                  <th></th>
                  <th id="col_name">Permit Cutoff Date</th>
				...
				$allegation=array();
				 $i=1; foreach($plinth as $rowmodule){
					 $id = $rowmodule['cutoff_master_id'];
					?>
					<tr id="<?php echo $i;?>">
						<td  id="sl_div_<?php echo $i; ?>"> <?php echo $i; ?> </td>
                        <td></td>
						<td id="col_div_<?php echo $i; ?>">
                        <div id="first_<?php echo $i;?>"><?php echo strtoupper($rowmodule['cutoff_date']);?></div>
                        </td>				
						<td id="td_div_<?php echo $i;?>"> 
                        <div id="edit_div_<?php echo $i;?>">
                        <a href="<?php echo $site_url.'/Manual_dredging/Master/cutoff_master_edit/'.encode_url($id);?>">
