          ...
          <div class="input-group">
            <div class="input-group-addon"> </i> 
              <ul class="nav child_menu">
                ...
                <li><a href="<?php echo site_url("Master/cr_pc_user"); ?>">Create User</a></li>
                <li><a href="<?php echo site_url("Master/material_rate_pc"); ?>">Add Material Rate</a></li>
                ...
                <li><a href="<?php echo site_url("Master/customer_bookingapproval"); ?>">Customer Booking Approve</a></li>	
                 <li><a href="<?php echo site_url("Master/genReport"); ?>">Report</a></li>	
               <!-- <li><a href="<?php echo site_url("Master/customer_login"); ?>">Customer Login Details</a></li>-->
                ...
                <li><a href="<?php echo site_url("Port/mailbox"); ?>">MailBox</a></li>
                 <li><a href="<?php echo site_url("Port/chart_pc"); ?>">Chart</a></li>
              </ul>
            </div>
          </div>
          <!-- /.input group -->
