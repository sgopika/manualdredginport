  ...
  <link rel="stylesheet" href=<?php echo base_url("assets/plugins/datepicker/datepicker3.css"); ?>>
   <script src=<?php echo base_url("assets/plugins/input-mask/jquery.inputmask.js");?>></script>
	  ...
	  <script type="text/javascript">
		...
		messages: {
				vch_plinth_name: {
					required: "<font color='#FF0000'> Plinth Area Required!!</font>",
...
<div class="row py-1">
	...
	<div class="col-8 d-flex justify-content-end">
        ...
        <li class="breadcrumb-item"><a href="<?php echo site_url("Manual_dredging/Master/plintharea_master"); ?>"><strong>Plinth Area</strong></a></li>
		 <li class="breadcrumb-item"><a href="#"><strong><?php if(isset($int_userpost_sl)){?>Edit<?php } else {?>Add <?php }?> Plinth Area </strong></a></li>
      </ol>
</div> <!-- end of col-8 -->
     ...
     <div id="msgDiv" class="alert alert-info alert-dismissible" style="display:none"></div> 
       ...
       $attributes = array("class" => "form-horizontal", "id" => "addplinth", "name" => "userposting", "onSubmit" => "return validate_chk();");
		...
		if(isset($int_userpost_sl)){
       		echo form_open("Manual_dredging/Master/Quantity_edit", $attributes);
		} else {
		echo form_open("Manual_dredging/Master/plintharea_add", $attributes);
		...
		<input type="hidden" name="hid" value="<?php if(isset($int_userpost_sl)){ echo encode_url($int_userpost_sl);} ?>" />
              ...
              Plinth Area<font color="#FF0000">*</font>
			 </div>
           <div class="col-md-4 d-flex justify-content-start px-2">
            <input type="text" name="vch_plinth_name" value="<?php if(isset($int_userpost_sl)){ echo $plinth[0]['plintharea_area'];} ?>" id="vch_plinth_name"  class="form-control"  maxlength="100" autocomplete="off" /> 
            </div>
		   </div> <!-- end of row -->
           <div class="row p-3">
           <div class="col-md-6 d-flex justify-content-center px-2">
