...
<div class="row py-1">
	...
	<div class="col-8 d-flex justify-content-end">
		...
		<li class="breadcrumb-item"><a href="<?php echo site_url("Manual_dredging/Report/userman_home"); ?>"> User management</a></li>
          <li class="breadcrumb-item"><a href="#"><strong>Add Module</strong></a></li>
      </ol>
</nav>
</div> <!-- end of col-8 -->
 ...
 <?php 
       ...
       $attributes = array("class" => "form-horizontal", "id" => "addzone", "name" => "addzone", "onSubmit" => "return validate_chk();");
		...
		if(isset($int_userpost_sl)){
       		echo form_open("Manual_dredging/Port/add_module_new", $attributes);
		} else {
		echo form_open("Manual_dredging/Port/add_module_new", $attributes);
...
<div class="row p-3">
		...
		User Name<font color="#FF0000">*</font>
           ...
           <div class="col-md-4 d-flex justify-content-start px-2">
            <select  name="int_user"  id="int_user"  class="form-control"  maxlength="100">
            <option value="" selected="selected">--select--</option>
            <?php foreach($get_clerk as $p)
			{
				
				?>
            <option value="<?php echo $p['user_master_id'];?>"><?php echo $p['user_master_name'];?></option>
            <?php
           ...
           <div class="row p-3">
           <div class="col-md-6 d-flex justify-content-center px-2">
		   Select Module <font color="#FF0000">*</font>
		  </div>
           <div class="col-md-4 d-flex justify-content-start px-2">
            <select  name="int_mod"  id="int_mod"  class="form-control"  maxlength="100">
            <option value="" selected="selected">--select--</option>
            <?php foreach($get_module as $p)
			{
				
				?>
            <option value="<?php echo $p['module_id'];?>"><?php echo $p['module_name'];?></option>
            <?php
