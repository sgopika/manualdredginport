          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <div class="box-tools pull-right">
                <a href="<?php echo site_url("Port/mailbox");?>" class="btn btn-box-tool" data-toggle="tooltip" title="back to inbox"><i class="glyphicon glyphicon-inbox"></i></a>
              </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body no-padding">
              <div class="mailbox-read-info">
                <h3><?php echo $msg[0]['tbl_subject']; ?></h3>
                <h5>From: <?php echo $msg[0]['user_master_name']; ?>
                  <span class="mailbox-read-time pull-right"><?php echo $msg[0]['tbl_date']; ?></span></h5>
              </div>
              <!-- /.mailbox-read-info -->
