	...
	$('#zone_id').change(function()
				{
					...
					$.post("<?php echo $site_url?>/Manual_dredging/Report/workerdetails_ajax/",{zone_id:zone_id},function(data)
						{
							$('#show').html(data);
						});
				});
...
<div class="row py-1">
	<div class="col-4 breaddiv">
		<span class="badge bg-darkmagenta innertitle mt-2">Worker Details</span>
	</div>  <!-- end of col4 -->
	
	<div class="col-8 d-flex justify-content-end">
		<ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?php echo site_url("Manual_dredging/Master/pcdredginghome"); ?>"> Home</a></li>
        <li class="breadcrumb-item"><a href="#"><strong>Worker Details</strong></a></li>
      </ol>
</div> <!-- end of col-8 -->
...
//	print_r($zone); //echo $editres[0]['intUserTypeID'];
		if(isset($editres))
		{
