    ...
    <section class="content-header">
     ...
     <h1>
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#"><strong>Door Delivery Booking</strong></a></li>
...
<?php $sess_mobno 			=  $this->session->userdata('sess_spot_mob'); ?>
      ...
      <!--      </div> -->
        ...
        <div class="box box-primary box-blue-bottom">
            ...
            <div class="box-header ">
              ...
              <h3 class="box-title">Door Delivery Booking</h3>
			  ...
			  echo form_open('Report/add_door_registrationnew',$attributes);
...

		{
			...
			?>
					...
					<tr>
               			...
               			<option value="16">PONNANI</option>
 ...
 <option value="8">Rajadani Minerals</option>
            </select>
