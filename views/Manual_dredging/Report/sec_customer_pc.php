	...
	$('#zone_id').change(function()
				{
					...
					$.post("<?php echo $site_url?>/Manual_dredging/Report/sec_customer_booking_pc_ajax/",{zone_id:zone_id},function(data)
						{
							$('#show').html(data);
						});
				});
...
<div class="row py-1">
	<div class="col-4 breaddiv">
		<span class="badge bg-darkmagenta innertitle mt-2">Change Alotted Date</span>
	</div>  <!-- end of col4 -->
	<?php 
	...
	<div class="col-8 d-flex justify-content-end">
        ...
        <li class="breadcrumb-item"><a href="#"><strong>Change Alotted Date</strong></a></li>
      </ol>
</div> <!-- end of col-8 -->
          ...
          <div class="col-md-6 d-flex justify-content-center px-2">
           ...
           <div class="col-md-4 d-flex justify-content-start px-2">
			   ...
			   foreach($zone as $row)
				{
				?>
                <option value="<?php echo $row['zone_id']; ?>" <?php if(isset($pass_zoneid))
{  if($pass_zoneid==$row['zone_id']) { ?> selected <?php } } ?>><?php echo $row['zone_name']; ?></option> 
				<?php 
				}
				?>
                </select>
           ...
           <div class="row py-1">
           <div class="col-md-12 d-flex justify-content-center px-2"><center><button id="sh_buk" class="btn btn-success">Submit</button></center>
           </div>
           </div>
