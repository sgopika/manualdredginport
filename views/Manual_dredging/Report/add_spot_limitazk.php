...
<div class="row p-3">
          <div class="col-md-6 d-flex justify-content-center px-2">
           ...
           <div class="col-md-4 d-flex justify-content-start px-2">
                                <select name="txt_zone" id="txt_zone"><option value="">select kadavu</option><?php foreach($zone as $z){?> <option value="<?php echo $z['zone_id']; ?>"><?php echo $z['zone_name'];?></option><?php } ?>
                                </select>
                            </div>
		</div> <!-- end of row -->
           <div class="row p-3">
           ...
           <div class="col-md-4 d-flex justify-content-start px-2">
                              <input type="date" name="date_int"  id="date_int"     maxlength="8" autocomplete="off" />
           ...
           <div class="row p-3">
           <div class="col-md-6 d-flex justify-content-center px-2">
        Other Lorry Booking Count
    </div>
           <div class="col-md-4 d-flex justify-content-start px-2">
        <input type="text" name="txtbookingcount" id="txtbookingcount" />
     </div>
		</div> <!-- end of row -->
           <div class="row p-3">
           <div class="col-md-6 d-flex justify-content-center px-2" id="show">
