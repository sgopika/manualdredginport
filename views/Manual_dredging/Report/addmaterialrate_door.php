...

{
	...
	$('#quantityid').change(function()
		...
		var quantityid=$('#quantityid').val();
					...
					$.post("<?php echo $site_url?>/Report/doordevl_zonecheck_ajax/",{zoneid:zoneid,quantityid:quantityid},function(data)
      ...
      <!--      </div> -->
       ...
       $attributes = array("class" => "form-horizontal", "id" => "userposting", "name" => "userposting", "onSubmit" => "return validate_chk();");
        ...
        <tr >
      	...
      	<tr><td>Quantity<font color="#FF0000">*</font></td><td><select id="quantityid" name="quantityid">
        ...
        <tr >
      		...
      		<td>Minimum Distance(in KM)<font color="#FF0000">*</font></td>
