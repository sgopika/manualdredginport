...
<div class="container-fluid ui-innerpage">
    ...
    <section class="content-header">
          ...
          <div class="col-md-6 d-flex justify-content-center px-2">
               ...
               &nbsp;Click Here -> Spot Booking Home<a href="<?php echo site_url(); ?>/Manual_dredging/Report/spot" title="Go to SpotBooking Home"> <span class="glyphicon glyphicon-home" aria-hidden="false"></span></a></div></div>
            <p>&nbsp;</p>
              <hr />
              <?php
			  echo form_open('Manual_dredging/Report/add_kadavu_spot') ;
			  ?>
          ...
          <div class="col-md-6 d-flex justify-content-center px-2">
           ...
           <div class="col-md-4 d-flex justify-content-start px-2">
         	<select name="zone_id">
         		<option value="">select</option><?php foreach($zone as $z) {?> <option value="<?php echo $z['zone_id']; ?>"><?php echo $z['zone_name'];?></option><?php }?></select>
         	</div></div>
              <div class="row p-3">
          <div class="col-md-12 d-flex justify-content-center px-2">
             <input type="submit" value="add kadavu" />
             </div>
             <?php echo form_close(); ?>
