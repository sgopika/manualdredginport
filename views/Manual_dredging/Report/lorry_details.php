     ...
     <div id="msgDiv" class="alert alert-info alert-dismissible" style="display:none"></div> 
       ...
       <div class="row">
		...
		<!-- --------------------------------------------- start of table column ------------------------------------- -->
               ...
               <a href="<?php echo $site_url.'/Manual_dredging/Report/lorry_reg';?>"> <button class="btn btn-primary btn-flat" type="button" > <i class="fa fa-fw fa-plus-circle"></i> &nbsp;&nbsp;Add Lorry </button>
              </a>
              <hr />
