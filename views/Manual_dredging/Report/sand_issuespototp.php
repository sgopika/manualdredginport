...
//	$("#spotenter").hide();
	...
	$('#btn_otp').click(function()
		...
		//alert(txtaadharno);
		//alert(txttokenno);
   						$.post("<?php echo $site_url?>/Manual_dredging/Report/spototp_vehiclepass/",{txttokenno:txttokenno},function(data)
						{
							//alert(data);exit;
							if(data==0)
							{
	...
	$('#btn_check').click(function()
				{
					var otpno=$('#txt_otp').val();
   						...
   						$.post("<?php echo $site_url?>/Manual_dredging/Report/vehiclepass_spototpcheck/",{otpno:otpno},function(data)
						{
							//alert(data);exit;
							if(data==0)
							{
...
<div class="row py-1">
	<div class="col-4 breaddiv">
		<span class="badge bg-darkmagenta innertitle mt-2">Sand Issue Spot</span>
	</div>  <!-- end of col4 -->
	
	<div class="col-8 d-flex justify-content-end">
		<ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?php echo site_url("Manual_dredging/Port/port_zone_main"); ?>"> Home</a></li>
        <li class="breadcrumb-item"><a href="#"><strong>Sand Issue Spot</strong></a></li>
      </ol>
</div> <!-- end of col-8 -->
     ...
     <div id="msgDiv" class="alert alert-info alert-dismissible" style="display:none"></div>
       ...
       $attributes = array("class" => "form-horizontal", "id" => "sand_issue_add", "name" => "sand_issue_add", "onSubmit" => "return validate_chk();");
		...
		if(isset($int_userpost_sl)){
       		...
       		echo form_open("Manual_dredging/Report/sand_issueotpspot", $attributes);
  ...
  <table ><tr ><td></td><td>
  		...
  		<div class="row px-5"  id="divid" style="display: none;">
		...
		<input type="hidden" name="hId" value="<?php  if(isset($int_designation_sl)){echo $int_designation_sl;}?>" />
		               ...
		               <input id="btn_add" name="btn_add" type="submit" class="btn btn-primary" value="View Details"/>
