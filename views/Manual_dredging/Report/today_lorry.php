...
<div class="row py-1">
	<div class="col-4 breaddiv">
		<span class="badge bg-darkmagenta innertitle mt-2">Lorry Details</span>
	</div>  <!-- end of col4 -->
	
	<div class="col-8 d-flex justify-content-end">
		<ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?php echo site_url("Manual_dredging/Port/port_zone_main"); ?>"> Home</a></li>
        <li class="breadcrumb-item"><a href="#"><strong>Lorry Details</strong></a></li>
      </ol>
</div> <!-- end of col-8 -->
       ...
       <div class="row">
		...
		<!-- --------------------------------------------- start of table column ------------------------------------- -->
			 ...
			 ?>
             		<tr>
                    	<td><?php echo $i; ?></td>
                        <td><?php echo $l['lorry_reg_no']; ?></td>
                        <td><?php echo $l['owner_name']; ?></td>
                        <td><?php echo $l['contact_no']; ?></td>
                        <td><?php echo $l['lorry_cap']; ?></td>
                        <td><?php echo date("d/m/Y",strtotime(str_replace('-', '/',$l['assign_lorry_date']))); ?></td>
                        <td><?php echo $l['assign_lorry_time']; ?></td>
                    </tr>
             <?php
			 $i++;
				}
