...
$(document).ready(function()
{
	$('#btn_rep').click(function()
				...
				//alert("hello");
					...
					$.post("<?php echo $site_url?>/Report/getqtyspot/",{port_id:port_id},function(data)
						{
						//alert(data);
				...
				//alert("hello");
					...
					//getamt(port_id);
					//var period =$('#periodb').val();
					$.post("<?php echo $site_url?>/Report/getspotton/",{port_id:port_id,ton:ton},function(data)
						{
						//alert(data);
						if(data==1){alert("Balance ton limit over");$('#txt_ton').val('');}else{
						//alert(data);
			  ...
			  ?>
                  <table  class="table table-bordered table-striped">
                    <tr>
                    	...
                    	<td><input type="text" name="txt_username" id="txt_username"  class="form-control" required="required" autocomplete="off"  /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="txt_phone" id="txt_phone" class="form-control" maxlength="10" required="required" autocomplete="off" /></td>
                    </tr>
					<tr>
      					 <td>Select Port</td>
                    ...
                    <tr>
                    	<td>Unloading Place[<font color="#FF0000" >Unloading place must me same as that in Aadhar Card</font>]</td>
                        <td><input type="text" name="txt_place" id="txt_place" class="form-control" maxlength="100" required="required"/></td>
                    </tr>
                    <tr>
                    	<td>Route</td>
                        <td>
                        <textarea name="txt_route" id="txt_route" class="form-control" autocomplete="off" required="required"></textarea>
                        </td>
                    </tr>
                    <tr>
                    	<td>Distance in KM</td>
                        <td><input type="text" name="txt_distance" id="txt_distance" class="form-control" maxlength="10" required="required" autocomplete="off" /></td>
                    </tr>
