      ...
      <div class="row custom-inner">
		...
		if(isset($editres)){
            ...
            <div class="box-header" id="view_allegation">
               ...
               <a href="<?php echo $site_url.'/Report/addmaterialrate_door';?>"> <button class="btn btn-primary btn-flat" type="button" > <i class="fa fa-fw fa-plus-circle"></i> &nbsp;&nbsp;Door Delivery Rate</button>
            ...
            <div class="box-body">
              ...
              <table id="vacbtable" class="table table-bordered table-striped">
				...
				<th id="col_name">Minimum Distance(KM)</th>

                  <th id="col_name">Minimum amount</th>

                  <th id="col_name">Per Km Rate</th>
				...
				$allegation=array();
				 ...
				 $i=1; foreach($material_rate as $rowmodule){
					 ...
					 $id = $rowmodule['door_delivery_rate_id'];
					...
					<tr id="<?php echo $i;?>">
                        ...
                        <div id="first_<?php echo $i;?>"></div>

                         <?php echo $rowmodule['door_delivery_quantity'];?>
                         <div id="hide_<?php echo $i;?>" style="display:none"><input type="text" name="edit_allegation_<?php echo $i;?>"  id="edit_allegation_<?php echo $i;?>" value="<?php echo $rowmodule['door_delivery_status'];?>" onchange="check_dup_allegation_edit(<?php echo $i;?>);"   maxlength="100" autocomplete="off"/>
                        ...
                        <div id="first_<?php echo $i;?>"></div>
                         ...
                         <?php echo $rowmodule['minimum_distance'];?>
                         <div id="hide_<?php echo $i;?>" style="display:none"><input type="text" name="edit_allegation_<?php echo $i;?>"  id="edit_allegation_<?php echo $i;?>" value="<?php echo $rowmodule['door_delivery_status'];?>" onchange="check_dup_allegation_edit(<?php echo $i;?>);"   maxlength="100" autocomplete="off"/>
                        ...
                        <div id="first_<?php echo $i;?>"></div>
                         ...
                         <?php echo $rowmodule['minimum_amount'];?>
                         <div id="hide_<?php echo $i;?>" style="display:none"><input type="text" name="edit_allegation_<?php echo $i;?>"  id="edit_allegation_<?php echo $i;?>" value="<?php echo $rowmodule['door_delivery_status'];?>" onchange="check_dup_allegation_edit(<?php echo $i;?>);"   maxlength="100" autocomplete="off"/>
                        ...
                        <div id="first_<?php echo $i;?>"><?php echo strtoupper($rowmodule['per_kiometer_amount']);?></div>
                        ...
                        <div id="first_<?php echo $i;?>"><?php $zi=$rowmodule['door_delivery_zone_id']; $z_a=explode(',',$zi);foreach($zone as $z){ if(in_array($z['zone_id'],$z_a)){ echo strtoupper($z['zone_name'])." ";} }?></div>
						...
						<?php 
							...
							if ($rowmodule['door_delivery_status']==1) {

								?>

								<td> <button class="btn btn-sm btn-success btn-flat" type="button" onclick="toggle_status(<?php echo $id;?>,<?php echo $rowmodule['door_delivery_status'];?>);"  > <i class="fa fa-fw  fa-check-circle-o"></i> &nbsp;&nbsp; Active &nbsp;&nbsp; </button> </td>
								...
								<td> <button class="btn btn-sm btn-info btn-flat" type="button" onclick="toggle_status(<?php echo $id;?>,<?php echo $rowmodule['door_delivery_status'];?>);"> <i class="fa fa-fw  fa-minus"></i> &nbsp; Inactive  </button> </td>
                       ...
                       <a href="<?php echo $site_url.'/Report/editmaterialrate_door/'.encode_url($id);?>"> <button <?php if ($rowmodule['door_delivery_status']==2) { ?> disabled="disabled" <?php }?> name="edit_allegation_btn_<?php echo $i;?>" id="edit_allegation_btn_<?php echo $i;?>" class="btn btn-sm bg-purple btn-flat" type="button"  ><i class="fa fa-fw  fa-pencil"></i> &nbsp; Edit  </button> 	</a>					
						...
						<?php if($rowmodule['end_date']!='0000-00-00'){ ?> <button <?php if ($rowmodule['door_delivery_status']==2) { ?> disabled="disabled" <?php }?> class="btn btn-sm btn-danger btn-flat" type="button" onclick="del_matrate(<?php echo $rowmodule['door_port_id']; ?>)"> <i class="fa fa-fw fa-trash"></i> &nbsp; Delete  </button><?php  } else { echo "Update End Date to Delete data"; }?>
