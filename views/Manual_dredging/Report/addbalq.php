...
<div class="container-fluid ui-innerpage">
    ...
    <div class="col-12 d-flex justify-content-end">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#"><strong><?php if(isset($int_userpost_sl)){?>Edit<?php } else {?>Add <?php }?> Add Sale Quantity </strong></a></li>
      </ol>
    </div>
    <!-- Main content -->
        ...
        <?php if( $this->session->flashdata('msg')){ 
              ...
              <?php
			  echo form_open('Manual_dredging/Report/addbalq') ;
			  ?>
			   <div class="row p-3">
          <div class="col-md-6 d-flex justify-content-center px-2"> 
           ...
           <div class="col-md-4 d-flex justify-content-start px-2">
			 <input  type="text" name="upqty" id="upqty" />
			  </div>
		</div> <!-- end of row -->
           <div class="row p-3">
           <div class="col-md-12 d-flex justify-content-center px-2">
			 <input class="btn btn-primary" type="submit" value="Add Quantity" />
			</div>
			</div> <!-- end of row -->
             <?php echo form_close(); ?>
