...
if($vessel_type_id==2 && $vessel_subtype_id==0)
    {
     
       $label_control_details     =   $this->Survey_model->get_label_control_details($vessel_type_id,$vessel_subtype_id,$vessel_length1,$hullmaterial_id,$engine_placement_id,$form_id,$heading_id);
       // $data['label_control_details'] = $label_control_details;
    }
    if($vessel_type_id==7 && $vessel_subtype_id==1)
    {
    
        $label_control_details     =   $this->Survey_model->get_label_control_details($vessel_type_id,$vessel_subtype_id,$vessel_length1,$hullmaterial_id,$engine_placement_id,$form_id,$heading_id);
         //$data['label_control_details'] = $label_control_details;
    }
     if($vessel_type_id==7 && ($vessel_subtype_id==2 || $vessel_subtype_id==3 || $vessel_subtype_id==9) )
    {
      
       $label_control_details     =   $this->Survey_model->get_label_control_details($vessel_type_id,$vessel_subtype_id,$vessel_length1,9999,9999,$form_id,$heading_id);
        //$data['label_control_details'] = $label_control_details;
    }
     if(($vessel_type_id==1 || $vessel_type_id==3 || $vessel_type_id==4 || $vessel_type_id==5 || $vessel_type_id==6) && ($vessel_subtype_id==0) )
...
function engine_details_form3($vessel_id)
{
  ...
  if(!empty($vessel_condition))
  {
   ...
   /* $field_all_engine = $this->Survey_model->get_label_details($vessel_type_id, $vessel_subtype_id, $vessel_length1, $hullmaterial_id, $engine_placement_id, $form_id, $heading_id, $label_id);*/
     if($vessel_type_id==2 && $vessel_subtype_id==false)
    {
    
      $field_all_engine = $this->Survey_model->get_label_details($vessel_type_id,$vessel_subtype_id,$vessel_length1,$hullmaterial_id,$engine_placement_id,$form_id,$heading_id);
    }
    if($vessel_type_id==7 && $vessel_subtype_id==1)
    {
     ...
     if($vessel_type_id==7 && ($vessel_subtype_id==2 || $vessel_subtype_id==3 || $vessel_subtype_id==9) )
    {
       ...
       $field_all_engine = $this->Survey_model->get_label_details($vessel_type_id,$vessel_subtype_id,$vessel_length1,9999,9999,$form_id,$heading_id);
    }
     if(($vessel_type_id==1 || $vessel_type_id==3 || $vessel_type_id==4 || $vessel_type_id==5 || $vessel_type_id==6) && ($vessel_subtype_id==false) )
    {
...
function add_vessel_details()
{
 ...
 /*   $length_overthedeck			= 	$this->Survey_model->get_length_overthedeck($vessel_type_id,$vessel_subtype_id,$hullmaterial_id,$engine_placement_id,$form_id,$heading_id);*/
    if($vessel_type_id==2 && $vessel_subtype_id==false)
      ...
      if($vessel_type_id==7 && ($vessel_subtype_id==2 || $vessel_subtype_id==3 || $vessel_subtype_id==9) )
      {
        $length_overthedeck      =   $this->Survey_model->get_length_overthedeck($vessel_type_id,$vessel_subtype_id,9999,9999,$form_id,$heading_id);
      }
      if(($vessel_type_id==1 || $vessel_type_id==3 || $vessel_type_id==4 || $vessel_type_id==5 || $vessel_type_id==6) && ($vessel_subtype_id==false) )
      {
        $length_overthedeck      =   $this->Survey_model->get_length_overthedeck($vessel_type_id,$vessel_subtype_id,9999,9999,$form_id,$heading_id);
    ...
    else
    {
      ...
      /*$data2=1;
       $this->load->view('Kiv_views/Ajax_form1_show.php',$data2);*/
...
if($vessel_type_id==2 && $vessel_subtype_id==false)
     ...
     if($vessel_type_id==7 && ($vessel_subtype_id==2 || $vessel_subtype_id==3 || $vessel_subtype_id==9) )
    {
      ...
      $field_all_engine = $this->Survey_model->get_label_details($vessel_type_id, $vessel_subtype_id, $vessel_length,9999, 9999, $form_id, $heading_id, $label_id);
    }
     if(($vessel_type_id==1 || $vessel_type_id==3 || $vessel_type_id==4 || $vessel_type_id==5 || $vessel_type_id==6) && ($vessel_subtype_id==false) )
    {
  ...
  if($vessel_type_id==2 && $vessel_subtype_id==false)
    {
       ...
       $label_control_details     =   $this->Survey_model->get_label_control_details($vessel_type_id,$vessel_subtype_id,$vessel_length,$hullmaterial_id,$engine_placement_id,$form_id,$heading_id);
    }
    if($vessel_type_id==7 && $vessel_subtype_id==1)
    {
     ...
     if($vessel_type_id==7 && ($vessel_subtype_id==2 || $vessel_subtype_id==3 || $vessel_subtype_id==9) )
    {
       ...
       $label_control_details     =   $this->Survey_model->get_label_control_details($vessel_type_id,$vessel_subtype_id,$vessel_length,9999,9999,$form_id,$heading_id);
    }
     if(($vessel_type_id==1 || $vessel_type_id==3 || $vessel_type_id==4 || $vessel_type_id==5 || $vessel_type_id==6) && ($vessel_subtype_id==false) )
    {
...
function add_engine_details()
{
  ...
  /*  if(!empty($propulsion_diameter))
    {
      $propulsion_diameter=$propulsion_diameter;
    }
    else
    {
      $propulsion_diameter=0;
    }

    if(!empty($propulsion_material_id))
    {
      $propulsion_material_id=$propulsion_material_id;
    }
    else
    {
      $propulsion_material_id=0;
    }*/
  ...
  //}
    ...
    if(!empty($vessel_condition))
    {
      ...
      $vessel_length1=$vessel_condition[0]['vessel_length'];
      $hullmaterial_id=$vessel_condition[0]['hullmaterial_id'];
      $engine_inboard_outboard=$vessel_condition[0]['engine_placement_id'];
    }
    $form_id=1;
    $heading_id=4;
    if($updstatus_res)     
    {
      /*$label_control_details			= 	$this->Survey_model->get_label_control_details($vessel_type_id,$vessel_subtype_id,$vessel_length1,$hullmaterial_id,$engine_inboard_outboard,$form_id,$heading_id);*/
       if($vessel_type_id==2 && $vessel_subtype_id==false)
    {
  ...
  //}
   /* $vessel_type_id           =$this->security->xss_clean($this->input->post('hdn_vessel_type'));
    ...
    if(!empty($vessel_condition))
    {
      $vessel_type_id=$vessel_condition[0]['vessel_type_id'];
      $vessel_subtype_id=$vessel_condition[0]['vessel_subtype_id'];
      $vessel_length=$vessel_condition[0]['vessel_length'];
      $hullmaterial_id=$vessel_condition[0]['hullmaterial_id'];
      $engine_inboard_outboard=$vessel_condition[0]['engine_placement_id'];
    }
    $form_id=1;
...
public function SurveyorHome()
{
  ...
  $customer_id	=	$this->session->userdata('customer_id');
  $survey_user_id=	$this->session->userdata('survey_user_id');
  if(!empty($sess_usr_id) && ($user_type_id==13)) 
  {
   ...
   // exit;
    ...
    if($this->input->post())
    {
      ...
      $processflow_sl		=	$this->security->xss_clean($this->input->post('processflow_sl'));
       ...
       $initial_data1          =   $this->Survey_model->get_form7_process_flow_csde($sess_usr_id,$vessel_id);
    $data['initial_data1']   = $initial_data1;
    @$id=$initial_data1[0]['vessel_created_user_id'];
  ...
  if(!empty($sess_usr_id) && (($user_type_id==12) || ($user_type_id==13)))
  {
    ...
    if($this->input->post())
    {
      ...
      $status_change_date =	$date;
       ...
       $initial_data1          =   $this->Survey_model->get_form8_process_flow($sess_usr_id,$vessel_id);
    $data['initial_data1']   = $initial_data1;
    //print_r($initial_data);

    @$id=$initial_data1[0]['vessel_created_user_id'];
    @$category=$initial_data1[0]['category'];
...
public function pcHome()
{
  ...
  if(!empty($sess_usr_id) && ($user_type_id==3))
  {
   ...
   // $menu     =   $this->Master_model->get_menu_pc($user_type_id,$mod_id); //print_r($menu);
     $menu     =   $this->Master_model->get_menu_pc(3,2);
    $data['menu'] = $menu;
    $data       =   $data + $this->data;
    /* ======Added for dynamic menu listing (end)  on 02.11.2019========   */ 
...
public function Verify_payment_pc_registration()
{
  ...
  if(!empty($sess_usr_id) && ($user_type_id==3))
  {
    ...
    $payment_details =  $this->Survey_model->get_form_payment_details($vessel_id,5,$form_id);
    $data['payment_details']= $payment_details;
    //print_r($payment_details);
...
public function initialsurvey_done()
{
  ...
  if(!empty($sess_usr_id) && (($user_type_id==11) || ($user_type_id==12) || ($user_type_id==13)))
  {
...
public function timeline()
{
  ...
  $modenc          = $this->encrypt->encode($moduleid); 
  $modidenc        = str_replace(array('+', '/', '='), array('-', '_', '~'), $modenc);
  if(!empty($sess_usr_id) && (($user_type_id==3) || ($user_type_id==11) || ($user_type_id==12)|| ($user_type_id==13) ))
  { 
...
public function Verify_dataentry_vessel()
{
  ...
  { 
    ...
    /*  if(!empty($user_master_id))
      {
        $created_user_id=$user_master_id;
      }
      else
      {*/
        $username=$user_email;
     ...
     /*______________Insertion of sandbox_____________________*/
      ...
      'hull_created_user_id' =>$created_user_id,
      'hull_created_timestamp'=>$date,
      'hull_created_ipaddress'=>$ip,
...
*/
 ...
 //_____________________________Email sending start_____________________________//
          ...
          $email_message="<div>      <h4>Registration Successful!</h4>
      <p>Your application for registering as a vessel owner at Department of Ports, Governmet of Kerala has been completed. Your login credential has been sent to your mobile number and email provided in the first form. <br> Username :".$username."  <br> Password : ".$user_password."</p> <hr>  </div>";
         /* $saji_email="kivportinfo@gmail.com";
         $this->emailSendFunction($saji_email,$email_subject,$email_message);*/
          $this->emailSendFunction($user_email,$email_subject,$email_message);
          //___________________Email sending start___________________________________________//
...
public function dcb_statement_cssrra()
{
  ...
  $modenc          = $this->encrypt->encode($moduleid); 
  $modidenc        = str_replace(array('+', '/', '='), array('-', '_', '~'), $modenc);
  if(!empty($sess_usr_id) && (($user_type_id==14) || ($user_type_id==12) || ($user_type_id==13)))
  {
    $this->load->model('Survey_model');
...
public function transaction_search()
{
  ...
  $modenc          = $this->encrypt->encode($moduleid); 
  $modidenc        = str_replace(array('+', '/', '='), array('-', '_', '~'), $modenc);
  if(!empty($sess_usr_id) && (($user_type_id==14) || ($user_type_id==3)))
  {
    $this->load->model('Survey_model');
...
public function number_plate_req()
{
  $sess_usr_id    = $this->session->userdata('int_userid');
  $int_usertype   = $this->session->userdata('int_usertype');
  if(!empty($sess_usr_id) && ($int_usertype==11))
  { 
...
function reprint_approve_list()
{
  $sess_usr_id    = $this->session->userdata('int_userid');
  $int_usertype   = $this->session->userdata('int_usertype');
  if(!empty($sess_usr_id) && ($int_usertype==3))
  { 
...
function reprint_status_update()
{
  ...
  { 
    ...
    else 
    {
      if($status==1)
      {
        $data_upd_vm= array('reprint_approve_status' => $status);
