    ...
    if(!empty($bank_gen_number))
    {
      ...
      if($result_insert)
      {
        ...
        */ 
        ...
        /*___________Direct data for testing server (192.168.2.194/port)-start_________________*/

        if(!empty($online_payment_data))
        { 
          $customer_details       = $this->Survey_model->get_customer_details($sess_usr_id);
          ...
          /*__________________________________Processflow start________________________*/
          date_default_timezone_set("Asia/Kolkata");
          $ip         = $_SERVER['REMOTE_ADDR'];
          $date       =   date('Y-m-d h:i:s', time());
          $newDate    =   date("Y-m-d");
        ...
        /*___________Direct data for testing server (192.168.2.194/port)-end_________________*/
    ...
    if($this->input->post())
    {
      ...
      if(!empty($bank_gen_number))
      {
        ...
        if($result_insert)
        {
         ...
         /*___________Direct data for testing server (192.168.2.194/port)-send_________________*/
