...
class Master_manual_dredg extends CI_Controller {
...

    {
	        ...
	        $this->load->model('Master_model_manual_dredg');
...
//==============================================================================================================
	...
	$this->load->view('Master_manual_dredg/customerreg_ajax_new', $data);
...
/////-----test for integration-----------/////		
		...
		{  	//echo "entered";exit;
			...
			$res=$this->Master_model_manual_dredg->login($uname);//print_r($res);exit;
			foreach($res as $re)
...

			{
				...
				$userdet=$this->Master_model_manual_dredg->getuserdetails($uname);//print_r($userdet);exit;
				...
				$res=$this->Master_model_manual_dredg->getuserlog($user_id);//print_r($res);exit;
			...
			//print_r($userdet);break;
...

				{
					...
					redirect("Master_manual_dredg/ch_pw");
    ...
    $u_ip = $_SERVER["REMOTE_ADDR"];
						...
						$this->Master_model_manual_dredg->save_userlog($data);

					}

					redirect("Master_manual_dredg/dashboard");
...

			{
				...
				redirect('Master_manual_dredg/index'); 
...
/////-----test for integration-----------/////		
...

	{
		...
		{	
			...
			$this->load->view('Master_manual_dredg/chart', $data);
			...
			$this->load->view('template/html-footer');*/
			$this->load->view('template/all-header.php');
		$this->load->view('template/master-header.php');
		$this->load->view('Master_manual_dredg/chart', $data);
		$this->load->view('template/all-footer.php');
		$this->load->view('template/all-scripts.php');
...

{
			...
			$this->load->view('Master_manual_dredg/piechart',$data);
...

{
			...
			$this->load->view('Master_manual_dredg/dowchart',$data);
...

{
			...
			$this->load->view('Master_manual_dredg/barchart',$data);
...

	{
...

		{
			...
			$u_h_dat			=	$this->Master_model_manual_dredg->getuserdetailsforheader($u_id);
		...
		$this->load->view('template/all-scripts.php');
...

			{
				...
				$npaswd=$this->security->xss_clean(html_escape($this->input->post('n_p'))); //echo $sess_usr_id;

				$res=$this->Master_model_manual_dredg->login($sess_usr_id);//print_r($res);exit;
    ...
    $u_ip = $_SERVER["REMOTE_ADDR"];
						...
						$data_u=array('user_master_password'=>$newp);//print_r($data_u);exit;

						$res=$this->Master_model_manual_dredg->up_pw($data_u,$u_id); //print_r($res);exit;
	...
	{//print_r($_SESSION);exit;
...

		{
			...
			$u_h_dat			=	$this->Master_model_manual_dredg->getuserdetailsforheader($sess_usr_id);
...

			{
				...
				redirect('Port/port_officer_main');
			...
			//	echo "update tbl_userlog set otpnumber='$otpno' where user_id='$user_id' and login='$login_time' and logout='$login_time'";exit();
				...
				$sess_otpno=$this->session->set_userdata('sess_otpno',$otpno);
					...
					redirect('Master_manual_dredg/customer_otpcheck');
...

{
	...
	$i=0;
		...
		{	$this->load->model('Master_model');
			...
			$this->load->view('Master_manual_dredg/zone', $data);
...

{
		...
		{	$this->load->model('Master_model');
			...
			$this->load->view('Master_manual_dredg/addzone', $data);
...

				{
...

					{
						...
						$this->session->set_flashdata('msg','<div class="alert alert-success text-center">Zone added successfully</div>');
														...
														redirect('Master_manual_dredg/zone');
...

{
...

	{
		...
		$this->load->view('Master_manual_dredg/genreport',$data);
...
$nmatamt1=0;
		...
		$this->load->view('Master_manual_dredg/rep_gen',$data);
...

{
...

		{
			...
			$this->load->view('Master_manual_dredg/lsgd', $data);
...

{
...

		{
			...
			$this->load->view('Master_manual_dredg/addlsgd', $data);
...

				{
...

					{
						...
						$this->session->set_flashdata('msg','<div class="alert alert-success text-center">LSGD added successfully</div>');
														...
														redirect('Master_manual_dredg/lsgd');
...

{
	...
	$this->load->view('Master/getDist', $data);
...

{
	...
	$this->load->view('Master/getpanchayath', $data);
...

{
	...
	$this->load->view('Master/getpanchayath_mal', $data);
...

{
...

	{
		...
		$this->load->view('Master/getlsgforzone', $data);
...

{
	...
	$this->load->view('Master/getzones', $data);
...

{
	...
	$sess_usr_id 			=  $this->session->userdata('int_userid');
		...
		{	$this->load->model('Master_model');	
			...
			$this->load->view('Master/material', $data);
...

{
	...
	$sess_usr_id 			=  $this->session->userdata('int_userid');
		...
		{	$this->load->model('Master_model');	
			...
			$this->load->view('Master/addmaterial', $data);
...

{
	...
	$sess_usr_id 			=  $this->session->userdata('int_userid');
		...
		{	
			...
			$this->load->view('Master/material_rate', $data);
...

{
	...
	$sess_usr_id 			=  $this->session->userdata('int_userid');
		...
		{	
			...
			$this->load->view('Master/addmaterialrate', $data);
...

			{
				...
				'materialrate_port_material_master_id'=>$this->input->post('int_material'),

				'materialrate_port_amount'=>$this->input->post('vch_material_amt'),

				'materialrate_port_start_date'=>date("Y-m-d",strtotime(str_replace('/', '-',$this->input->post('vch_material_sd')))),

				'materialrate_port_end_date'=>$end_date,

				'materialrate_domain'=>1,

				'materialrate_port_status'=>$this->input->post('int_material_status'),
...

{
		...
		{	
			...
			$this->load->view('Master/material_rate_pc',$data);
...

{
...

		{
			...
			$this->load->view('Master/addmaterialrate_pc', $data);
...

					{
...

						{
							...
							$this->session->set_flashdata('msg','<div class="alert alert-success text-center">Material Rate added successfully</div>');
															...
															redirect('Master/material_rate_pc');
...

{
	...
	$sess_usr_id 			=  $this->session->userdata('int_userid');
		...
		{	
			...
			$this->load->view('Master/taxcalculator', $data);
...

{
		...
		{	
			...
			$this->load->view('Master/addtaxcalculator', $data);
...

{
		...
		{	
			...
			$this->load->view('Master/quantity_pc', $data);
...

{
		...
		{				
			...
			$this->load->view('Master/addquantity_pc', $data);
...

{
...

		{
			...
			$this->load->view('Master/quantity_master', $data);
...

{
...

		{
			...
			$this->load->view('Master/addquantity_master', $data);
...

			{
...

				{
					...
					redirect('Master/quantity_master');
...

{
...

		{
			...
			$this->load->view('Master/taxname_master', $data);
...

{
...

		{
			...
			$this->load->view('Master/addtaxname_master', $data);
...

			{
...

				{
					...
					redirect('Master/taxname_master');
...

{
...

		{
			...
			$this->load->view('Master/construction_master', $data);
...

{
...

		{
			...
			$this->load->view('Master/addconstruction_master', $data);
			...
			//	'user_id'=>$sess_usr_id
...

				{
					...
					redirect('Master/construction_master');
...

{
...

		{
			...
			$this->load->view('Master/plintharea_master', $data);
...

{
...

		{
			...
			$this->load->view('Master/addplintharea_master', $data);
...

			{
...

				{
					...
					redirect('Master/plintharea_master');
...

{
...

		{
			...
			$this->load->view('Master/cutoff_master', $data);
...

{
...

	{
			...
			$this->load->view('Master/addcutoff_master', $data);
...

{
...

		{
			...
			$this->load->view('Master/buking_master', $data);
...

{
		...
		{	
			...
			$this->load->view('Master/addbuking_master', $data);
...

			{
...

				{
					...
					redirect('Master/booking_master');
...

{
...

		{
			...
			$this->load->view('Master/workerqty_master', $data);
...

{
...

		{
			...
			$this->load->view('Master/addworkerqty', $data);
...

			{
...

				{
					...
					redirect('Master/workerqty_master');
...

{
	...
	$sess_user_type			=	$this->session->userdata('int_usertype');
...

		{
			...
			$this->load->view('Master/bank_pc', $data);
...

{
	...
	$this->load->model('Master_model');
...

		{
			...
			$this->load->view('Master/addbank_pc', $data);
...

{
	...
	$sess_usr_id 			=  $this->session->userdata('int_userid');
...

		{
			...
			$this->load->view('Master/assignzone_pc', $data);
...

{
	...
	$sess_usr_id 			=  $this->session->userdata('int_userid');
...

		{
			...
			$this->load->view('Master/addassignzone_pc', $data);
...

			{
...

				{
					...
					echo "wewewewe".validation_errors();
...

{
	...
	$sess_usr_id 			=  $this->session->userdata('int_userid');
...

		{
			...
			$this->load->view('Master/assignzonesec_pc', $data);
...

{
	...
	$sess_usr_id 			=  $this->session->userdata('int_userid');
		...
		{	
			...
			$this->load->view('Master/addassignzone_sec_pc', $data);
...

				{
...

					{
						...
						//$this->session->set_flashdata('msg','<div class="alert alert-success text-center">Bank added successfully</div>');
														...
														redirect('Master/sec_user/'.encode_url($result));
...

{
	...
	$sess_usr_id 			=  $this->session->userdata('int_userid');
...

		{
			...
			$int_sec_id			=	decode_url($this->uri->segment(3));
			...
			$this->load->view('Master/sec_user', $data);
...

			{
...

				{
					...
					$this->session->set_flashdata('msg','<div class="alert alert-success text-center">Section added successfully</div>');
													...
													redirect('Master/assignzone_sec');
...

{
...

		{
			...
			$this->load->view('Master/assigndredgport', $data);
...

{
...

		{
			...
			$this->load->view('Master/adddredgeport', $data);
...

			{
...

				{
					...
					$this->session->set_flashdata('msg','<div class="alert alert-success text-center">Dredging Port added successfully</div>');
													...
													redirect('Master/dregport_master');
...

{
...

		{
			...
			$this->load->view('Master/portconserv', $data);
...

{
	...
	//echo bin2hex(openssl_random_pseudo_bytes(4));
...

		{
			...
			$this->load->view('Master/addportconserv', $data);
...

{
...

		{
			...
			$this->load->view('Master/pcuser', $data);
...

{
...

		{
			...
			$this->load->view('Master/addpcuser', $data);
...
///////////                  ******               POLICE            ******              /////////////////
...

    {
		...
		$this->load->model('Master_model');	
			...
			$this->load->view('Master/police_case', $data);
...

    {
		...
		{	
			...
			$this->load->view('Master/police_case_pc', $data);
...

    {
		...
		{	
			...
			$this->load->view('Master/police_case_add', $data);
...

    {
...

		{
...

			{
...

				{
...

					{
							...
							redirect('Master/police_case_pc');
			...
			$this->load->view('Master/police_case_view', $data);
...

    {
		...
		{	$this->load->model('Master_model');	
			...
			$this->load->view('Master/feemaster', $data);
...

    {
		...
		{	$this->load->model('Master_model');	
			...
			$this->load->view('Master/feemaster_edit', $data);
...

    {
		...
		{	
			...
			$this->load->view('Master/police_caseforwards_add', $data);
...

    {
		...
		{	
			...
			$this->load->view('Master/police_case_pc_add', $data);
...

{
...

		{
...

			{
				...
				$this->load->view('Master/customerregistration_addAjax',$data);
...

{
	...
	$this->load->view('Master/getpanchayathpostoffice', $data);
...

{
	...
	$this->load->view('Master/getpanchayathwork', $data);
...
public function customerregistration_add()

    {
			...
			$this->load->view('Master/customerregistration_add', $data);
...

			{
...

				{
					...
					redirect('Master/customerregistration_add');
	...
	$portid=$this->security->xss_clean(html_escape($this->input->post('customer_port_id')));
...

	  {
...

        {
            ...
            $this->load->view('Master/customerregistration_add', $error);
			...
			'permit_uploadname'=>$permitupload);
...

				{
					...
					//$this->session->set_flashdata('msg','<div class="alert alert-success text-center">Customer Registration successfully</div>');
													...
													redirect('Master/customerregistration_message/'.encode_url($customerreg_insert_id));
...
$portid=$this->input->post('customer_port_id');
...

	{
		...
		$data['getcustomerreg_message']=$getcustomerreg_message;
			...
			$this->load->view('Master/customerregistration_message',$data);
...

{
	...
	$this->load->view('Master/getPermPincode', $data);
...

{
	...
	$this->load->view('Master/getWorkPincode', $data);
...

{
	...
	$this->load->view('Master/checkresult', $data);
...
//print_r($this->input->post());exit;
...

			{
						...
						$this->session->set_flashdata('msg','<div class="alert alert-success text-center">please select approve or reject option!!</div>');															                    	redirect('Master/customer_requestprocessing');
 ...
 //print_r( $usermaster_insert_id);exit;
				...
				$insert_usermaster=$this->db->query("update user_master set user_master_name='$user_name',user_master_password='$password' where user_master_id='$pub_user_id'");
				 ...
				 $msg="Your Port Registration Approved successfully,Please note the login details and change it on first login.%0aUsername ".$user_name."%0aPassword  ".$passwordnew;
...

					{
						...
						$this->session->set_flashdata('msg','<div class="alert alert-success text-center">Request Processing Rejected</div>');															                    	redirect('Master/customer_requestprocessing');
			...
			$this->load->view('Master/customerregistration_view', $data);
...

    {
		...
		{	
		 ...
		 $msg="Your Port Registration Approved successfully,Please note the login details and change it on first login.%0aUsername ".$user_name."%0aPassword  ".$user_name;
...

				{
...

					{
						...
						$this->session->set_flashdata('msg','<div class="alert alert-success text-center">Request Processed successfully</div>');
													...
													redirect('Master/customer_login_add/'.encode_url($customerreg_id));
			...
			$this->load->view('Master/customer_requestprocessing_add', $data);
...
//--------------------------------------------------------------------------------------------------------------------
...

    {
...

		{
...

			{
...

				{
...

					{
						...
						redirect('Master/sand_issue_addmessage/'.$booking_id);
			...
			$this->load->view('Master/sand_issue', $data);
...

			{
				...
				redirect('Master/generatepass/'.encode_url($bk_id_pass));
...
//-------------------------------------  Insert to Payment Table    -----------------------------------------------
 ...
 //-----------------------------------------------------------------------------------------------------------------------
				...
				redirect('Master/vehicle_pass_success/'.encode_url($hid_bookingid));
			...
			$this->load->view('Master/sand_issue_add',$data);
...
//--------------------------------------------------------------------------------------------------------------------------------------------
...

	{
		...
		$this->load->view('Master/sand_issue_reprint',$data);
...

				{
...

					{
						...
						$this->session->set_flashdata('msg','<div class="alert alert-success text-center">Request Send Successfully</div>');
														...
														redirect('Master/sand_issue_reprintVw');
...

	{
		...
		$this->load->view('Master/sand_issue_reprintAppVw',$data);
...

	{
		...
		$pass_id=decode_url($this->uri->segment(3));
		...
		$this->load->view('Master/sand_issue_reprintVw',$data);
		...
		$request_data=array('reprint_status'=>2);
...

					{
						...
						redirect('Master/generatepass/'.encode_url($booking_id));
...

	{
		...
		$this->load->view('Master/sand_issue_reprintApproval',$data);
...

				{
...

					{
						...
						$this->session->set_flashdata('msg','<div class="alert alert-success text-center">Request Approved Successfully</div>');
														...
														redirect('Master/sand_issue_reprintApprove');
...

	{
		...
		//$customer_regn_id	=	$datareprintview[$i]['transaction_customer_registration_id'];

		//print_r($datacustreg);break;
		...
		//$data['customer_name']=$datacustreg[$i]['customer_name'];

		//$data['customer_aadhar_number']=$datacustreg[$i]['customer_aadhar_number'];

		//$data['customer_max_allotted_ton']=$datacustreg[$i]['customer_max_allotted_ton'];
...

    {
		...
		{	$this->load->model('Master_model');	
			...
			$this->load->view('Master/customer_requestprocessing', $data);
	...
	$this->load->view('Master/cus_buk_approve_pc', $data);
...

{
	...
	$this->load->view('Master/customerreg_ajax', $data);
...
exit;
...

    {
		...
		//	$customerreg_detailsAppvd= $this->Master_model->get_customerreg_detailsapproved($port_id);
			...
			$this->load->view('Master/customer_login', $data);
...

    {
		...
		$data = array('title' => 'Add Customer Login Details', 'page' => 'customer_login_add', 'errorCls' => NULL, 'post' => $this->input->post());
			...
			$customerregupt_data= $this->Master_model->update_usermaster($update_data,$hid_usermasterid);
...

				{
					...
					$this->session->set_flashdata('msg','<div class="alert alert-danger text-center">!!!Error failed!!!</div>');
													...
													redirect('Master/customer_login');
			...
			$this->load->view('Master/customer_login_add', $data);
...

    {
		...
		//	$data['customerreg_booking']=$customerreg_booking;
			...
			$this->load->view('Master/customer_booking', $data);
...
public function customer_booking_history()

    {
		...
		{	$this->load->model('Master_model');	
			...
			$this->load->view('Master/customer_booking_his', $data);
...
public function customer_booking_add()

    {
		...
		{ 
			...
			$this->load->view('Master/customer_booking_add', $data);
    ...
    $ip_address = $_SERVER["REMOTE_ADDR"];
...

			{
				...
				$this->session->set_flashdata('msg','<div class="alert alert-danger text-center">!!!Warning Balance Quantity less than Requested Quantity!!!</div>');
			     ...
			     redirect('Master/customer_booking_add/'.encode_url($hid_custid));
...
$diff = date_diff($date1,$date2);
	...
	redirect('Master/customer_booking_add');
	...
	//echo "insert----".$insert_customer_booking;break;
				...
				$bookkeddate= date("Y-m-d", strtotime($booked_date));
						...
						redirect('Master/customer_booking_Succ/'.encode_url($customer_booking_insert_id));
...
//---------------------------------------------
...

    {
		...
		{	
			...
			$this->load->view('Master/customer_bookingapproval', $data);
	...
	function customer_bookingapproval_add()

    {
		...
		//echo "<h2>under maintenance !!!! will be back soon</h2><br>";
		...
		{	
			...
			//$customerreg_details= $this->Master_model->getcustomerregdetailsfor($user_id,$port_id);

			//$data['customerreg_details']=$customerreg_details;

			//$data = $data + $this->data;

			//$booking_approval_addVw= $this->Master_model->booking_approval_addVw($id,$port_id);
			...
			//$booking_all= $this->Master_model->allbooking_approval_addVw($customerid);

			//$data['booking_all']=$booking_all;
...
//				$result=$this->Master_model->update_customerregistration($request_data,$customerreg_id);
		...
		//$res_dailyquery=$this->db->query("Update customer_registration set customer_used_ton=customer_used_ton + $requested_ton,customer_unused_ton  =	customer_unused_ton - $requested_ton where daily_log_date='$dailylogdate' and customer_registration_id='$customerid'");
						...
						redirect('Master/customer_bookingapproval/'.encode_url($bu_zone_id));
...

				{
					...
					$this->session->set_flashdata('msg','<div class="alert alert-danger text-center">Booking Rejected</div>');
													...
													redirect('Master/customer_bookingapproval');
			...
			$this->load->view('Master/customer_bookingapproval_add', $data);
...
public function workerregistration()

	{
		...
		{	
			...
			$this->load->view('Master/workerRegistration',$data);
...

    {
		...
		{	
				...
				{   
					...
					if($MaxWorkerCount!='' && $MaxWorkerCount>0){
						...
						if($no_of_workers>=$MaxWorkerCount){
							...
							redirect('Master/workerregistration');
					...
					if($usr_res && $upd_no_worker){
						...
						redirect('Master/workerregistration_add');
			...
			$this->load->view('Master/workerregistration_add', $data);
...

	{
		...
		{	
			...
			$this->load->view('Master/workerregistration_view',$data);
...

	{
		...
		{	
			...
			$this->load->view('Master/canoeregistration', $data);
...

    {
		...
		{	
...

			{
				...
				{    
					...
					if($can_suc){
						...
						redirect('Master/canoeregistration');
						...
						redirect('Master/canoeregistration_add');
			...
			$this->load->view('Master/canoeregistration_add', $data);
...

	{
		...
		{	
			...
			$this->load->view('Master/canoeregistration_view', $data);
		...
		{	
        	...
        	if(isset($_REQUEST['btn_add'])){
...

				{
					...
					redirect("Master/canoeregistration_edit/$enc_hid");
...

	{
		...
		{	
			...
			$this->load->view('Master/monthlypermitapproval', $data);
...

	{
		...
		{	
			...
			$this->load->view('Master/monthlypermit', $data);
				...
				{    
					...
					if($holidayStatus!=''){
						...
						if($holidayStatus['holiday_port_status']==0){
							...
							redirect("Master/monthlypermit_add");
...
//---------------------------------------------------------------------------------------------------------------------------------------	//				
			...
			$this->load->view('Master/monthlypermit_add', $data);
	...
	//print_r($dataArray); print_r($hid);
			...
			$this->load->view('Master/monthlypermitapproval_action', $data);
...

	{
		...
		{	
			...
			$this->load->view('Master/holidaysettings', $data);
	...
	function holi_period_add(){
...

		{
			...
			$this->load->view('Master/holidays_period', $data);
...

    {
		...
		{	
...

			{
				...
				if(count($isHolidaysSet)>0){
					...
					redirect('Master/holidaysettings');
		...
		//----------------------------------------------------------------------------------		
			...
			$this->load->view('Master/holidays_add', $data);
...

	{
		...
		{	
			...
			$this->load->view('Master/holidays_view', $data);
...

	{
		...
		{	
			...
			$edtzone_enc 			= 	$this->uri->segment(4);
			...
			if($monthly_permit_status==2)  
				...
				$this->load->view('Master/holidays_approved_edit', $data);

			else

				$this->load->view('Master/holidays_edit', $data);
...

	{
		...
		{	
			...
			/*if($monthly_permit_status==2)  
				...
				$this->load->view('Master/holidays_edit_new', $data);
...
<p>&nbsp;</p>
...

    {
		...
		{	
			...
			$this->load->view('Master/calendar');
...

{
 ...
 $lsg_sec_id=decode_url($this->uri->segment(3));
...
public function RemoveReserveDay_Ajax(){
...

	{
		...
		//exit;
			...
			$this->load->view('Master/vehicle_pass_success',$data);
...

{
	...
	//exit;
		...
		//-------------------5/01/2018---------------------------------------------
			...
			$this->load->view('Master/scanpass',$data);
...
//------------------------------------------------------------------------------------------------
...

			{
				...
				redirect('Master/customer_otpcheck');
			...
			$this->load->view('Master/otpview', $data);
...
$get_bookingapprovedlistdata= $this->Master_model->get_bookingapprovedlistnnew($tokennumnber,$port_id,$zone_id);
			...
			$this->load->view('Master/sand_issueotp', $data);
...
//------------------------------------------------------------------------------------------
...

    {
		...
		//	$customerreg_detailsAppvd= $this->Master_model->get_customerreg_detailsapproved($port_id);
			...
			$this->load->view('Master/customer_bookingsearch', $data);
	...
	$this->load->view('Master/getbookingdetails_ajax_new', $data);
