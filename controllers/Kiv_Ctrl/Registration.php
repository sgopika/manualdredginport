...
{ 
	...
	{  //-------------------------------------------------21/08/2020
		...
		$user_state_id      	=	$this->security->xss_clean($this->input->post('user_state_id'));
		$user_district_id      	=	$this->security->xss_clean($this->input->post('user_district_id'));
		$user_occupation_id     =	$this->security->xss_clean($this->input->post('user_occupation_id'));
		$user_occupation_address=	$this->security->xss_clean($this->input->post('user_occupation_address'));
		$user_idcard_id      	=	$this->security->xss_clean($this->input->post('user_idcard_id'));
		$user_idcard_number     =	$this->security->xss_clean($this->input->post('user_idcard_number'));
		$user_dob      			=	$this->security->xss_clean($this->input->post('user_dob'));
		$pan_card_number      	=	$this->security->xss_clean($this->input->post('pan_card_number'));

		$minor_status      		=	$this->security->xss_clean($this->input->post('hdnminor'));
		$agent_status      		=	$this->security->xss_clean($this->input->post('hdnagent'));
		$co_owner_status      	=	$this->security->xss_clean($this->input->post('hdn_co_owner'));
		$co_owner_count      	=	$this->security->xss_clean($this->input->post('co_owner_count'));
		...
		$f_pancard_document1=$_FILES["pancard_document"]["name"];
...
public function NewUser_Registration_guardian()
{
	...
	if($this->input->post())
    {
		...
		$user_idcard_number     =	$this->security->xss_clean($this->input->post('user_idcard_number'));
		$user_dob      			=	$this->security->xss_clean($this->input->post('user_dob'));
		$minor_status      		=	$this->security->xss_clean($this->input->post('minor_status'));
		$relation_sl      		=	$this->security->xss_clean($this->input->post('user_sl'));
