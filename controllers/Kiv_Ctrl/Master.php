...
{ 	   
	...
	$data 					= 	$data + $this->data;//print_r($vesselsub_type);
...
{ 
	...
	//print_r($dynamic_form_details1);
	$start_date1=$dynamic_form_details1[0]['start_date'];
	$end_date1=$dynamic_form_details1[0]['end_date'];
	$date_data=$start_date1.'+'.$end_date1;
	$cnt=count($dynamic_form_details1);
...
{ 	  
	...
	$vessel_subtype_name_opt=$_REQUEST['vessel_subtype_name'];
	$length_over_deck		=$_REQUEST['length_over_deck'];
	$start_date				=$_REQUEST['start_date']; //echo "start_date".$start_date; //01-01-2021
	$end_date				=$_REQUEST['end_date']; //echo "end_date".$end_date;
	//$date1					=$_REQUEST['date1']; echo "date1".$date1;//01-01-2020
	//$date2					=$_REQUEST['date2']; echo "date2".$date2;//01-01-2021
	if($end_date=='')
	{
		$end_date='0000-00-00';
	}
	...
	$dynamic_form_details1= 	$this->Master_model->get_dynamicForm_date($vesseltype_name,$vessel_subtype_id,$length_over_deck,$hullmaterial_name,$engine_inboard_outboard,$form_id,$heading_id);
	$data['dynamic_form_details1']	=	$dynamic_form_details1;
	$date1=$dynamic_form_details1[0]['start_date'];
	$date2=$dynamic_form_details1[0]['end_date'];	
...
{ 	
	...
	$subvesselId 			= $_REQUEST['subvesselId'];
	$hullId 				= $_REQUEST['hullId'];
	$lengthOverDeck 		= $_REQUEST['lengthOverDeck'];
	$engineInboardOutboard 	= $_REQUEST['engineInboardOutboard'];
	$formId 				= $_REQUEST['formId'];
	$startDate 				= $_REQUEST['startDate'];
	$endDate 				= $_REQUEST['endDate'];
	$vesselName 			= $_REQUEST['vesselName'];
	$subvesselName 			= $_REQUEST['subvesselName'];
	$hullName 				= $_REQUEST['hullName'];
	$boardName 				= $_REQUEST['boardName'];
	$hidformName 			= $_REQUEST['hidformName'];
	...
	{ 
		...
		{					
			...
			$cntrows				= 	count($checkDupliList);print_r($checkDupliList);//echo "----dupli count".$cntrows;
			$data['checkDupliList']	=	$checkDupliList;
			$data 					= 	$data + $this->data;//echo "------dupli check 1";//exit();
			//--------------------------
			...
			{ 
				...
				$copiedPrimaryVal=explode(',', $copiedPrimaryValue);
				$this->load->model('Kiv_models/Master_model');
