...
{ 
	...
	/*	$f_user_photo 		= 	$_FILES["user_photo"]["name"];
		$f_aadhar_document 	= 	$_FILES["aadhar_document"]["name"];
		$f_pancard_document = 	$_FILES['pancard_document']['name'];
		$f_signature 		= 	$_FILES['signature']['name'];*/
		...
		/*$extension1 =explode(".", $f_user_photo);
        $ext1=$extension1[1];
		$extension2 =explode(".", $f_aadhar_document);
		$ext2=$extension2[1];
		$extension3 =explode(".", $f_pancard_document);
		$ext3=$extension3[1];
		$extension4 =explode(".", $f_signature);
		$ext4=$extension4[1];*/
		...
		$user_photo='owner_photo_'.$id.'.jpg';
		$aadhar_document='aadhar_'.$id.'.pdf';
		$pancard='pancard_'.$id.'.pdf';
		$signature='signature_'.$id.'.pdf';
