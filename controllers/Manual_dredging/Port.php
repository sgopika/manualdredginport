...

{
	...
	public function mailbox12092020()

	{
			...
			{	
				...
				$this->load->view('Manual_dredging/Master/mailbox', $data);
...

	{
			...
			$msg_id		=	decode_url($this->uri->segment(4));	
			...
			{	//$this->load->model('Master_model');	
				...
				$this->load->view('Kiv_views/template/dash-header');
				$this->load->view('Kiv_views/template/nav-header');
				$this->load->view('Manual_dredging/Master/readmail', $data);
...

	{
			...
			{	//$this->load->model('Master_model');	
...

				{
...

					{
...

							{
									...
									redirect('Manual_dredging/Port/mailbox');
				...
				$this->load->view('Kiv_views/template/dash-header');
				$this->load->view('Kiv_views/template/nav-header');
				$this->load->view('Manual_dredging/Master/compose', $data);
...

	{
			...
			{	//$this->load->model('Master_model');
				...
				$this->load->view('Kiv_views/template/dash-header');
				$this->load->view('Kiv_views/template/nav-header');
				$this->load->view('Manual_dredging/Master/sentitem', $data);
...

	{
				...
				$this->load->view('Manual_dredging/Master/showzone', $data);
...

	{
			...
			$data 				= 	$data + $this->data;
				...
				$this->load->view('Kiv_views/template/dash-header');
				$this->load->view('Kiv_views/template/nav-header');
				$this->load->view('Manual_dredging/Master/chart_pc', $data);
	...
	{ //print_r($_SESSION); exit;
		    ...
		    $this->load->view('Kiv_views/dash/pcdash');
...

	{
		...
		$sess_user_type			=	$this->session->userdata('int_usertype');*/
		$sess_usr_id 			=  $this->session->userdata('u_id');

		$sess_user_type			=	$this->session->userdata('utyp_id');
		...
		{ //echo $sess_usr_id;exit;
			...
			$this->load->view('Master_manual_dredg/portconservator',$data);
...

	{
...

		{
			...
			$this->load->view('Manual_dredging/Master/portdirector',$data);
...
$this->load->view('Kiv_views/template/dash-header');
			...
			$this->load->view('Manual_dredging/Master/zoneop',$data);
...
$this->load->view('Kiv_views/template/dash-header');
			...
			$this->load->view('Manual_dredging/Master/lsgdop',$data);
...

	{
...

		{
			...
			$this->load->view('Manual_dredging/Master/cus_buk_pd',$data);
...

	{
...

		{
			...
			$this->load->view('Manual_dredging/Master/cut_reg_pd',$data);
...

	{
...

		{
			...
			$this->load->view('Manual_dredging/Master/mon_pt_pd',$data);
...

	{
			    ...
			    $port_id		    =	decode_url($this->uri->segment(4));
				...
				$this->load->view('Kiv_views/template/dash-header');
				$this->load->view('Kiv_views/template/nav-header');
				$this->load->view('Manual_dredging/Master/show_pd_buk', $data);
				$this->load->view('Kiv_views/template/dash-footer');
...

	{
				...
				$this->load->view('Kiv_views/template/dash-header');
				$this->load->view('Kiv_views/template/nav-header');
				$this->load->view('Manual_dredging/Master/show_pd_mon', $data);
				$this->load->view('Kiv_views/template/dash-footer');
...

	{
			   ...
			   $port_id		    =	decode_url($this->uri->segment(4));
				...
				$this->load->view('Kiv_views/template/dash-header');
				$this->load->view('Kiv_views/template/nav-header');
				$this->load->view('Manual_dredging/Master/show_pd_cus', $data);
				$this->load->view('Kiv_views/template/dash-footer');
...

    {
		...
		{	
			...
			$id			=		decode_url($id);
			$portid			=		$this->uri->segment(5);

			$portid			=		decode_url($portid);
			...
			$customerreg_details= $this->Master_model->getcustomerregdetails($id,$portid);
			...
			$data 				= 	$data + $this->data;
				...
				$this->load->view('Kiv_views/template/dash-header');
				$this->load->view('Kiv_views/template/nav-header');
				$this->load->view('Manual_dredging/Master/customerregistration_view_pd', $data);
				$this->load->view('Kiv_views/template/dash-footer');
	   	}
...

	{
				...
				$this->load->view('Kiv_views/template/dash-header');
				$this->load->view('Kiv_views/template/nav-header');
				$this->load->view('Manual_dredging/Master/userlogs', $data);
				$this->load->view('Kiv_views/template/dash-footer');
...

	{
				...
				$this->load->view('Manual_dredging/Master/showzones', $data);
...

	{
				...
				$this->load->view('Manual_dredging/Master/showqty', $data);
...
$this->load->view('Kiv_views/template/dash-header');
				$this->load->view('Kiv_views/template/nav-header');
			$this->load->view('Manual_dredging/Master/portofficer', $data);
...
$this->load->view('Kiv_views/template/dash-header');
				$this->load->view('Kiv_views/template/nav-header');
			$this->load->view('Manual_dredging/Master/addportofficer', $data);
...
public function all_customer_booking_pc()

    {
		...
		{	//$this->load->model('Master_model');	
			...
			$u_h_dat			=	$this->Master_model->getuserdetailsforheader($sess_usr_id);
				...
				$this->load->view('Kiv_views/template/dash-header');
				$this->load->view('Kiv_views/template/nav-header');
				$this->load->view('Manual_dredging/Master/all_customer_booking', $data);
				$this->load->view('Kiv_views/template/dash-footer');
...

    {
		...
		{	
			...
			$this->load->view('Manual_dredging/Master/all_customer_booking_Ajax', $data);
...
$this->load->view('Kiv_views/template/dash-header');
...

    {
		...
		{	//$this->load->model('Master_model');	
            ...
            $this->load->view('Kiv_views/template/dash-header');
			$this->load->view('Kiv_views/template/nav-header');
			$this->load->view('Manual_dredging/Master/paid_customer_pc', $data);
			$this->load->view('Kiv_views/template/dash-footer');
...

    {
		...
		{	
			...
			$this->load->view('Manual_dredging/Master/paid_customer_ajax_pc', $data);
 ...
 where customer_booking_id='$buk_id'");
			...
			redirect('Manual_dredging/Port/customer_booking_pc_paid');
...

    {
...

		{
			...
			$data 				= 	$data + $this->data; 
                        ...
                        $this->load->view('Kiv_views/template/dash-header');
			$this->load->view('Kiv_views/template/nav-header');
			$this->load->view('Manual_dredging/Master/zone_status_pc', $data);
			$this->load->view('Kiv_views/template/dash-footer');
...

	{
...

		{
			...
			$this->load->view('Manual_dredging/Master/show_zone_stat_ajax', $data);	
...

	{
...

		{
			...
			$this->load->view('Kiv_views/template/dash-header');
			$this->load->view('Kiv_views/template/nav-header');
			$this->load->view('Manual_dredging/Master/ch_pw_new', $data);
...

			{
...

				{
						...
						$data=array(
							...
							$data_u=array('user_master_password'=>$newp,'user_decrypt_pwd'=>$npaswd); 
...

	{
		...
		$this->load->view('Kiv_views/template/dash-header');
		$this->load->view('Kiv_views/template/nav-header');
		$this->load->view('Manual_dredging/Master/today_sand_pass', $data);	
		$this->load->view('Kiv_views/template/dash-footer');
...

	{
			...
			$this->load->view('Manual_dredging/Master/forgetme');	
						...
						*/
...

						{
							...
							$this->session->set_flashdata('msg','<div class="alert alert-success text-center">Material Rate Updated successfully</div>');
															...
															redirect('Manual_dredging/Port/mech_rate_pc');
...
$this->load->view('Kiv_views/template/dash-header');
				$this->load->view('Kiv_views/template/nav-header');
			$this->load->view('Manual_dredging/Master/addmaterialrate_mech_pc', $data);
	...
	{	
		...
		{	
			...
			$u_h_dat			=	$this->Master_model->getuserdetailsforheader($sess_usr_id);
				...
				$this->load->view('Kiv_views/template/dash-header');
				$this->load->view('Kiv_views/template/nav-header');
				$this->load->view('Manual_dredging/Master/material_rate_mech_pc',$data);
				$this->load->view('Kiv_views/template/dash-footer');
...
$this->load->view('Kiv_views/template/dash-header');
				$this->load->view('Kiv_views/template/nav-header');
			$this->load->view('Manual_dredging/Master/material_rate_mech',$data);
...

	{
...

		{
			...
			//$this->load->view('Kiv_views/template/dash-header');
				$this->load->view('Kiv_views/template/nav-header');$this->load->view('template/header',$data);

			$this->load->view('Manual_dredging/Master/addmaterialrate_mech', $data);
...

					{
...

						{
							...
							$this->session->set_flashdata('msg','<div class="alert alert-success text-center">Material Rate added successfully</div>');
															...
															redirect('Manual_dredging/Port/mech_rate');
...
$this->load->view('Kiv_views/template/dash-header');
...

	{
...

		{
			...
			$this->load->view('Manual_dredging/Master/portclerk_view',$data);
...

	{
...

		{
			...
			$this->load->view('Kiv_views/template/dash-header');
			$this->load->view('Kiv_views/template/nav-header');
			$this->load->view('Manual_dredging/Master/addmodule', $data);
			$this->load->view('Kiv_views/template/dash-footer');
...

	{
		...
		if(!empty($sess_usr_id))
		{
			...
			$this->load->view('Kiv_views/template/dash-header');
			$this->load->view('Kiv_views/template/nav-header');
			$this->load->view('Manual_dredging/Master/add_module_new', $data);
			$this->load->view('Kiv_views/template/dash-footer');
...

			{
...

				{
						...
						redirect('Manual_dredging/Port/addmodule_clerk');
...

				{
					...
					redirect('Manual_dredging/Port/add_module_new'); 
