...
//-------------------------------------------------------------------------------------------------------------------------------------
function check_duplicationIns_dynamicPage($vesseltype_id,$vessel_subtype_id,$length_over_deck,$hullmaterial_id,$engine_inboard_outboard,$form_id,$heading_sl)//,$start_date     
    { 	
